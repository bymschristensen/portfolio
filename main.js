...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		// Entry Animations
		var EntryAnimations = {};
		EntryAnimations.selected=function(e){e=e||document;var t=e.querySelector(".selected-container"),n=t&&t.querySelector(".selected-content"),i=gsap.timeline();if(!t||!n)return i;function r(){try{var r=[].concat([].slice.call(n.querySelectorAll(".appear-in-line")),[].slice.call(n.querySelectorAll(".selected-item-outer .selected-visual")),[].slice.call(n.querySelectorAll(".selected-item-outer .selected-item-header .headline-m")),[].slice.call(n.querySelectorAll(".selected-item-outer .selected-item-details")));r.length&&gsap.set(r,{visibility:"visible"});document.documentElement.removeAttribute("data-preloading")}catch{}}function o(){var e=Math.max(document.documentElement.clientWidth,window.innerWidth||0),t=window.innerHeight||document.documentElement.clientHeight||0,l=[].slice.call(n.querySelectorAll(".selected-item-outer"));if(!l.length)return i;function a(e){if(e.__entryPrepared)return;var t=e.querySelector(".selected-visual"),n=e.querySelector(".selected-item-header .headline-m"),i=e.querySelector(".selected-item-details"),r=e.querySelectorAll(".selected-item-details .body-s");t&&gsap.set(t,{scaleY:0,transformOrigin:"bottom center",opacity:0,willChange:"transform,opacity"}),n&&gsap.set(n,{opacity:0,willChange:"opacity,transform"}),i&&gsap.set(i,{opacity:0,height:0,willChange:"height,opacity"}),r.length&&gsap.set(r,{opacity:0,y:20,filter:"blur(10px)",willChange:"transform,opacity,filter"}),e.__entryPrepared=!0}l.forEach(a);var s=l.map(function(n){var i=n.getBoundingClientRect();return{el:n,rect:i,area:Math.max(0,Math.min(i.right,e)-Math.max(i.left,0))*Math.max(0,Math.min(i.bottom,t)-Math.max(i.top,0)),cx:(i.left+i.right)/2}}),d=s.filter(function(e){return e.area>1}).sort(function(e,t){return e.rect.left-t.rect.left});if(!d.length){var c=e/2;d=s.slice().sort(function(e,t){return Math.abs(e.cx-c)-Math.abs(t.cx-c)}).slice(0,2).sort(function(e,t){return e.rect.left-t.rect.left})}var u={};d.forEach(function(e){u[e.el]=!0}),s.forEach(function(e){if(!e.el.__entryDone&&!u[e.el]){var t=e.el.querySelector(".selected-visual"),n=e.el.querySelector(".selected-item-header .headline-m"),i=e.el.querySelector(".selected-item-details"),r=e.el.querySelectorAll(".selected-item-details .body-s");t&&gsap.set(t,{scaleY:1,opacity:1}),n&&gsap.set(n,{opacity:1}),i&&gsap.set(i,{opacity:1,height:"auto"}),r.length&&gsap.set(r,{opacity:1,y:0,filter:"blur(0px)"}),e.el.__entryDone=!0}}),d.forEach(function(e,t){var n=e.el,r=n.querySelector(".selected-visual"),o=n.querySelector(".selected-item-header .headline-m"),l=n.querySelector(".selected-item-details"),a=n.querySelectorAll(".selected-item-details .body-s"),s=.14*t;r&&i.set(r,{opacity:1},s).to(r,{scaleY:1,duration:.75,ease:"power2.out"},s),o&&i.set(o,{opacity:1},s+.16).call(function(){var e=CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready?CoreUtilities.Fonts.ready():Promise.resolve();e.then(function(){if(window.SplitText&&window.splitAndMask&&window.animateLines&&window.safelyRevertSplit){var e=splitAndMask(o);animateLines(e.lines).eventCallback("onComplete",function(){safelyRevertSplit(e,o)})}else gsap.to(o,{y:0,opacity:1,duration:.55,ease:"power2.out"})})},null,s+.16),l&&i.to(l,{opacity:1,height:"auto",duration:.4,ease:"power2.out"},s+.56),a.length&&i.to(a,{opacity:1,y:0,filter:"blur(0px)",duration:.4,ease:"power2.out",stagger:.12},s+.56),n.__entryDone=!0});return i}function l(){return new Promise(function(e){requestAnimationFrame(function(){requestAnimationFrame(e)})})}function a(){r();return l().then(o)}return t.hasAttribute("data-loop-ready")?a():(n.addEventListener("selected:loop-ready",function e(){n.removeEventListener("selected:loop-ready",e,!0),a()},!0),setTimeout(a,420)),i};
