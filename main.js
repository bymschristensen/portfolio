	...
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({
				...
				init: async r=>{if(matchMedia("(prefers-reduced-motion: reduce)").matches)return;const a=[...r.querySelectorAll(".infinite-gallery")];if(!a.length)return;const u=e=>{const t=[...e.querySelectorAll("img,video")];if(!t.length)return Promise.resolve();const n=e=>e.naturalWidth>0&&e.naturalHeight>0||e.videoWidth>0&&e.videoHeight>0,o=[];return Promise.race([Promise.all(t.map(e=>{if(n(e))return Promise.resolve();const t="function"==typeof e.decode?e.decode().catch(()=>{}):Promise.resolve(),o=new Promise(r=>{const t=()=>{e.removeEventListener("load",t),r()};e.addEventListener("load",t,{once:!0})}),i=new Promise(r=>{let t=0;!function c(){if(n(e)||t++>80)return r();setTimeout(c,40)}()});return Promise.race([t,o,i])})),new Promise(e=>o.push(setTimeout(e,3500)))]).finally(()=>o.forEach(clearTimeout))},s=CSS&&CSS.supports&&CSS.supports("aspect-ratio: 1/1"),l=e=>{const t=parseFloat(e.getAttribute("data-ratio"));if(t&&isFinite(t)&&t>0)return t;const n=(e.className||"").match(/sv-ratio-(\d+)/);if(n){const o=n[1];if("169"===o)return 16/9;if("133"===o||"43"===o)return 4/3;if("11"===o)return 1}const o=e.querySelector("img,video");if(o){const e=parseInt(o.getAttribute("width"),10)||o.naturalWidth||o.videoWidth||0,t=parseInt(o.getAttribute("height"),10)||o.naturalHeight||o.videoHeight||0;if(e>0&&t>0)return e/t}const i=e.getBoundingClientRect();return i.height>0?i.width/i.height:1.5},d=(e,t)=>{const n=parseFloat(e.getAttribute("data-size"));if(n&&isFinite(n))return Math.max(1,Math.round(t*n/100));const o=(e.className||"").match(/sv-size-(\d+)/);if(o){const e=parseFloat(o[1]);if(e>0)return Math.max(1,Math.round(t*e/100))}const i=e.getBoundingClientRect().height||0;return i>0?Math.round(i):Math.max(1,Math.round(.5*t))};a.forEach(e=>{const t=e.querySelector(".infinite-gallery-wrapper");if(!t||t.__inited)return;t.__inited=!0,e.setAttribute("data-armed","0");const n=[...t.querySelectorAll(".service-visual-wrapper:not([data-clone])")];if(!n.length){e.setAttribute("data-armed","1");return}const o=new Set;let i=!1,c=0,f=0,m=0,p=("right"===(e.dataset.direction||"left").toLowerCase()?-1:1),h=parseFloat(e.dataset.speed)||.6,g=()=>{n.forEach((e,r)=>{const a=l(e);const u=d(e,t.clientHeight);const g=String(r);e.dataset.key=g,e.dataset.ratio=String(a),e.dataset.targetH=String(u),e.style.overflow="hidden",e.style.flex="0 0 auto",e.style.willChange="height,transform";if(s){e.style.aspectRatio=a+" / 1",e.style.removeProperty("width"),e.style.removeProperty("min-width"),e.style.removeProperty("max-width")}else{const t=Math.max(1,Math.round(u*a));e.style.width=t+"px",e.style.minWidth=t+"px",e.style.maxWidth=t+"px"}o.has(g)?(e.dataset.revealed="1",e.dataset.revealing="",e.style.height=u+"px"):(e.dataset.revealed="0",e.dataset.revealing="",e.style.height="0px")})},y=()=>{n.forEach(e=>{const r=e.dataset.key||"",a=parseFloat(e.dataset.ratio)||l(e),u=+e.dataset.targetH||0;const s=e.cloneNode(!0);s.setAttribute("data-clone","1"),s.dataset.key=r,s.dataset.ratio=String(a),s.style.overflow="hidden",s.style.flex="0 0 auto",s.style.willChange="height,transform",s.style.height=o.has(r)&&u>0?u+"px":"0px",s.style.aspectRatio=a+" / 1",t.appendChild(s);if(!s){return}if(!CSS||!CSS.supports||!CSS.supports("aspect-ratio: 1/1")){const e=Math.max(1,Math.round(u*a));s.style.width=e+"px",s.style.minWidth=e+"px",s.style.maxWidth=e+"px"}})},v=()=>{let e=0;return t.childNodes.forEach(t=>{1===t.nodeType&&(e+=(t.getBoundingClientRect().width||0)+(parseFloat(getComputedStyle(t.parentElement||t).gap||"0")||0))}),e},w=()=>{[...t.querySelectorAll('.service-visual-wrapper[data-clone="1"]')].forEach(e=>e.remove())},b=()=>{w(),y(),y();let e=0;for(;v()<3*eW()&&e++<8;)y()},eW=()=>Math.max(document.documentElement.clientWidth,window.innerWidth||0),E=()=>{e.setAttribute("data-armed","1");const n=e.getBoundingClientRect(),o=innerHeight||document.documentElement.clientHeight||0;n.bottom>0&&n.top<o&&(i=!0,cancelAnimationFrame(f),f=requestAnimationFrame(S))},S=a=>{if(!i){cancelAnimationFrame(f);return}if((a||0)-m<80){f=requestAnimationFrame(S);return}m=a||performance.now();const r=innerWidth||document.documentElement.clientWidth||0,n=-.05*r,l=1.05*r,s=[...t.querySelectorAll('.service-visual-wrapper:not([data-clone])')].filter(e=>{const t=e.getBoundingClientRect();return t.right>n&&t.left<l}).filter(e=>"1"!==e.dataset.revealed&&"1"!==e.dataset.revealing).sort((e,t)=>e.getBoundingClientRect().left-t.getBoundingClientRect().left);if(s.length){const e=gsap.timeline();s.forEach((r,n)=>{const a=+r.dataset.targetH||0,u=r.dataset.key||"";r.dataset.revealing="1",e.to(r,{height:a,duration:.9,ease:"power2.out",onComplete:()=>{r.style.height="",r.dataset.revealed="1",r.dataset.revealing="",o.add(u);const e=!spt();t.querySelectorAll('.service-visual-wrapper[data-clone="1"][data-key="'+u+'"]').forEach(t=>{t.style.height=a+"px";if(e){const r=parseFloat(t.dataset.ratio)||l(t);const n=Math.max(1,Math.round(a*r));t.style.width=n+"px",t.style.minWidth=n+"px",t.style.maxWidth=n+"px"}});if(e){const e=parseFloat(r.dataset.ratio)||l(r),t=Math.max(1,Math.round(a*e));r.style.width=t+"px",r.style.minWidth=t+"px",r.style.maxWidth=t+"px"}}},.12*n)})}f=requestAnimationFrame(S)},spt=()=>CSS&&CSS.supports&&CSS.supports("aspect-ratio: 1/1"),T=(e,r)=>{const n=(r||16.6667)/1e3,o=60*h;c-=p*n*o;let i=t.firstElementChild,a=0;for(;i&&c<-(i.getBoundingClientRect().width+(parseFloat(getComputedStyle(i.parentElement||i).gap||"0")||0))&&a++<50;)c+=i.getBoundingClientRect().width+(parseFloat(getComputedStyle(i.parentElement||i).gap||"0")||0),t.appendChild(i),i=t.firstElementChild;let l=t.lastElementChild;a=0;for(;l&&c>0&&a++<50;)c-=l.getBoundingClientRect().width+(parseFloat(getComputedStyle(l.parentElement||l).gap||"0")||0),t.insertBefore(l,t.firstElementChild),l=t.lastElementChild;gsap.set(t,{x:c});const s=(innerWidth||0)/2;t.querySelectorAll(".service-visual").forEach(e=>{const t=e.closest(".service-visual-wrapper");if(!t)return;const r=t.getBoundingClientRect(),n=(s-(r.left+r.width/2))/((innerWidth)||1);e.style.setProperty("--drift",40*n+"px")})},R=t=>{t.forEach(t=>{t.target===e&&(t.isIntersecting?(i=!0,cancelAnimationFrame(f),f=requestAnimationFrame(S)):(i=!1,cancelAnimationFrame(f)))})},O=new ResizeObserver(()=>{g(),w(),b(),n.forEach(e=>{const r=e.dataset.key||"",a=+e.dataset.targetH||0;t.querySelectorAll('.service-visual-wrapper[data-clone="1"][data-key="'+r+'"]').forEach(e=>{e.style.height=a+"px"});if(!s){const n=parseFloat(e.dataset.ratio)||l(e),o=Math.max(1,Math.round(a*n));e.style.width=o+"px",e.style.minWidth=o+"px",e.style.maxWidth=o+"px"}}),E()});(async()=>{await u(t),g(),b(),E();const n=new IntersectionObserver(R,{root:null,threshold:0,rootMargin:"0px 0px -5% 0px"});n.observe(e),CoreUtilities.Observers.addDom(n),CoreUtilities.Observers.addDom({disconnect(){i=!1,cancelAnimationFrame(f)}});const o=(e,r)=>T(e,r);gsap.ticker.add(o),CoreUtilities.Observers.addTicker(o),O.observe(t),CoreUtilities.Observers.addDom(O)})()})}
			})
		);
