...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		const EntryAnimations = {
			selected(e=document){const t=e.querySelector(".selected-container"),a=t?.querySelector(".selected-content"),o=[...e.querySelectorAll(".selected-item-outer")],l=gsap.timeline();if(!(t&&a&&o.length))return l;o.forEach(s=>{if(s.__entryDone)return;const t=s.querySelector(".selected-visual"),a=s.querySelector(".selected-item-header .headline-m"),o=s.querySelector(".selected-item-details"),l=s.querySelectorAll(".selected-item-details .body-s");t&&gsap.set(t,{scaleY:0,transformOrigin:"bottom center",opacity:0}),a&&gsap.set(a,{opacity:0}),o&&gsap.set(o,{opacity:0,height:0}),l.length&&gsap.set(l,{opacity:0,y:20,filter:"blur(10px)"})});const r=s=>requestAnimationFrame(()=>requestAnimationFrame(s)),n=s=>{const n=()=>r(s);if(t.hasAttribute("data-loop-ready"))return n();const i=()=>{a.removeEventListener("selected:loop-ready",i,!0),n()};a.addEventListener("selected:loop-ready",i,!0),setTimeout(()=>{a.removeEventListener("selected:loop-ready",i,!0),n()},600)};const i=()=>{const e=innerWidth||document.documentElement.clientWidth,t=innerHeight||document.documentElement.clientHeight,r=o.map(s=>{const t=s.getBoundingClientRect();return{o:s,r:t,area:Math.max(0,Math.min(t.right,e)-Math.max(t.left,0))*Math.max(0,Math.min(t.bottom,t)-Math.max(t.top,0)),center:(t.left+t.right)/2}});let n=r.filter(s=>s.area>1).sort((e,t)=>e.r.left-t.r.left);if(!n.length){const t=e/2;n=r.slice().sort((e,a)=>Math.abs(e.center-t)-Math.abs(a.center-t)).slice(0,2).sort((e,t)=>e.r.left-t.r.left)}const i=new Set(n.map(s=>s.o));r.forEach(s=>{if(s.o.__entryDone||i.has(s.o))return;const e=s.o.querySelector(".selected-visual"),t=s.o.querySelector(".selected-item-header .headline-m"),a=s.o.querySelector(".selected-item-details"),o=s.o.querySelectorAll(".selected-item-details .body-s");e&&gsap.set(e,{scaleY:1,opacity:1}),t&&gsap.set(t,{opacity:1}),a&&gsap.set(a,{opacity:1,height:"auto"}),o.length&&gsap.set(o,{opacity:1,y:0,filter:"blur(0px)"}),s.o.__entryDone=!0});n.forEach((e,t)=>{const a=e.o;if(a.__entryDone)return;const o=a.querySelector(".selected-visual"),n=a.querySelector(".selected-item-header .headline-m"),i=a.querySelector(".selected-item-details"),s=a.querySelectorAll(".selected-item-details .body-s"),r=.15*t;o&&l.set(o,{opacity:1},r).to(o,{scaleY:1,duration:.8,ease:"power2.out"},r),n&&l.set(n,{opacity:1},r+.2).call(()=>{if(n.__splitRun)return;n.__splitRun=!0,(CoreUtilities?.Fonts?.ready?.()??Promise.resolve()).then(()=>{if(!window.SplitText)return void gsap.to(n,{y:0,opacity:1,duration:.6,ease:"power2.out"});const e=splitAndMask(n);gsap.delayedCall(.15,()=>{animateLines(e.lines).eventCallback("onComplete",()=>safelyRevertSplit(e,n))})})},null,r+.2),i&&l.to(i,{opacity:1,height:"auto",duration:.4,ease:"power2.out"},r+.6),s.length&&l.to(s,{opacity:1,y:0,filter:"blur(0px)",duration:.4,ease:"power2.out",stagger:.15},r+.6),a.__entryDone=!0})};return n(i),l},
			...
			caseStudy(e){const t=gsap.timeline(),a=e.querySelector(".cs-hero-image"),i=e.querySelector(".cs-headline"),s=e.querySelector(".cs-titles-inner .headline-m"),n=o=>{if(!o)return;try{o.removeAttribute("data-entry-hidden"),o.removeAttribute("hidden"),o.removeAttribute("aria-hidden"),o.style.visibility="visible",["hidden","is-hidden","u-hidden","opacity-0","visually-hidden"].forEach(r=>o.classList&&o.classList.remove(r))}catch{}};function l(o){return new Promise(r=>{if(window.SplitText)return r();let d=0;(function c(){window.SplitText?r():d++<24?setTimeout(c,50):r()})()})}a&&(gsap.set(a,{autoAlpha:0,y:100,filter:"blur(10px)"}),n(a),t.to(a,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.75,ease:"power2.out"},0));if(i){gsap.set(i,{autoAlpha:0,visibility:"hidden"}),n(i),t.addLabel("hl",.15).call(()=>{const o=()=>{const r=splitAndMask(i);gsap.set(i,{autoAlpha:1,visibility:"visible",display:"block"});const d=(r.lines&&r.lines.length?r.lines.length:1),c=.8+.08*Math.max(0,d-1);s&&(gsap.set(s,{autoAlpha:0,y:20,filter:"blur(10px)"}),n(s),t.to(s,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.5,ease:"power2.out"},"hl+"+Math.max(0,c-.2))),animateLines(r.lines).eventCallback("onComplete",()=>{try{(window.safelyRevertSplit?window.safelyRevertSplit:r.revert).call(r,r,i)}catch{}"inline"===getComputedStyle(i).display&&(i.style.display="inline")})};Promise.resolve(CoreUtilities?.Fonts?.ready?.()).then(()=>l().then(()=>{requestAnimationFrame(()=>requestAnimationFrame(o))})).catch(()=>{l().then(()=>{requestAnimationFrame(()=>requestAnimationFrame(o))})})},null,"hl")}return t}
		};
