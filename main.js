	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(e){e=e||document;var K="archiveView",mq=matchMedia("(min-width:1024px)"),P=e.querySelector(".section-archive-playful"),M=e.querySelector(".section-archive-minimal"),B=e.querySelector(".archive-switch-block"),S=e.querySelector(".archive-switch"),D=e.querySelector(".archive-switch-dot");if(!P||!M||e.__archiveViewBound)return;e.__archiveViewBound=1;function stored(){try{var v=localStorage.getItem(K);return v==="playful"||v==="minimal"?v:null}catch(_){return null}}function desired(){return mq.matches?(stored()||"playful"):"minimal"}function ui(v){var on=v==="playful";B&&(B.dataset.view=v,B.setAttribute("aria-pressed",String(on)),B.classList.toggle("is-playful",on),B.classList.toggle("is-minimal",!on));S&&(S.dataset.view=v,S.classList.toggle("is-playful",on),S.classList.toggle("is-minimal",!on));D&&(D.dataset.view=v,D.classList.toggle("is-playful",on),D.classList.toggle("is-minimal",!on))}function emit(v){try{document.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:v}}))}catch(_){}try{var f=localStorage.getItem("archiveFilter");f&&document.dispatchEvent(new CustomEvent("archive:filter",{bubbles:!0,detail:{filter:f,source:"view"}}))}catch(_){}}function show(v){P.style.display=v==="playful"?"block":"none";M.style.display=v==="minimal"?"block":"none";ui(v);emit(v);try{window.ScrollTrigger&&requestAnimationFrame(function(){try{ScrollTrigger.refresh()}catch(_){}})}catch(_){}}function set(v,save){v=v==="playful"?"playful":"minimal";mq.matches||(v="minimal");save&&mq.matches&&function(){try{localStorage.setItem(K,v)}catch(_){}}();show(v)}function toggle(ev){ev&&ev.preventDefault&&ev.preventDefault();var cur=(B&&B.dataset.view)||(S&&S.dataset.view)||((P&&getComputedStyle(P).display!=="none")?"playful":"minimal");set(cur==="playful"?"minimal":"playful",!0)}function onMQ(){set(desired(),!1)}set(desired(),!1);[B,S].forEach(function(b){b&&b.addEventListener("click",toggle,{passive:!1})});mq.addEventListener?mq.addEventListener("change",onMQ):mq.addListener(onMQ);e.__archiveViewDestroy=function(){try{mq.removeEventListener?mq.removeEventListener("change",onMQ):mq.removeListener(onMQ)}catch(_){}[B,S].forEach(function(b){try{b&&b.removeEventListener("click",toggle)}catch(_){}});e.__archiveViewBound=0;e.__archiveViewDestroy=null}}
			}),
			feature({
				id: "archiveListMotion",
				stage: "main",
				namespaces: ["archive"],
				selectors: [".archive-playful-item",".archive-minimal-item"],
				init: function(root){if(!window.gsap)return;root=root||document;var c=root.querySelector('[data-barba="container"]')||root;if(c.__alm4Cleanup)try{c.__alm4Cleanup()}catch(e){}var PRM=matchMedia("(prefers-reduced-motion: reduce)").matches,SEL_VIS=".archive-minimal-item-visual",io=null,raf=0,alive=1,deb=0,act=null;function activeView(){try{var p=c.querySelector(".section-archive-playful"),m=c.querySelector(".section-archive-minimal");if(m&&getComputedStyle(m).display!=="none")return"minimal";if(p&&getComputedStyle(p).display!=="none")return"playful"}catch(e){}return null}function isShown(el){if(!el||!c.contains(el))return!1;try{if(getComputedStyle(el).display==="none")return!1;var s=el.closest(".section-archive-playful, .section-archive-minimal");if(s&&getComputedStyle(s).display==="none")return!1}catch(e){}return!0}function getVisWrap(it){return it&&it.classList&&it.classList.contains("archive-minimal-item")?it.querySelector(SEL_VIS):null}function getVisTargets(it){var w=getVisWrap(it);if(!w)return null;var m=w.querySelector("img,video");return m?[w,m]:[w]}function prepOne(it){if(!it||PRM)return;if(!it.__almPrep){it.__almPrep=1;try{gsap.killTweensOf(it)}catch(e){}try{gsap.set(it,{y:18,autoAlpha:0,filter:"blur(10px)",willChange:"transform,opacity,filter"})}catch(e){}}var vt=getVisTargets(it);if(vt){var w=vt[0];if(!w.__almVisPrep){w.__almVisPrep=1;try{gsap.killTweensOf(vt)}catch(e){}try{gsap.set(vt,{autoAlpha:0,filter:"blur(10px)",willChange:"opacity,filter"})}catch(e){}}}}function revealOne(it,fromKick){if(!alive||!it||it.__almDone||PRM||!isShown(it))return;it.__almDone=1;var vt=getVisTargets(it),delayV=(fromKick&&vt)?.45:0,delayI=fromKick?.05:0;try{gsap.killTweensOf(it)}catch(e){}try{gsap.fromTo(it,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,ease:"power3.out",delay:delayI,overwrite:!0,clearProps:"y,filter,willChange"})}catch(e){}if(vt){var w=vt[0];if(!w.__almVisDone){w.__almVisDone=1;try{gsap.killTweensOf(vt)}catch(e){}try{gsap.fromTo(vt,{autoAlpha:0,filter:"blur(10px)"},{autoAlpha:1,filter:"blur(0px)",duration:.9,ease:"sine.out",delay:delayV,overwrite:!0,clearProps:"filter,willChange"})}catch(e){}}}}function buildIO(){io&&function(){try{io.disconnect()}catch(e){}}();io=new IntersectionObserver(function(ents){for(var k=0;k<ents.length;k++){var ent=ents[k];if(!ent.isIntersecting)continue;var it=ent.target;try{io.unobserve(it)}catch(e){}revealOne(it,!1)}},{threshold:.12,root:null,rootMargin:"0px 0px -10% 0px"})}function itemsFor(v){var sec=v==="minimal"?c.querySelector(".section-archive-minimal"):v==="playful"?c.querySelector(".section-archive-playful"):null;if(!sec||getComputedStyle(sec).display==="none")return[];return[].slice.call(sec.querySelectorAll(v==="minimal"?".archive-minimal-item":".archive-playful-item"))}function clearAll(items){for(var i=0;i<items.length;i++){var it=items[i];delete it.__almPrep;delete it.__almDone;delete it.__almObs;var w=getVisWrap(it);if(w){delete w.__almVisPrep;delete w.__almVisDone}}}function kickInView(items){if(!alive||PRM||!items||!items.length)return;for(var i=0;i<items.length;i++){var it=items[i];if(it.__almDone)continue;prepOne(it);var r=it.getBoundingClientRect();if(r.top<innerHeight&&r.bottom>0)revealOne(it,!0)}}function scan(v,doReset){if(!alive)return;var view=v||activeView();if(!view)return;var items=itemsFor(view);if(!items.length)return;io||buildIO();if(doReset)clearAll(items);for(var i=0;i<items.length;i++){var it=items[i];prepOne(it);if(!it.__almObs){it.__almObs=1;try{io.observe(it)}catch(e){}}}kickInView(items)}function schedule(v,doReset){alive&&(raf||(raf=requestAnimationFrame(function(){raf=0;scan(v,doReset)})))}function onView(ev){var v=ev&&ev.detail&&ev.detail.view;act=v||activeView();schedule(act,1)}function onFilterApplied(){schedule(act||activeView(),0)}function onResize(){schedule(act||activeView(),0)}buildIO();act=activeView();schedule(act,0);document.addEventListener("archive:view",onView,{passive:!0});document.addEventListener("archive:filter:applied",onFilterApplied,{passive:!0});window.addEventListener("resize",onResize,{passive:!0});c.__alm4Cleanup=function(){alive=0;try{document.removeEventListener("archive:view",onView)}catch(e){}try{document.removeEventListener("archive:filter:applied",onFilterApplied)}catch(e){}try{window.removeEventListener("resize",onResize)}catch(e){}raf&&(cancelAnimationFrame(raf),raf=0);io&&function(){try{io.disconnect()}catch(e){}}();io=null;try{var a=[].slice.call(c.querySelectorAll(".archive-playful-item, .archive-minimal-item"));clearAll(a)}catch(e){}delete c.__alm4Cleanup};try{CoreUtilities&&CoreUtilities.Observers&&CoreUtilities.Observers.addDom&&CoreUtilities.Observers.addDom({disconnect:c.__alm4Cleanup})}catch(e){}}
			}),
			//feature({
			//	id: "archiveViewController",
			//	stage: "early",
			//	namespaces: ["archive"],
			//	selectors: [".section-archive-playful",".section-archive-minimal",".archive-switch-block",".archive-switch",".archive-switch-dot"],
			//	init: function(e){e=e||document;var K="archiveView",mq=matchMedia("(min-width:1024px)"),P=e.querySelector(".section-archive-playful"),M=e.querySelector(".section-archive-minimal"),B=e.querySelector(".archive-switch-block"),S=e.querySelector(".archive-switch"),D=e.querySelector(".archive-switch-dot");if(!P||!M||e.__archiveViewBound)return;e.__archiveViewBound=1;function stored(){try{var v=localStorage.getItem(K);return"playful"===v||"minimal"===v?v:null}catch(_){return null}}function desired(){return mq.matches?(stored()||"playful"):"minimal"}function ui(v){var on="playful"===v;B&&(B.dataset.view=v,B.setAttribute("aria-pressed",String(on)),B.classList.toggle("is-playful",on),B.classList.toggle("is-minimal",!on));S&&(S.dataset.view=v,S.classList.toggle("is-playful",on),S.classList.toggle("is-minimal",!on));D&&(D.dataset.view=v,D.classList.toggle("is-playful",on),D.classList.toggle("is-minimal",!on))}function emit(v){try{document.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:v}}))}catch(_){}try{var f=localStorage.getItem("archiveFilter");f&&document.dispatchEvent(new CustomEvent("archive:filter",{bubbles:!0,detail:{filter:f,source:"view"}}))}catch(_){}}function show(v){P.style.display="playful"===v?"block":"none";M.style.display="minimal"===v?"block":"none";ui(v);emit(v);try{window.ScrollTrigger&&requestAnimationFrame(function(){try{ScrollTrigger.refresh()}catch(_){}})}catch(_){}}function set(v,save){v="playful"===v?"playful":"minimal";mq.matches||(v="minimal");save&&mq.matches&&function(){try{localStorage.setItem(K,v)}catch(_){}}();show(v)}function toggle(ev){ev&&ev.preventDefault&&ev.preventDefault();var cur=(B&&B.dataset.view)||(S&&S.dataset.view)||((P&&getComputedStyle(P).display!=="none")?"playful":"minimal");set("playful"===cur?"minimal":"playful",!0)}function onMQ(){set(desired(),!1)}set(desired(),!1);[B,S].forEach(function(b){b&&b.addEventListener("click",toggle,{passive:!1})});mq.addEventListener?mq.addEventListener("change",onMQ):mq.addListener(onMQ);e.__archiveViewDestroy=function(){try{mq.removeEventListener?mq.removeEventListener("change",onMQ):mq.removeListener(onMQ)}catch(_){}[B,S].forEach(function(b){try{b&&b.removeEventListener("click",toggle)}catch(_){}});e.__archiveViewBound=0;e.__archiveViewDestroy=null}}
			//}),
			//feature({
			//	id: "archiveListMotion",
			//	stage: "main",
			//	namespaces: ["archive"],
			//	selectors: [".archive-playful-item",".archive-minimal-item"],
			//	//init: function(root){if(!window.gsap)return;root=root||document;var c=root.querySelector('[data-barba="container"]')||root;if(c.__alm3Cleanup)try{c.__alm3Cleanup()}catch(e){}var PRM=matchMedia("(prefers-reduced-motion: reduce)").matches,SEL_ITEM=".archive-playful-item, .archive-minimal-item",SEL_VIS=".archive-minimal-item-visual",io=null,mo=null,raf=0,alive=1,deb=0;function activeView(){try{var p=c.querySelector(".section-archive-playful"),m=c.querySelector(".section-archive-minimal");if(m&&getComputedStyle(m).display!=="none")return"minimal";if(p&&getComputedStyle(p).display!=="none")return"playful"}catch(e){}return null}function isShown(el){if(!el||!c.contains(el))return!1;try{if(getComputedStyle(el).display==="none")return!1;var s=el.closest(".section-archive-playful, .section-archive-minimal");if(s&&getComputedStyle(s).display==="none")return!1}catch(e){}return!0}function getVis(it){return it&&it.classList&&it.classList.contains("archive-minimal-item")?it.querySelector(SEL_VIS):null}function prepOne(it){if(!it||it.__almPrep||PRM)return;it.__almPrep=1;try{gsap.killTweensOf(it)}catch(e){}try{gsap.set(it,{y:18,autoAlpha:0,filter:"blur(10px)",willChange:"transform,opacity,filter"})}catch(e){}var v=getVis(it);if(v&&!v.__almVisPrep){v.__almVisPrep=1;try{gsap.killTweensOf(v)}catch(e){}try{gsap.set(v,{autoAlpha:0,filter:"blur(10px)",willChange:"opacity,filter"})}catch(e){}}}function revealOne(it){if(!alive||!it||it.__almDone||PRM||!isShown(it))return;it.__almDone=1;var v=getVis(it);try{gsap.killTweensOf(it)}catch(e){}try{gsap.fromTo(it,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,ease:"power3.out",overwrite:!0,clearProps:"y,filter,willChange"})}catch(e){}if(v&&!v.__almVisDone){v.__almVisDone=1;try{gsap.killTweensOf(v)}catch(e){}try{gsap.fromTo(v,{autoAlpha:0,filter:"blur(10px)"},{autoAlpha:1,filter:"blur(0px)",duration:.7,ease:"sine.out",overwrite:!0,clearProps:"filter,willChange"})}catch(e){}}}function buildIO(){io&&function(){try{io.disconnect()}catch(e){}}();io=new IntersectionObserver(function(ents){for(var k=0;k<ents.length;k++){var ent=ents[k];if(!ent.isIntersecting)continue;var it=ent.target;try{io.unobserve(it)}catch(e){}revealOne(it)}},{threshold:.12,root:null,rootMargin:"0px 0px -10% 0px"})}function scan(){if(!alive)return;var items=[].slice.call(c.querySelectorAll(SEL_ITEM));if(!items.length)return;io||buildIO();for(var k=0;k<items.length;k++){var it=items[k];prepOne(it);if(!it.__almObs){it.__almObs=1;try{io.observe(it)}catch(e){}}}kickInView()}function kickInView(){if(!alive||PRM)return;var v=activeView(),sec=v==="minimal"?c.querySelector(".section-archive-minimal"):v==="playful"?c.querySelector(".section-archive-playful"):null;if(!sec||getComputedStyle(sec).display==="none")return;var items=[].slice.call(sec.querySelectorAll(v==="minimal"?".archive-minimal-item":".archive-playful-item"));for(var i=0;i<items.length;i++){var it=items[i];if(it.__almDone)continue;var r=it.getBoundingClientRect();if(r.top<innerHeight&&r.bottom>0)revealOne(it)}}function scheduleScan(){alive&&(raf||(raf=requestAnimationFrame(function(){raf=0,scan()})))}function hardReset(){if(!alive)return;try{io&&io.disconnect&&io.disconnect()}catch(e){}io=null;try{var items=[].slice.call(c.querySelectorAll(SEL_ITEM));for(var k=0;k<items.length;k++){var it=items[k];delete it.__almPrep;delete it.__almDone;delete it.__almObs;var v=getVis(it);if(v){delete v.__almVisPrep;delete v.__almVisDone}}}catch(e){}scheduleScan()}function debouncedReset(){if(deb)return;deb=1;requestAnimationFrame(function(){deb=0;hardReset()})}buildIO();scan();mo=new MutationObserver(scheduleScan);try{mo.observe(c,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})}catch(e){}document.addEventListener("archive:view",debouncedReset,{passive:!0});document.addEventListener("archive:filter:applied",scheduleScan,{passive:!0});window.addEventListener("resize",scheduleScan,{passive:!0});c.__alm3Cleanup=function(){alive=0;try{document.removeEventListener("archive:view",debouncedReset)}catch(e){}try{document.removeEventListener("archive:filter:applied",scheduleScan)}catch(e){}try{window.removeEventListener("resize",scheduleScan)}catch(e){}raf&&(cancelAnimationFrame(raf),raf=0);io&&function(){try{io.disconnect()}catch(e){}}();mo&&function(){try{mo.disconnect()}catch(e){}}();io=null;mo=null;try{var items=[].slice.call(c.querySelectorAll(SEL_ITEM));for(var k=0;k<items.length;k++){var it=items[k];delete it.__almPrep;delete it.__almDone;delete it.__almObs;var v=getVis(it);if(v){delete v.__almVisPrep;delete v.__almVisDone}}}catch(e){}delete c.__alm3Cleanup};try{CoreUtilities&&CoreUtilities.Observers&&CoreUtilities.Observers.addDom&&CoreUtilities.Observers.addDom({disconnect:c.__alm3Cleanup})}catch(e){}}
			//	init: function(root){if(!window.gsap)return;root=root||document;var c=root.querySelector('[data-barba="container"]')||root;if(c.__alm3Cleanup)try{c.__alm3Cleanup()}catch(e){}var PRM=matchMedia("(prefers-reduced-motion: reduce)").matches,SEL_ITEM=".archive-playful-item, .archive-minimal-item",SEL_VIS=".archive-minimal-item-visual",io=null,mo=null,raf=0,alive=1,deb=0;function activeView(){try{var p=c.querySelector(".section-archive-playful"),m=c.querySelector(".section-archive-minimal");if(m&&getComputedStyle(m).display!=="none")return"minimal";if(p&&getComputedStyle(p).display!=="none")return"playful"}catch(e){}return null}function isShown(el){if(!el||!c.contains(el))return!1;try{if(getComputedStyle(el).display==="none")return!1;var s=el.closest(".section-archive-playful, .section-archive-minimal");if(s&&getComputedStyle(s).display==="none")return!1}catch(e){}return!0}function getVisWrap(it){return it&&it.classList&&it.classList.contains("archive-minimal-item")?it.querySelector(SEL_VIS):null}function getVisTargets(it){var w=getVisWrap(it);if(!w)return null;var m=w.querySelector("img,video");return m?[w,m]:[w]}function prepOne(it){if(!it||PRM)return;it.__almPrep||(it.__almPrep=1,(()=>{try{gsap.killTweensOf(it)}catch(e){}try{gsap.set(it,{y:18,autoAlpha:0,filter:"blur(10px)",willChange:"transform,opacity,filter"})}catch(e){}})());var vt=getVisTargets(it);if(vt){var w=vt[0];if(!w.__almVisPrep){w.__almVisPrep=1;try{gsap.killTweensOf(vt)}catch(e){}try{gsap.set(vt,{autoAlpha:0,filter:"blur(10px)",willChange:"opacity,filter"})}catch(e){}}}}function revealOne(it,fromKick){if(!alive||!it||it.__almDone||PRM||!isShown(it))return;it.__almDone=1;var vt=getVisTargets(it),delayV=(fromKick&&vt)?.45:0,delayI=(fromKick?.05:0);try{gsap.killTweensOf(it)}catch(e){}try{gsap.fromTo(it,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,ease:"power3.out",delay:delayI,overwrite:!0,clearProps:"y,filter,willChange"})}catch(e){}if(vt){var w=vt[0];if(!w.__almVisDone){w.__almVisDone=1;try{gsap.killTweensOf(vt)}catch(e){}try{gsap.fromTo(vt,{autoAlpha:0,filter:"blur(10px)"},{autoAlpha:1,filter:"blur(0px)",duration:.9,ease:"sine.out",delay:delayV,overwrite:!0,clearProps:"filter,willChange"})}catch(e){}}}}function buildIO(){io&&function(){try{io.disconnect()}catch(e){}}();io=new IntersectionObserver(function(ents){for(var k=0;k<ents.length;k++){var ent=ents[k];if(!ent.isIntersecting)continue;var it=ent.target;try{io.unobserve(it)}catch(e){}revealOne(it,!1)}},{threshold:.12,root:null,rootMargin:"0px 0px -10% 0px"})}function kickInView(){if(!alive||PRM)return;var v=activeView(),sec=v==="minimal"?c.querySelector(".section-archive-minimal"):v==="playful"?c.querySelector(".section-archive-playful"):null;if(!sec||getComputedStyle(sec).display==="none")return;var items=[].slice.call(sec.querySelectorAll(v==="minimal"?".archive-minimal-item":".archive-playful-item"));for(var i=0;i<items.length;i++){var it=items[i];if(it.__almDone)continue;prepOne(it);var r=it.getBoundingClientRect();if(r.top<innerHeight&&r.bottom>0)revealOne(it,!0)}}function scan(){if(!alive)return;var items=[].slice.call(c.querySelectorAll(SEL_ITEM));if(!items.length)return;io||buildIO();for(var k=0;k<items.length;k++){var it=items[k];prepOne(it);if(!it.__almObs){it.__almObs=1;try{io.observe(it)}catch(e){}}}kickInView()}function scheduleScan(){alive&&(raf||(raf=requestAnimationFrame(function(){raf=0,scan()})))}function hardReset(){if(!alive)return;try{io&&io.disconnect&&io.disconnect()}catch(e){}io=null;try{var items=[].slice.call(c.querySelectorAll(SEL_ITEM));for(var k=0;k<items.length;k++){var it=items[k];delete it.__almPrep;delete it.__almDone;delete it.__almObs;var w=getVisWrap(it);if(w){delete w.__almVisPrep;delete w.__almVisDone}}}catch(e){}scheduleScan()}function debouncedReset(){if(deb)return;deb=1;requestAnimationFrame(function(){deb=0;hardReset()})}buildIO();scan();mo=new MutationObserver(scheduleScan);try{mo.observe(c,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["class","style"]})}catch(e){}document.addEventListener("archive:view",debouncedReset,{passive:!0});document.addEventListener("archive:filter:applied",scheduleScan,{passive:!0});window.addEventListener("resize",scheduleScan,{passive:!0});c.__alm3Cleanup=function(){alive=0;try{document.removeEventListener("archive:view",debouncedReset)}catch(e){}try{document.removeEventListener("archive:filter:applied",scheduleScan)}catch(e){}try{window.removeEventListener("resize",scheduleScan)}catch(e){}raf&&(cancelAnimationFrame(raf),raf=0);io&&function(){try{io.disconnect()}catch(e){}}();mo&&function(){try{mo.disconnect()}catch(e){}}();io=null;mo=null;try{var items=[].slice.call(c.querySelectorAll(SEL_ITEM));for(var k=0;k<items.length;k++){var it=items[k];delete it.__almPrep;delete it.__almDone;delete it.__almObs;var w=getVisWrap(it);if(w){delete w.__almVisPrep;delete w.__almVisDone}}}catch(e){}delete c.__alm3Cleanup};try{CoreUtilities&&CoreUtilities.Observers&&CoreUtilities.Observers.addDom&&CoreUtilities.Observers.addDom({disconnect:c.__alm3Cleanup})}catch(e){}}
			//}),
			feature({
				...
				init: function(e){if(!(e=e||document).__archiveControllerBound)return e.__archiveControllerBound=1,e.__archiveControllerDestroy=function(){e.__archiveControllerBound=0,e.__archiveControllerDestroy=null}}
			})
		);
