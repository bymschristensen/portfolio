...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(t){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;t=t||document;var e=t.querySelector(".hero-section-showreel");if(!e||e.__hsBound)return;var r=e.querySelector(".showreel-track"),n=e.querySelector(".showreel-container");if(!r||!n)return;e.__hsBound=1,n.style.transformOrigin="center center",n.style.willChange="transform";try{gsap.set(n,{x:0,scaleX:1,scaleY:1,force3D:!0})}catch(t){}var o={x:0,sc:1,tsc:1,px:0,hasMove:!1,raf:0,last:0,w:0,tw:0,lock:!1,vx:0,sq:0},A=1.1,P=20,S=.96,M=1.1,D=60,F=10,L=6,s=gsap.quickSetter(n,"scaleX"),a=gsap.quickSetter(n,"scaleY"),i=gsap.quickSetter(n,"x","px");function c(){var t=n.getBoundingClientRect(),e=r.getBoundingClientRect();o.w=t.width||n.offsetWidth||0,o.tw=e.width||r.offsetWidth||0}function l(){return Math.max(0,(o.tw-o.w*o.sc)/2)}function u(t){var e=r.getBoundingClientRect(),n=(t-e.left)+P+o.w*o.sc/2-(o.tw/2),s=l(),i=Math.max(-s,Math.min(s,n)),c=s?i/s:0,u=Math.tanh(c*A)/Math.tanh(A);return u*s}function d(t){var e=t.clientX;o.hasMove&&(o.vx+=e-(o.px||e)),o.hasMove=!0,o.px=e}function f(){var t=r.getBoundingClientRect(),e=(innerHeight||document.documentElement.clientHeight||0),n=t.top+t.height/2,s=Math.abs(n-e/2),i=1-Math.min(1,s/(.75*e));o.tsc=S+i*(M-S),o.lock=o.w*o.sc>=o.tw-1}function h(){c()}function p(t){o.last||(o.last=t);var e=Math.min(.05,(t-o.last)/1e3);o.last=t,l();var n=innerWidth||document.documentElement.clientWidth||1,c=.5*n,p=o.px||c,h=(c-p)/n*D,v=o.lock?0:o.hasMove?u(p)+h:0,g=1-Math.exp(-F*e),x=1-Math.exp(-L*e);o.sc+=x*(o.tsc-o.sc),o.x+=g*(v-o.x),o.vx*=.9;var y=0;Math.abs(o.vx)>.1&&(y=-(o.vx/400),y>.22?y=.22:y<-.22&&(y=-.22)),o.sq+=.18*(y-o.sq);var w=o.sc*(1+o.sq),E=o.sc*(1-.55*o.sq);i(o.x),s(w),a(E),o.raf=requestAnimationFrame(p)}c(),f(),addEventListener("pointermove",d,{passive:!0}),addEventListener("scroll",f,{passive:!0}),addEventListener("resize",h,{passive:!0}),o.raf=requestAnimationFrame(p),e.__hsDestroy=function(){try{removeEventListener("pointermove",d)}catch(t){}try{removeEventListener("scroll",f)}catch(t){}try{removeEventListener("resize",h)}catch(t){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(t){}}},destroy:async function(t){t=t||document;var e=t.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{e&&e.__hsDestroy&&e.__hsDestroy()}catch(t){}}}),
			feature({
