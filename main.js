...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1;n.style.transformOrigin="50% 50%";n.style.willChange="transform";n.style.transform="translate3d(0,0,0)";var o=n.querySelector(".showreel-visual")||n.firstElementChild,i=o?gsap.quickSetter(o,"scale"):null;o&&(o.style.transformOrigin="50% 50%",o.style.willChange="transform");var a=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9");a&&(n.style.aspectRatio="16/9");var s={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0},c=gsap.quickSetter(n,"x","px"),l=3;function u(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();s.w=e.width||n.offsetWidth||0,s.tw=t.width||r.offsetWidth||0,s.left=t.left,s.right=t.right,s.baseC=e.left+e.width/2-s.x,a||s.w&&(n.style.height=s.w*9/16+"px")}function d(e,t,r){return e<t?t:e>r?r:e}function f(e){var t=d(e,s.left,s.right),o=t+s.w/2,i=s.left+s.w/2,a=s.right-s.w/2;i>a&&(i=a=(s.left+s.right)/2);var c=d(o,i,a);return c-s.baseC}function v(e){var t=e.clientX;s.hasMove&&null!=s.px&&(s.vx+=t-s.px),s.hasMove=!0,s.px=t}function p(e){if(!s.hasMove||null==s.px)return s.last=e,void(s.raf=requestAnimationFrame(p));s.last||(s.last=e);var t=Math.min(.05,(e-s.last)/1e3);s.last=e;var r=f(s.px),o=1-Math.exp(-l*t);s.x+=o*(r-s.x);s.vx*=.86;var a=s.vx,u=0;if(Math.abs(a)>.1){var d=-(a/900),v=.03;d>v?d=v:d<-v&&(d=-v),u=d}s.sq+=.15*(u-s.sq);var h=1+s.sq;c(s.x),i&&i(h),s.raf=requestAnimationFrame(p)}u(),s.raf=requestAnimationFrame(p),addEventListener("pointermove",v,{passive:!0}),addEventListener("resize",u,{passive:!0}),t.__hsDestroy=function(){try{removeEventListener("pointermove",v)}catch(e){}try{removeEventListener("resize",u)}catch(e){}try{s.raf&&cancelAnimationFrame(s.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
