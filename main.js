...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		const EntryAnimations = {
			selected(e=document){const t=e.querySelector(".selected-container"),a=t?.querySelector(".selected-content"),l=gsap.timeline();if(!(t&&a))return l;const o=s=>{if(s.__entryPrepared)return;const e=s.querySelector(".selected-visual"),t=s.querySelector(".selected-item-header .headline-m"),a=s.querySelector(".selected-item-details"),l=s.querySelectorAll(".selected-item-details .body-s");e&&gsap.set(e,{scaleY:0,transformOrigin:"bottom center",opacity:0}),t&&gsap.set(t,{opacity:0}),a&&gsap.set(a,{opacity:0,height:0}),l.length&&gsap.set(l,{opacity:0,y:20,filter:"blur(10px)"}),s.__entryPrepared=!0},r=s=>requestAnimationFrame(()=>requestAnimationFrame(s)),n=s=>{const n=()=>r(s);if(t.hasAttribute("data-loop-ready"))return n();const i=()=>{a.removeEventListener("selected:loop-ready",i,!0),n()};a.addEventListener("selected:loop-ready",i,!0),setTimeout(()=>{a.removeEventListener("selected:loop-ready",i,!0),n()},600)},i=()=>{const e=innerWidth||document.documentElement.clientWidth,H=innerHeight||document.documentElement.clientHeight,d=[...a.querySelectorAll(".selected-item-outer")];if(!d.length)return;d.forEach((e=>{e.__entryDone||o(e)}));const v=d.map((t=>{const a=t.getBoundingClientRect();return{o:t,r:a,area:Math.max(0,Math.min(a.right,e)-Math.max(a.left,0))*Math.max(0,Math.min(a.bottom,H)-Math.max(a.top,0)),center:(a.left+a.right)/2}}));let S=v.filter((e=>e.area>1)).sort(((e,t)=>e.r.left-t.r.left));if(!S.length){const t=e/2;S=v.slice().sort(((e,a)=>Math.abs(e.center-t)-Math.abs(a.center-t))).slice(0,2).sort(((e,t)=>e.r.left-t.r.left))}const c=new Set(S.map((e=>e.o)));v.forEach((e=>{if(e.o.__entryDone||c.has(e.o))return;const t=e.o.querySelector(".selected-visual"),a=e.o.querySelector(".selected-item-header .headline-m"),l=e.o.querySelector(".selected-item-details"),o=e.o.querySelectorAll(".selected-item-details .body-s");t&&gsap.set(t,{scaleY:1,opacity:1}),a&&gsap.set(a,{opacity:1}),l&&gsap.set(l,{opacity:1,height:"auto"}),o.length&&gsap.set(o,{opacity:1,y:0,filter:"blur(0px)"}),e.o.__entryDone=!0})),S.forEach(((e,t)=>{const a=e.o;if(a.__entryDone)return;const r=a.querySelector(".selected-visual"),n=a.querySelector(".selected-item-header .headline-m"),i=a.querySelector(".selected-item-details"),s=a.querySelectorAll(".selected-item-details .body-s"),d=.15*t;r&&l.set(r,{opacity:1},d).to(r,{scaleY:1,duration:.8,ease:"power2.out"},d),n&&l.set(n,{opacity:1},d+.2).call((()=>{if(n.__splitRun)return;n.__splitRun=!0,(CoreUtilities?.Fonts?.ready?.()??Promise.resolve()).then((()=>{if(!window.SplitText){gsap.to(n,{y:0,opacity:1,duration:.6,ease:"power2.out"});return}const e=splitAndMask(n);gsap.delayedCall(.15,(()=>{animateLines(e.lines).eventCallback("onComplete",(()=>safelyRevertSplit(e,n)))}))}))}),null,d+.2),i&&l.to(i,{opacity:1,height:"auto",duration:.4,ease:"power2.out"},d+.6),s.length&&l.to(s,{opacity:1,y:0,filter:"blur(0px)",duration:.4,ease:"power2.out",stagger:.15},d+.6),a.__entryDone=!0}))};return n(i),l},
			capabilities=function(e,{delayHero:t=!1}={}){var n=gsap.timeline();var o=e.querySelector(".section-table-of-contents");o&&gsap.set(o,{autoAlpha:0});n.to({},0.01,{});var r=e.querySelector(".section-hero .headline-lg"),i=e.querySelector(".section-hero .button-primary");if(r){var a=t?0.2:0;gsap.set(r,{autoAlpha:0,visibility:"hidden"});n.addLabel("heroStart",a).call(function(){gsap.set(r,{autoAlpha:1,visibility:"visible"});var d=(window.CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready?CoreUtilities.Fonts.ready():Promise.resolve());var u=0,f=function(){try{if(window.SplitText&&window.splitAndMask&&window.animateLines&&window.safelyRevertSplit){var s=splitAndMask(r);animateLines(s.lines).eventCallback("onComplete",function(){safelyRevertSplit(s,r)});}else{gsap.to(r,{y:0,opacity:1,duration:.6,ease:"power2.out"});} }catch{} };f();(function p(){if(window.SplitText&&window.splitAndMask&&window.animateLines)return;u++;if(u>40)return;setTimeout(p,50);})();d.catch(function(){});},null,"heroStart")}i&&(gsap.set(i,{autoAlpha:0,y:20,filter:"blur(10px)"}),n.to(i,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.6,ease:"power2.out"},"heroStart+=0.4"));var l=gsap.utils.toArray(e.querySelectorAll(".table-of-contents-item"));l.length&&n.from(l,{autoAlpha:0,paddingTop:"6rem",paddingBottom:"6rem",duration:1,ease:"power2.out",stagger:.15},0);o&&n.to(o,{autoAlpha:1,duration:.6,ease:"power2.out"},0);return n},
			...
			caseStudy=function(root){const tl=gsap.timeline(),hero=root.querySelector(".cs-hero-image"),headWrap=root.querySelector(".cs-headline"),headEl=headWrap&&(headWrap.querySelector("h1, .headline-xl, .headline-lg, .headline, [data-split], [role='heading'][aria-level='1']")||[...headWrap.querySelectorAll("*")].find(n=>(n.textContent||"").trim().length&&getComputedStyle(n).display!=="none")||headWrap),sub=root.querySelector(".cs-titles-inner .headline-m"),unhide=e=>{if(!e)return;try{e.removeAttribute("data-entry-hidden"),e.removeAttribute("hidden"),e.removeAttribute("aria-hidden"),e.style.visibility="visible",["hidden","is-hidden","u-hidden","opacity-0","visually-hidden"].forEach(c=>e.classList&&e.classList.remove(c))}catch{}};if(hero){gsap.set(hero,{autoAlpha:0,y:100,filter:"blur(10px)"}),unhide(hero),tl.to(hero,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.7,ease:"power2.out"},0)}if(headEl){gsap.set(headEl,{autoAlpha:0,visibility:"hidden",display:"block"}),unhide(headEl),sub&&(gsap.set(sub,{autoAlpha:0,y:20,filter:"blur(10px)"}),unhide(sub));const fontsReady=(CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready&&CoreUtilities.Fonts.ready())||Promise.resolve(),splitReady=new Promise(r=>{let t=0;!function o(){if(window.SplitText&&window.animateLines)return r();t++>40?r():setTimeout(o,50)}()});tl.addLabel("h",.15).call(()=>{Promise.race([fontsReady,splitReady]).then(()=>{requestAnimationFrame(()=>requestAnimationFrame(()=>{let split;if(window.splitAndMask)split=splitAndMask(headEl);else{const w=document.createElement("div"),line=document.createElement("div");w.className="text-mask",w.style.overflow="hidden",line.className="split-line",line.innerHTML=headEl.innerHTML,w.appendChild(line),headEl.innerHTML="",headEl.appendChild(w),gsap.set(line,{yPercent:100,rotation:10,transformOrigin:"0 10%",willChange:"transform"}),split={lines:[line],revert(){try{headEl.innerHTML=line.innerHTML}catch{}}}}const lines=split&&split.lines&&split.lines.length?split.lines:[headEl],headlineDur=.8+.08*Math.max(0,lines.length-1);gsap.set(headEl,{autoAlpha:1,visibility:"visible"}),sub&&tl.to(sub,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.5,ease:"power2.out"},"h+"+Math.max(0,headlineDur-.2));(window.animateLines?animateLines(lines):gsap.to(lines,{yPercent:0,rotation:0,duration:headlineDur,ease:"power2.out",stagger:.08})).eventCallback("onComplete",()=>{try{(window.safelyRevertSplit?window.safelyRevertSplit:split.revert).call(split,split,headEl)}catch{}try{"inline"===getComputedStyle(headEl).display&&(headEl.style.display="inline")}catch{}})}))})},null,"h")}return tl}
		};
