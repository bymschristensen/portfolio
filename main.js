	...
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({
				...
				init: async r=>{if(matchMedia("(prefers-reduced-motion: reduce)").matches)return;const e=r.querySelectorAll(".infinite-gallery");if(!e.length)return;const t=async(e,t=3500)=>{const n=[...e.querySelectorAll("img")];if(!n.length)return;const i=e=>e.naturalWidth>0&&e.naturalHeight>0;const o=[];try{await Promise.race([Promise.all(n.map((e=>{if(i(e))return Promise.resolve();const n="function"==typeof e.decode?e.decode().catch(()=>{}):Promise.resolve(),o=new Promise((t=>{const n=()=>{e.removeEventListener("load",n),t()};e.addEventListener("load",n,{once:!0})})),s=new Promise((t=>{let n=0;!function o(){if(i(e)||n++>80)return t();o._tm=setTimeout(o,40),o.push&&o.push(o._tm)}()}));return Promise.race([n,o,s])}))),new Promise((e=>o.push(setTimeout(e,t)))]]}finally{o.forEach(clearTimeout)}};e.forEach((e=>{const n=e.querySelector(".infinite-gallery-wrapper");if(!n||n.__inited)return;n.__inited=!0,e.setAttribute("data-armed","0");const i=[...n.querySelectorAll(".service-visual-wrapper")];if(!i.length){e.setAttribute("data-armed","1");return}const o=new Set;let s=!1,a=0,l=0;const c=("right"===(e.dataset.direction||"left").toLowerCase()?-1:1),d=parseFloat(e.dataset.speed)||.6,u=e=>{return(e.getBoundingClientRect().width||0)+(parseFloat(getComputedStyle(n).gap||"0")||0)},f=()=>n.querySelectorAll('.service-visual-wrapper[data-clone="1"]').forEach((e=>e.remove())),p=()=>{i.forEach(((e,t)=>{e.style.height="";const r=e.getBoundingClientRect().width||e.offsetWidth||0;let a=parseFloat(getComputedStyle(e).height)||e.getBoundingClientRect().height||0;if(a<=0){const t=e.querySelector("img");t&&t.naturalWidth>0&&t.naturalHeight>0&&r>0&&(a=t.naturalHeight/t.naturalWidth*r)}const l=String(t);e.dataset.key=l,e.dataset.targetH=String(Math.max(0,Math.round(a))),e.style.minWidth=r+"px",e.style.maxWidth=r+"px",e.style.overflow="hidden",o.has(l)?(e.style.height="",e.dataset.revealed="1",e.dataset.revealing=""):(e.style.height="0px",e.dataset.revealed="0",e.dataset.revealing="")}))},g=()=>{i.forEach((e=>{const t=e.dataset.key||"",r=+e.dataset.targetH||0,s=e.cloneNode(!0);s.setAttribute("data-clone","1"),s.dataset.key=t,s.style.minWidth=e.style.minWidth,s.style.maxWidth=e.style.maxWidth,s.style.height=r>0?r+"px":"0px",s.style.overflow="hidden",n.appendChild(s)}))},h=()=>{let e=0;return n.childNodes.forEach((t=>{1===t.nodeType&&(e+=u(t))})),e},m=()=>{f(),g(),g();let t=0;for(;h()<3*e.clientWidth&&t++<8;)g()},y=()=>{e.setAttribute("data-armed","1");const t=e.getBoundingClientRect(),n=innerHeight||document.documentElement.clientHeight||0;t.bottom>0&&t.top<n&&(s=!0,cancelAnimationFrame(a),a=requestAnimationFrame(v))},v=t=>{if(!s){cancelAnimationFrame(a);return}if(t-l<80){a=requestAnimationFrame(v);return}l=t||performance.now();const r=innerWidth||document.documentElement.clientWidth||0,i=-.05*r,d=1.05*r;const c=[...n.querySelectorAll('.service-visual-wrapper:not([data-clone])')].filter((e=>{const t=e.getBoundingClientRect();return t.right>i&&t.left<d})).filter((e=>"1"!==e.dataset.revealed&&"1"!==e.dataset.revealing)).sort(((e,t)=>e.getBoundingClientRect().left-t.getBoundingClientRect().left));if(c.length){const t=gsap.timeline();c.forEach(((e,r)=>{const i=+e.dataset.targetH||0,s=e.dataset.key||"";e.dataset.revealing="1",t.to(e,{height:i,duration:.9,ease:"power2.out",onComplete:()=>{e.style.height="",e.dataset.revealed="1",e.dataset.revealing="",o.add(s),n.querySelectorAll(`.service-visual-wrapper[data-clone][data-key="${s}"]`).forEach((e=>e.style.height=i+"px"))}},.12*r)}))}a=requestAnimationFrame(v)},w=(e,t)=>{const r=(t||16.6667)/1e3,i=60*d;l-=c*i*r;let o=n.firstElementChild,s=0;for(;o&&l<-u(o)&&s++<50;)l+=u(o),n.appendChild(o),o=n.firstElementChild;let a=n.lastElementChild;s=0;for(;a&&l>0&&s++<50;)l-=u(a),n.insertBefore(a,n.firstElementChild),a=n.lastElementChild;gsap.set(n,{x:l});const f=(innerWidth||0)/2;n.querySelectorAll(".service-visual").forEach((e=>{const t=e.closest(".service-visual-wrapper");if(!t)return;const r=t.getBoundingClientRect(),i=(f-(r.left+r.width/2))/((innerWidth)||1);e.style.setProperty("--drift",40*i+"px")}))},b=t=>{t.forEach((t=>{if(t.target!==e)return;t.isIntersecting?(s=!0,cancelAnimationFrame(a),a=requestAnimationFrame(v)):(s=!1,cancelAnimationFrame(a))}))},k=new ResizeObserver((()=>{p(),f(),m(),o.forEach((e=>{const t=i.find((t=>t.dataset.key===e)),r=t&&+t.dataset.targetH||0;n.querySelectorAll(`.service-visual-wrapper[data-clone][data-key="${e}"]`).forEach((e=>e.style.height=r+"px"))})),y()}));(async()=>{await t(n),p(),m(),y();const r=new IntersectionObserver(b,{root:null,threshold:0,rootMargin:"0px 0px -5% 0px"});r.observe(e),CoreUtilities.Observers.addDom(r),CoreUtilities.Observers.addDom({disconnect(){s=!1,cancelAnimationFrame(a)}});const i=(e,t)=>w(e,t);gsap.ticker.add(i),CoreUtilities.Observers.addTicker(i),k.observe(n),CoreUtilities.Observers.addDom(k)})()}))}
			})
		);
...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		// Entry Animations
		var EntryAnimations = {};
		EntryAnimations.selected=function(e){var t=(e=e||document).querySelector(".selected-container"),r=t&&t.querySelector(".selected-content"),o=gsap.timeline();if(!t||!r)return o;return function(e){function o(){requestAnimationFrame((function(){requestAnimationFrame(e)}))}if(t.hasAttribute("data-loop-ready"))return o();function i(){r.removeEventListener("selected:loop-ready",i,!0),o()}r.addEventListener("selected:loop-ready",i,!0),setTimeout((function(){r.removeEventListener("selected:loop-ready",i,!0),o()}),600)}((function(){var e=innerWidth||document.documentElement.clientWidth,t=innerHeight||document.documentElement.clientHeight,i=[].slice.call(r.querySelectorAll(".selected-item-outer"));if(i.length){i.forEach((function(e){e.__entryDone||function(e){if(!e.__entryPrepared){var t=e.querySelector(".selected-visual"),r=e.querySelector(".selected-item-header .headline-m"),o=e.querySelector(".selected-item-details"),i=e.querySelectorAll(".selected-item-details .body-s");t&&gsap.set(t,{scaleY:0,transformOrigin:"bottom center",opacity:0}),r&&gsap.set(r,{opacity:0}),o&&gsap.set(o,{opacity:0,height:0}),i.length&&gsap.set(i,{opacity:0,y:20,filter:"blur(10px)"}),e.__entryPrepared=!0}}(e)}));var n=i.map((function(r){var o=r.getBoundingClientRect();return{o:r,r:o,area:Math.max(0,Math.min(o.right,e)-Math.max(o.left,0))*Math.max(0,Math.min(o.bottom,t)-Math.max(o.top,0)),center:(o.left+o.right)/2}})),a=n.filter((function(e){return e.area>1})).sort((function(e,t){return e.r.left-t.r.left}));if(!a.length){var l=e/2;a=n.slice().sort((function(e,t){return Math.abs(e.center-l)-Math.abs(t.center-l)})).slice(0,2).sort((function(e,t){return e.r.left-t.r.left}))}var c={};a.forEach((function(e){c[e.o]=!0})),n.forEach((function(e){if(!e.o.__entryDone&&!c[e.o]){var t=e.o.querySelector(".selected-visual"),r=e.o.querySelector(".selected-item-header .headline-m"),o=e.o.querySelector(".selected-item-details"),i=e.o.querySelectorAll(".selected-item-details .body-s");t&&gsap.set(t,{scaleY:1,opacity:1}),r&&gsap.set(r,{opacity:1}),o&&gsap.set(o,{opacity:1,height:"auto"}),i.length&&gsap.set(i,{opacity:1,y:0,filter:"blur(0px)"}),e.o.__entryDone=!0}})),a.forEach((function(e,t){var r=e.o;if(!r.__entryDone){var i=r.querySelector(".selected-visual"),n=r.querySelector(".selected-item-header .headline-m"),a=r.querySelector(".selected-item-details"),l=r.querySelectorAll(".selected-item-details .body-s"),c=.15*t;i&&o.set(i,{opacity:1},c).to(i,{scaleY:1,duration:.8,ease:"power2.out"},c),n&&o.set(n,{opacity:1},c+.2).call((function(){n.__splitRun||(n.__splitRun=!0,(CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready?CoreUtilities.Fonts.ready():Promise.resolve()).then((function(){if(window.SplitText){var e=splitAndMask(n);gsap.delayedCall(.15,(function(){animateLines(e.lines).eventCallback("onComplete",(function(){safelyRevertSplit(e,n)}))}))}else gsap.to(n,{y:0,opacity:1,duration:.6,ease:"power2.out"})})))}),null,c+.2),a&&o.to(a,{opacity:1,height:"auto",duration:.4,ease:"power2.out"},c+.6),l.length&&o.to(l,{opacity:1,y:0,filter:"blur(0px)",duration:.4,ease:"power2.out",stagger:.15},c+.6),r.__entryDone=!0}}))}})),o};
		...
		EntryAnimations.caseStudy=function(e){var t=gsap.timeline(),i=e.querySelector(".cs-hero-image"),n=e.querySelector(".cs-headline"),a=n&&(n.querySelector("h1, .headline-xl, .headline-lg, .headline, [data-split], [role='heading'][aria-level='1']")||[].slice.call(n.querySelectorAll("*")).find(function(e){return((e.textContent||"").trim().length&&"none"!==getComputedStyle(e).display)})||n),l=e.querySelector(".cs-titles-inner .headline-m"),r=function(e){if(!e)return;try{e.removeAttribute("data-entry-hidden"),e.removeAttribute("hidden"),e.removeAttribute("aria-hidden"),e.style.visibility="visible",["hidden","is-hidden","u-hidden","opacity-0","visually-hidden"].forEach(function(t){e.classList&&e.classList.remove(t)})}catch{}};if(i){gsap.set(i,{autoAlpha:0,y:100,filter:"blur(10px)"}),r(i),t.to(i,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.7,ease:"power2.out"},0)}if(a){gsap.set(a,{autoAlpha:0,visibility:"hidden",display:"block"}),r(a),l&&(gsap.set(l,{autoAlpha:0,y:20,filter:"blur(10px)"}),r(l));var o=window.CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready&&CoreUtilities.Fonts.ready()||Promise.resolve(),s=new Promise(function(e){var t=0;!function i(){return window.SplitText&&window.animateLines?e():++t>40?e():void setTimeout(i,50)}()});t.addLabel("h",.15).call(function(){Promise.race([o,s]).then(function(){requestAnimationFrame(function(){requestAnimationFrame(function(){try{a._split&&function(e,t){try{CoreUtilities.Text.safelyRevertSplit(e,t)}catch{}}(a._split,a);var e=CoreUtilities&&CoreUtilities.Text&&CoreUtilities.Text.splitAndMask?CoreUtilities.Text.splitAndMask(a):function(){var e=document.createElement("div"),t=document.createElement("div");return e.className="text-mask",e.style.overflow="hidden",t.className="split-line",t.innerHTML=a.innerHTML,e.appendChild(t),a.innerHTML="",a.appendChild(e),gsap.set(t,{yPercent:100,rotation:10,transformOrigin:"0 10%",willChange:"transform"}),{lines:[t],revert:function(){try{a.innerHTML=t.innerHTML}catch{}}}}(),i=e&&e.lines&&e.lines.length?e.lines:[a],n=.8+.08*Math.max(0,i.length-1);gsap.set(a,{autoAlpha:1,visibility:"visible"}),l&&t.to(l,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.5,ease:"power2.out"},"h+"+Math.max(0,n-.2)),(CoreUtilities&&CoreUtilities.Text&&CoreUtilities.Text.animateLines?CoreUtilities.Text.animateLines(i):gsap.to(i,{yPercent:0,rotation:0,duration:n,ease:"power2.out",stagger:.08})).eventCallback("onComplete",function(){try{(window.safelyRevertSplit?window.safelyRevertSplit:e.revert).call(e,e,a)}catch{}try{"inline"===getComputedStyle(a).display&&(a.style.display="inline")}catch{}})}catch{gsap.to(a,{y:0,autoAlpha:1,duration:.6,ease:"power2.out"}),l&&t.to(l,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.5,ease:"power2.out"},"h+=0.4")}})})})},null,"h")}return t};
