	...
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({
				...
				init: async r=>{if(!window.gsap||!window.ScrollTrigger)return;const s=[...r.querySelectorAll(".section-single-service")];if(!s.length)return;s.forEach(e=>{const t=e.offsetHeight>window.innerHeight,a=t?"bottom bottom":"top top";gsap.timeline({scrollTrigger:{trigger:e,start:a,end:"bottom top",pin:!0,pinSpacing:!1,scrub:1,anticipatePin:1,invalidateOnRefresh:!0}}).to(e,{ease:"none",startAt:{filter:"contrast(100%) blur(0px)"},filter:"contrast(10%) blur(10px)"},0)});try{ScrollTrigger.refresh()}catch{}}
			}),
			//feature({id:"productGallery",stage:"main",namespaces:["capabilities"],selectors:[".infinite-gallery"],init:async e=>{if(!window.gsap||matchMedia("(prefers-reduced-motion: reduce)").matches)return;const t=[...e.querySelectorAll(".infinite-gallery")];if(!t.length)return;const r=e=>{try{window.CoreUtilities&&CoreUtilities.Observers&&CoreUtilities.Observers.addDom(e)}catch{}},i=e=>{try{window.CoreUtilities&&CoreUtilities.Observers&&CoreUtilities.Observers.addTicker(e)}catch{}};t.forEach(e=>{const t=e.querySelector(".infinite-gallery-wrapper");if(!t||t.__inited)return;t.__inited=!0,e.setAttribute("data-armed","0");const n=Array.from(t.querySelectorAll(".service-visual-wrapper"));if(!n.length){e.setAttribute("data-armed","1");return}e.setAttribute("data-armed","measure");const o=new Set;n.forEach(((e,t)=>{e.style.height="";const r=e.getBoundingClientRect(),i=r.width,a=parseFloat(getComputedStyle(e).height)||r.height||0;let l=i,s=a;if(!s||s<4){const t=e.querySelector("img,video");if(t){const e=t.naturalWidth||t.videoWidth||t.clientWidth||0,r=t.naturalHeight||t.videoHeight||t.clientHeight||0;!l&&e&&(l=e),!s&&r&&(s=r)}}s||(s=240),l||(l=r.width||s*1.5),e.dataset.key=String(t),e.dataset.targetH=String(s),e.style.minWidth=l+"px",e.style.maxWidth=l+"px",e.style.height="0px",e.style.overflow="hidden",e.dataset.revealed="0"}));const a="right"===(e.dataset.direction||"left").toLowerCase(),l=parseFloat(e.dataset.speed)||.6,s=parseFloat(getComputedStyle(t).gap||"0")||0,d=e=>e.getBoundingClientRect().width+s;function c(){n.forEach((e=>{const r=e.cloneNode(!0),i=e.dataset.key||"",a=+e.dataset.targetH||0;r.setAttribute("data-clone","1"),r.dataset.key=i,r.style.minWidth=e.style.minWidth,r.style.maxWidth=e.style.maxWidth,r.style.height=o.has(i)?a+"px":"0px",r.style.overflow="hidden",t.appendChild(r)}))}function h(){let e=0;return t.childNodes.forEach((t=>{1===t.nodeType&&(e+=d(t))})),e}function u(){Array.from(t.querySelectorAll('.service-visual-wrapper[data-clone]')).forEach((e=>e.remove())),c(),c();let e=0;for(;h()<3*t.clientWidth&&e++<8;)c()}u(),e.setAttribute("data-armed","1");let f=0,p=!1,m=0;function v(n){if(!p)return void cancelAnimationFrame(f);if(n-m<80)return void(f=requestAnimationFrame(v));m=n||performance.now();const r=window.innerWidth,i=-.05*r,a=1.05*r,l=Array.from(t.querySelectorAll(".service-visual-wrapper")).filter((e=>{const t=e.getBoundingClientRect();return t.right>i&&t.left<a})).filter((e=>"1"!==e.dataset.revealed&&"1"!==e.dataset.revealing)).sort(((e,t)=>e.getBoundingClientRect().left-t.getBoundingClientRect().left));if(l.length){const e=gsap.timeline();l.forEach(((r,i)=>{const a=+r.dataset.targetH||0,l=r.dataset.key||"";if(!a)return;r.dataset.revealing="1",e.to(r,{height:a,duration:.9,ease:"power2.out",onComplete:()=>{r.style.height="",r.dataset.revealed="1",r.dataset.revealing="",o.add(l),t.querySelectorAll('.service-visual-wrapper[data-clone][data-key="'+l+'"]').forEach((e=>{e.style.height=a+"px"}))}},.12*i)}))}f=requestAnimationFrame(v)}const g=new IntersectionObserver((t=>{t.forEach((t=>{t.target===e&&(t.isIntersecting?p||(p=!0,cancelAnimationFrame(f),f=requestAnimationFrame(v)):(p=!1,cancelAnimationFrame(f)))}))}),{root:null,threshold:0,rootMargin:"0px 0px -5% 0px"});g.observe(e),r(g);let w=0,y=a?-1:1,x=60*l,b=(e,i)=>{const n=(i||16.6667)/1e3;let o=t.firstElementChild,a=0;w-=y*x*n;for(;o&&w<-d(o)&&a++<50;)w+=d(o),t.appendChild(o),o=t.firstElementChild;let r=t.lastElementChild;for(a=0;r&&w>0&&a++<50;)w-=d(r),t.insertBefore(r,t.firstElementChild),r=t.lastElementChild;gsap.set(t,{x:w});const l=window.innerWidth||1,s=l/2;t.querySelectorAll(".service-visual").forEach((e=>{const t=e.closest(".service-visual-wrapper");if(!t)return;const r=t.getBoundingClientRect(),i=(s-(r.left+r.right)/2)/l;e.style.setProperty("--drift",40*i+"px")}))};gsap.ticker.add(b),i(b);const k=new ResizeObserver((()=>{u()}));k.observe(t),r(k)})}})
			feature({id:"productGallery",stage:"main",namespaces:["capabilities"],selectors:[".infinite-gallery"],init:async r=>{if(!window.gsap||matchMedia("(prefers-reduced-motion: reduce)").matches)return;r=r||document;const g=[...r.querySelectorAll(".infinite-gallery")];if(!g.length)return;const a=o=>{try{window.CoreUtilities&&CoreUtilities.Observers&&CoreUtilities.Observers.addDom(o)}catch{}},l=o=>{try{window.CoreUtilities&&CoreUtilities.Observers&&CoreUtilities.Observers.addTicker(o)}catch{}},u=o=>{const t=parseFloat(o.dataset.ratio);if(t&&t>0)return t;const e=parseFloat(o.getAttribute("data-ratio"));if(e&&e>0)return e;const n=(o.className||"").match(/sv-ratio-(\d+)/);if(n){const o=n[1];if("169"===o)return 16/9;if("133"===o||"43"===o)return 4/3;if("11"===o)return 1}const i=o.querySelector("img,video");if(i){const o=parseInt(i.getAttribute("width"),10)||i.naturalWidth||i.videoWidth||0,t=parseInt(i.getAttribute("height"),10)||i.naturalHeight||i.videoHeight||0;if(o>0&&t>0)return o/t}return 1.5},c=async o=>{const t=[...o.querySelectorAll("img,video")];if(!t.length)return;const e=o=>o.naturalWidth>0&&o.naturalHeight>0||o.videoWidth>0&&o.videoHeight>0,n=[];const i=t.map(o=>{if(e(o))return Promise.resolve();const t="function"==typeof o.decode?o.decode().catch(()=>{}):Promise.resolve(),n=new Promise(t=>{const e=()=>{o.removeEventListener("load",e),t()};o.addEventListener("load",e,{once:!0})}),i=new Promise(t=>{let n=0;!function r(){if(e(o)||n++>80)return t();setTimeout(r,40)}()});return Promise.race([t,n,i])}),r=new Promise(o=>n.push(setTimeout(o,3500)));await Promise.race([Promise.all(i),r]),n.forEach(clearTimeout)},d=o=>parseFloat(getComputedStyle(o).gap||"0")||0,h=o=>{const t=d(o);let e=0;return o.childNodes.forEach(o=>{if(1===o.nodeType){const n=o.getBoundingClientRect().width||0;e+=n+t}}),e},f=(o,t)=>(o.getBoundingClientRect().width||0)+d(t);g.forEach(o=>{const r=o.querySelector(".infinite-gallery-wrapper");if(!r||r.__inited)return;r.__inited=!0,o.setAttribute("data-armed","0");const g=[...r.querySelectorAll(".service-visual-wrapper:not([data-clone])")];if(!g.length){o.setAttribute("data-armed","1");return}o.setAttribute("data-armed","measure");const p=new Set,m=async()=>{await c(r),v(),y(),o.setAttribute("data-armed","1")},v=()=>{g.forEach((o,t)=>{o.style.height="";const e=u(o);o.dataset.ratio=String(e);let n=o.getBoundingClientRect().height||parseFloat(getComputedStyle(o).height)||0;if(n<=0){const t=o.querySelector("img,video");t&&(n=t.getBoundingClientRect().height||parseFloat(getComputedStyle(t).height)||0)}const i=n>0?e*n:0;i>0&&(o.style.minWidth=i+"px",o.style.maxWidth=i+"px"),o.dataset.key=String(t),o.dataset.targetH=String(n),o.style.height="0px",o.style.overflow="hidden",o.style.flex="0 0 auto",o.style.willChange="transform",o.dataset.revealed="0"})},w=()=>{[...r.querySelectorAll('.service-visual-wrapper[data-clone="1"]')].forEach(o=>o.remove())},b=o=>{const t=o.cloneNode(!0);t.setAttribute("data-clone","1"),t.dataset.key=o.dataset.key||"";const e=parseFloat(o.style.minWidth)||o.getBoundingClientRect().width||0;e>0&&(t.style.minWidth=e+"px",t.style.maxWidth=e+"px");const n=t.dataset.key,i=parseFloat(o.dataset.targetH||"0")||0;i>0?(t.dataset.targetH=String(i),t.style.height=p.has(n)?i+"px":"0px"):t.style.height="0px",t.style.overflow="hidden",t.style.flex="0 0 auto",t.style.willChange="transform",r.appendChild(t)},y=()=>{w(),g.forEach(b),g.forEach(b);let t=0,e=3*r.clientWidth;for(;h(r)<e&&t++<8;)g.forEach(b)};m();let x=0,k=!1,S=0;const H=t=>{if(!k)return void cancelAnimationFrame(x);if(t-S<80)return void(x=requestAnimationFrame(H));S=t||performance.now();const e=window.innerWidth||1,n=-.05*e,i=1.05*e,s=[...r.querySelectorAll(".service-visual-wrapper")].filter(o=>{const t=o.getBoundingClientRect();return t.right>n&&t.left<i}).filter(o=>"1"!==o.dataset.revealed&&"1"!==o.dataset.revealing).sort((o,t)=>o.getBoundingClientRect().left-t.getBoundingClientRect().left);if(s.length){const t=gsap.timeline();s.forEach((n,i=>{let s=parseFloat(n.dataset.targetH||"0");if(!s||s<=0){const o=u(n),t=n.getBoundingClientRect().width||parseFloat(getComputedStyle(n).width)||0;s=o>0&&t>0?t/o:0,n.dataset.targetH=String(s)}const e=n.dataset.key||"";s&&(n.dataset.revealing="1",t.to(n,{height:s,duration:.9,ease:"power2.out",onComplete:()=>{n.style.height="",n.dataset.revealed="1",n.dataset.revealing="",p.add(e),r.querySelectorAll('.service-visual-wrapper[data-clone="1"][data-key="'+e+'"]').forEach(o=>{o.style.height=s+"px"})}},.12*i))}))}x=requestAnimationFrame(H)},T=new IntersectionObserver(t=>{t.forEach(t=>{t.target===o&&(t.isIntersecting?k||(k=!0,cancelAnimationFrame(x),x=requestAnimationFrame(H)):(k=!1,cancelAnimationFrame(x)))})},{root:null,threshold:0,rootMargin:"0px 0px -5% 0px"});T.observe(o),a(T);const E=o.getBoundingClientRect();E.top<(window.innerHeight||0)&&E.bottom>0&&(k=!0,cancelAnimationFrame(x),x=requestAnimationFrame(H));let W=0,$=("right"===(o.dataset.direction||"left").toLowerCase()?-1:1),D=parseFloat(o.dataset.speed)||.6,A=60*D,C=(o,t)=>{const e=(t||16.6667)/1e3;let n=r.firstElementChild,i=0;for(W-=$*A*e;n&&W<-f(n,r)&&i++<50;)W+=f(n,r),r.appendChild(n),n=r.firstElementChild;let s=r.lastElementChild;for(i=0;s&&W>0&&i++<50;)W-=f(s,r),r.insertBefore(s,r.firstElementChild),s=r.lastElementChild;gsap.set(r,{x:W});const l=window.innerWidth||1,u=l/2;r.querySelectorAll(".service-visual").forEach(o=>{const t=o.closest(".service-visual-wrapper");if(!t)return;const e=t.getBoundingClientRect(),n=(u-(e.left+e.right)/2)/l;o.style.setProperty("--drift",40*n+"px")})};gsap.ticker.add(C),l(C);const M=new ResizeObserver(()=>{v(),y()});M.observe(r),a(M)})}})
		);
