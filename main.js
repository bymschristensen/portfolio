...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		EntryAnimations.capabilities=function(e,i){e=e||document;var t=!!(i=i||{}).delayHero,a=gsap.timeline(),l=e.querySelector(".showreel-headline"),o=e.querySelector(".showreel-container");return l||o?(l&&gsap.set(l,{autoAlpha:0,visibility:"visible"}),o&&(gsap.set(o,{autoAlpha:1,visibility:"visible"}),gsap.set(o,{overflow:"hidden"}),gsap.set(o,{clipPath:"polygon(100% 100%,100% 100%,100% 100%,100% 100%)",willChange:"clip-path"})),a.addLabel("hero",t?.2:0),l&&a.set(l,{autoAlpha:1},"hero").call((function(){(CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready?CoreUtilities.Fonts.ready():Promise.resolve()).then((function(){try{if(window.SplitText&&window.splitAndMask&&window.animateLines&&window.safelyRevertSplit){var e=splitAndMask(l);animateLines(e.lines).eventCallback("onComplete",(function(){safelyRevertSplit(e,l)}))}else gsap.to(l,{autoAlpha:1,duration:.01})}catch(e){gsap.to(l,{autoAlpha:1,duration:.01})}}))}),null,"hero"),o&&a.to(o,{clipPath:"polygon(0% 0%,100% 0%,100% 100%,0% 100%)",duration:1.05,ease:"power3.inOut",clearProps:"willChange"},"hero+=0.45"),a):a};
