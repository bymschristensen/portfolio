	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				//init: async function(root){root=root||document;if(!window.matchMedia)return;var S=root.__archiveMinimalExperience||(root.__archiveMinimalExperience={});if(S._bound)return;S._bound=1;S.sel={section:".section-archive-minimal",list:".archive-minimal-list",item:".archive-minimal-item",hiddenImg:"img.archive-minimal-item-hidden-img",stickyImg:".archive-minimal-visual-img"};S.mqDesktop=matchMedia("(min-width: 1024px) and (pointer: fine) and (prefers-reduced-motion: no-preference)");function $(q,c){return(c||root).querySelector(q)}function $$(q,c){return[].slice.call((c||root).querySelectorAll(q))}function isVisible(el){if(!el)return!1;var cs=getComputedStyle(el);if(!cs||"none"===cs.display||"hidden"===cs.visibility)return!1;return null!==el.offsetParent}S.section=$(S.sel.section)||root;S.list=$(S.sel.list,S.section)||S.section;S.stickyImg=$(S.sel.stickyImg,root);if(!S.list||!S.stickyImg){S.destroy=function(){S._bound=0;try{delete root.__archiveMinimalExperience}catch(e){}};return}function initVisualBaseline(){var stickyImg=S.stickyImg,list=S.list;if(stickyImg.__ame_v1)return null;stickyImg.__ame_v1=1;var currentKey="",hoverActive=!1;function getVisibleItems(){return $$(S.sel.item,list).filter(isVisible)}function getHiddenImgFromItem(item){return item?$(S.sel.hiddenImg,item):null}function keyFromImg(img){return img&&(img.currentSrc||img.src)||""}function applyImg(img){if(!img)return!1;var src=img.currentSrc||img.src;if(!src)return!1;var key=keyFromImg(img);if(key&&key===currentKey)return!0;var srcset=img.getAttribute("srcset"),sizes=img.getAttribute("sizes");stickyImg.alt=img.alt||"";srcset?stickyImg.setAttribute("srcset",srcset):stickyImg.removeAttribute("srcset");sizes?stickyImg.setAttribute("sizes",sizes):stickyImg.removeAttribute("sizes");stickyImg.src=src;currentKey=key;return!0}function setToFirstVisible(){var first=getVisibleItems()[0];applyImg(getHiddenImgFromItem(first))}function onEnter(e){if(!S.mqDesktop.matches)return;var img=getHiddenImgFromItem(e.currentTarget);if(!img)return;hoverActive=!0;applyImg(img)}function onLeave(){if(!S.mqDesktop.matches)return;hoverActive=!1}function bindHover(){for(var items=$$(S.sel.item,list),i=0;i<items.length;i++){var it=items[i];if(it.__ame_v1h)continue;it.__ame_v1h=1;it.addEventListener("mouseenter",onEnter,{passive:!0});it.addEventListener("mouseleave",onLeave,{passive:!0})}}function refresh(){S.mqDesktop.matches&&hoverActive||setToFirstVisible();bindHover()}setToFirstVisible();bindHover();var mo=new MutationObserver(function(){refresh()});try{mo.observe(list,{subtree:!0,childList:!0,attributes:!0,attributeFilter:["style","class"]})}catch(e){}return{refresh:refresh,setToFirstVisible:setToFirstVisible,destroy:function(){try{mo.disconnect()}catch(e){}for(var items=$$(S.sel.item,list),i=0;i<items.length;i++){var it=items[i];if(!it.__ame_v1h)continue;it.removeEventListener("mouseenter",onEnter);it.removeEventListener("mouseleave",onLeave);it.__ame_v1h=0}stickyImg.__ame_v1=0;try{delete stickyImg.__ame_v1}catch(e){}}}}S.modules=S.modules||{};S.modules.visualBaseline=initVisualBaseline();S.destroy=function(){try{S.modules&&S.modules.visualBaseline&&S.modules.visualBaseline.destroy&&S.modules.visualBaseline.destroy()}catch(e){}S.modules=null;S.section=null;S.list=null;S.stickyImg=null;S._bound=0;try{delete root.__archiveMinimalExperience}catch(e){}};S.refresh=function(){try{S.modules&&S.modules.visualBaseline&&S.modules.visualBaseline.refresh&&S.modules.visualBaseline.refresh()}catch(e){}}}
				//init:async function(root){root=root||document;if(!window.matchMedia)return;var gs=window.gsap,rm=matchMedia("(prefers-reduced-motion: reduce)"),mq=matchMedia("(min-width: 1024px) and (pointer: fine)");var S=root.__archiveMinimalExperience||(root.__archiveMinimalExperience={});if(S._bound)return;S._bound=1;S.sel={section:".section-archive-minimal",list:".archive-minimal-list",item:".archive-minimal-item",hiddenImg:"img.archive-minimal-item-hidden-img",stickyImg:".archive-minimal-visual-img",viewport:".archive-minimal-visual-viewport",stack:".archive-minimal-visual-stack"};function $(q,c){return(c||root).querySelector(q)}function $$(q,c){return[].slice.call((c||root).querySelectorAll(q))}function isVisible(el){if(!el)return!1;var cs=getComputedStyle(el);if(!cs||cs.display==="none"||cs.visibility==="hidden")return!1;return el.offsetParent!==null}S.section=$(S.sel.section)||root;S.list=$(S.sel.list,S.section)||S.section;S.stickyImg=$(S.sel.stickyImg,root);S.viewport=$(S.sel.viewport,root);S.stack=$(S.sel.stack,root);if(!S.list||!S.stickyImg){S.destroy=function(){S._bound=0;try{delete root.__archiveMinimalExperience}catch(e){}};return}S.stack||(S.stack=S.stickyImg.parentElement||S.stickyImg);S.viewport||(S.viewport=S.stack.parentElement||S.stack);try{getComputedStyle(S.viewport).overflow!=="hidden"&&(S.viewport.style.overflow="hidden")}catch(e){}try{S.stack.style.position=S.stack.style.position||"relative"}catch(e){}try{S.stickyImg.style.position=S.stickyImg.style.position||"absolute",S.stickyImg.style.inset=S.stickyImg.style.inset||"0",S.stickyImg.style.width=S.stickyImg.style.width||"100%",S.stickyImg.style.height=S.stickyImg.style.height||"100%"}catch(e){}var curKey="",hoverActive=!1,animating=!1;function keyFromImg(img){return img&&(img.currentSrc||img.src)||""}function srcFromImg(img){return img&&(img.currentSrc||img.src)||""}function applyAttrs(dst,src){if(!dst||!src)return!1;var s=srcFromImg(src);if(!s)return!1;dst.alt=src.alt||"";var ss=src.getAttribute("srcset"),sz=src.getAttribute("sizes");ss?dst.setAttribute("srcset",ss):dst.removeAttribute("srcset");sz?dst.setAttribute("sizes",sz):dst.removeAttribute("sizes");dst.src=s;return!0}function hiddenFromItem(it){return it?$(S.sel.hiddenImg,it):null}function firstVisible(){return $$(S.sel.item,S.list).filter(isVisible)[0]||null}function killTemps(){try{var kids=[].slice.call(S.stack.children);for(var i=0;i<kids.length;i++){var n=kids[i];if(n&&n.__ameTemp){try{gs&&gs.killTweensOf&&gs.killTweensOf(n)}catch(e){}try{n.remove()}catch(e){}}}}catch(e){}animating=!1}function instantTo(img){if(!img)return;var k=keyFromImg(img);if(k&&k===curKey)return;killTemps();applyAttrs(S.stickyImg,img);curKey=k;try{gs&&gs.set&&gs.set(S.stickyImg,{clearProps:"transform,filter,opacity,visibility"})}catch(e){}}function animateTo(img){if(!img)return;var k=keyFromImg(img);if(k&&k===curKey)return;var srcOk=srcFromImg(img);if(!srcOk)return;curKey=k;if(!gs||rm.matches){instantTo(img);return}killTemps();animating=!0;var cur=S.stickyImg,incoming=cur.cloneNode(!1);incoming.__ameTemp=1;try{incoming.removeAttribute("id")}catch(e){}try{incoming.setAttribute("aria-hidden","true")}catch(e){}applyAttrs(incoming,img);try{incoming.style.position="absolute",incoming.style.inset="0",incoming.style.width="100%",incoming.style.height="100%",incoming.style.zIndex="2";cur.style.zIndex=cur.style.zIndex||"1"}catch(e){}try{S.stack.appendChild(incoming)}catch(e){}try{gs.set(incoming,{yPercent:-100,scale:1.15,transformOrigin:"50% 0%",willChange:"transform"})}catch(e){}var d=.65;try{gs.to(incoming,{yPercent:0,scale:1,duration:d,ease:"power3.out",overwrite:!0,onComplete:function(){try{applyAttrs(cur,img)}catch(e){}try{gs.set(cur,{clearProps:"transform,filter,opacity,visibility"})}catch(e){}try{incoming.remove()}catch(e){}animating=!1}})}catch(e){instantTo(img)}}function bindHover(){var items=$$(S.sel.item,S.list);for(var i=0;i<items.length;i++){var it=items[i];if(it.__ameH)continue;it.__ameH=1;it.addEventListener("mouseenter",function(ev){if(!mq.matches)return;var im=hiddenFromItem(ev.currentTarget);if(!im)return;hoverActive=!0;animateTo(im)},{passive:!0});it.addEventListener("mouseleave",function(){if(!mq.matches)return;hoverActive=!1},{passive:!0})}}function refresh(){if(!(mq.matches&&hoverActive)&&!animating){var it=firstVisible();instantTo(hiddenFromItem(it))}bindHover()}bindHover();instantTo(hiddenFromItem(firstVisible()));var mo=new MutationObserver(function(){refresh()});try{mo.observe(S.list,{subtree:!0,childList:!0,attributes:!0,attributeFilter:["style","class"]})}catch(e){}S.refresh=function(){try{refresh()}catch(e){}};S.destroy=function(){try{mo.disconnect()}catch(e){}killTemps();var items=$$(S.sel.item,S.list);for(var i=0;i<items.length;i++){var it=items[i];if(!it.__ameH)continue;it.__ameH=0}S._bound=0;try{delete root.__archiveMinimalExperience}catch(e){}};}
				init:async function(root){root=root||document;if(!window.matchMedia)return;var gs=window.gsap,rm=matchMedia("(prefers-reduced-motion: reduce)"),mq=matchMedia("(min-width: 1024px) and (pointer: fine)"),S=root.__archiveMinimalExperience||(root.__archiveMinimalExperience={});if(S._bound)return;S._bound=1;S.sel={section:".section-archive-minimal",list:".archive-minimal-list",item:".archive-minimal-item",hiddenImg:"img.archive-minimal-item-hidden-img",stickyImg:".archive-minimal-visual-img",viewport:".archive-minimal-visual-viewport",stack:".archive-minimal-visual-stack"};function $(q,c){return(c||root).querySelector(q)}function $$(q,c){return[].slice.call((c||root).querySelectorAll(q))}function isVisible(el){if(!el)return!1;var cs=getComputedStyle(el);return!!(cs&&cs.display!=="none"&&cs.visibility!=="hidden"&&el.offsetParent!==null)}S.section=$(S.sel.section)||root;S.list=$(S.sel.list,S.section)||S.section;S.stickyImg=$(S.sel.stickyImg,root);S.viewport=$(S.sel.viewport,root);S.stack=$(S.sel.stack,root);if(!S.list||!S.stickyImg){S.destroy=function(){S._bound=0;try{delete root.__archiveMinimalExperience}catch(e){}};return}S.stack||(S.stack=S.stickyImg.parentElement||S.stickyImg);S.viewport||(S.viewport=S.stack.parentElement||S.stack);try{getComputedStyle(S.viewport).overflow!=="hidden"&&(S.viewport.style.overflow="hidden")}catch(e){}try{S.stack.style.position=S.stack.style.position||"relative"}catch(e){}try{S.stickyImg.style.position=S.stickyImg.style.position||"absolute",S.stickyImg.style.inset=S.stickyImg.style.inset||"0",S.stickyImg.style.width=S.stickyImg.style.width||"100%",S.stickyImg.style.height=S.stickyImg.style.height||"100%"}catch(e){}var curKey="",hoverActive=!1,animating=!1;function keyFromImg(img){return img&&(img.currentSrc||img.src)||""}function srcFromImg(img){return img&&(img.currentSrc||img.src)||""}function applyAttrs(dst,src){if(!dst||!src)return!1;var s=srcFromImg(src);if(!s)return!1;dst.alt=src.alt||"";var ss=src.getAttribute("srcset"),sz=src.getAttribute("sizes");ss?dst.setAttribute("srcset",ss):dst.removeAttribute("srcset");sz?dst.setAttribute("sizes",sz):dst.removeAttribute("sizes");dst.src=s;return!0}function hiddenFromItem(it){return it?$(S.sel.hiddenImg,it):null}function firstVisible(){return $$(S.sel.item,S.list).filter(isVisible)[0]||null}function killTemps(){try{for(var kids=[].slice.call(S.stack.children),i=0;i<kids.length;i++){var n=kids[i];if(n&&n.__ameTemp){try{gs&&gs.killTweensOf&&gs.killTweensOf(n)}catch(e){}try{n.remove()}catch(e){}}}}catch(e){}animating=!1}function instantTo(img){if(!img)return;var k=keyFromImg(img);if(k&&k===curKey)return;killTemps();applyAttrs(S.stickyImg,img);curKey=k;try{gs&&gs.set&&gs.set(S.stickyImg,{clearProps:"transform,filter,opacity,visibility"})}catch(e){}}function animateTo(img){if(!img)return;var k=keyFromImg(img);if(k&&k===curKey)return;var ok=srcFromImg(img);if(!ok)return;curKey=k;if(!gs||rm.matches){instantTo(img);return}killTemps();animating=!0;var cur=S.stickyImg,incoming=cur.cloneNode(!1);incoming.__ameTemp=1;try{incoming.removeAttribute("id")}catch(e){}try{incoming.setAttribute("aria-hidden","true")}catch(e){}applyAttrs(incoming,img);try{incoming.style.position="absolute",incoming.style.inset="0",incoming.style.width="100%",incoming.style.height="100%",incoming.style.zIndex="2";cur.style.zIndex=cur.style.zIndex||"1"}catch(e){}try{S.stack.appendChild(incoming)}catch(e){}try{gs.set(incoming,{yPercent:-100,scale:1.15,transformOrigin:"50% 0%",willChange:"transform"})}catch(e){}try{gs.to(incoming,{yPercent:0,scale:1,duration:.9,ease:"power3.out",overwrite:!0,onComplete:function(){try{applyAttrs(cur,img)}catch(e){}try{gs.set(cur,{clearProps:"transform,filter,opacity,visibility"})}catch(e){}try{incoming.remove()}catch(e){}animating=!1}})}catch(e){instantTo(img)}}function bindHover(){for(var items=$$(S.sel.item,S.list),i=0;i<items.length;i++){var it=items[i];if(it.__ameH)continue;it.__ameH=1;it.__ameEnter=function(ev){if(!mq.matches)return;var im=hiddenFromItem(ev.currentTarget);if(!im)return;hoverActive=!0;animateTo(im)};it.__ameLeave=function(){if(!mq.matches)return;hoverActive=!1};it.addEventListener("mouseenter",it.__ameEnter,{passive:!0});it.addEventListener("mouseleave",it.__ameLeave,{passive:!0})}}function refresh(){if(!(mq.matches&&hoverActive)&&!animating){var it=firstVisible();instantTo(hiddenFromItem(it))}bindHover()}bindHover();instantTo(hiddenFromItem(firstVisible()));var mo=new MutationObserver(function(){refresh()});try{mo.observe(S.list,{subtree:!0,childList:!0,attributes:!0,attributeFilter:["style","class"]})}catch(e){}S.refresh=function(){try{refresh()}catch(e){}};S.destroy=function(){try{mo.disconnect()}catch(e){}killTemps();for(var items=$$(S.sel.item,S.list),i=0;i<items.length;i++){var it=items[i];if(!it.__ameH)continue;it.__ameH=0;try{it.__ameEnter&&it.removeEventListener("mouseenter",it.__ameEnter)}catch(e){}try{it.__ameLeave&&it.removeEventListener("mouseleave",it.__ameLeave)}catch(e){}try{delete it.__ameEnter;delete it.__ameLeave}catch(e){}}S._bound=0;try{delete root.__archiveMinimalExperience}catch(e){}};}
