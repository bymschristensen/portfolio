...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var r=e.querySelector(".hero-section-showreel");if(!r||r.__hsBound)return;var t=r.querySelector(".showreel-track"),n=r.querySelector(".showreel-container");if(!t||!n)return;r.__hsBound=1,n.style.transformOrigin="50% 50%",n.style.willChange="transform",n.style.transform="translate3d(0,0,0)";var o=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9");o&&(n.style.aspectRatio="16 / 9");var s={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1},a=gsap.quickSetter(n,"x","px");function c(){var e=n.getBoundingClientRect(),r=t.getBoundingClientRect();s.w=e.width||n.offsetWidth||0,s.tw=r.width||t.offsetWidth||0,s.left=r.left,s.right=r.right,s.baseC=e.left+e.width/2-s.x,!o&&s.w&&(n.style.height=s.w*9/16+"px")}function l(e,r,t){return e<r?r:e>t?t:e}function i(e){var r=l(e,s.left,s.right),o=r+s.w/2,c=s.left+s.w/2,i=s.right-s.w/2;if(c>i){var d=(s.left+s.right)/2;c=i=d}var u=l(o,c,i);return u-s.baseC}function d(e){s.hasMove=!0,s.px=e.clientX}function u(e){s.last||(s.last=e);var r=Math.min(.05,(e-s.last)/1e3);s.last=e,c();var t=s.left+s.w/2,n=s.hasMove&&null!=s.px?i(s.px):i(t),o=1-Math.exp(-10*r);s.x+=o*(n-s.x),a(s.x),s.raf=requestAnimationFrame(u)}c(),addEventListener("pointermove",d,{passive:!0}),addEventListener("resize",c,{passive:!0}),s.raf=requestAnimationFrame(u),r.__hsDestroy=function(){try{removeEventListener("pointermove",d)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{s.raf&&cancelAnimationFrame(s.raf)}catch(e){}}},destroy:async function(e){e=e||document;var r=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{r&&r.__hsDestroy&&r.__hsDestroy()}catch(e){}}}),
			feature({
