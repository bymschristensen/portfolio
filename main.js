...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({id:"archiveListMotion",stage:"main",namespaces:["archive"],selectors:[".archive-playful-list",".archive-minimal-list"],init:function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveListMotionBound)return;e.__archiveListMotionBound=1;var t=null,getActiveList=function(){var r=e.querySelector(".section-archive-playful")||null,t=e.querySelector(".section-archive-minimal")||null,n=(r&&r.querySelector(".list-archive"))||e.querySelector(".list-archive.is-playful")||e.querySelector('[data-archive-list="playful"]')||e.querySelector(".archive-playful-list")||null,a=(t&&t.querySelector(".list-archive"))||e.querySelector(".list-archive.is-minimal")||e.querySelector('[data-archive-list="minimal"]')||e.querySelector(".archive-minimal-list")||null;return r&&"none"!==r.style.display&&!r.classList.contains("is-hidden")?n:t&&"none"!==t.style.display&&!t.classList.contains("is-hidden")?a:n||a};function n(r){if(!r)return!1;var e=window.getComputedStyle(r);return"none"!==e.display&&"hidden"!==e.visibility&&r.getClientRects&&r.getClientRects().length>0}function a(r){if(!r)return[];for(var e=[].slice.call(r.querySelectorAll(".list-item-archive-project")),t=[],a=0;a<e.length;a++)n(e[a])&&"none"!==e[a].style.display&&t.push(e[a]);return t}function i(){var r=getActiveList();if(!r)return;var e=a(r);t&&t.kill&&t.kill(),gsap.killTweensOf([r].concat(e)),t=gsap.timeline({defaults:{overwrite:!0}});var n=Math.min(.22,.1+.02*e.length);t.to(r,{autoAlpha:0,duration:n,ease:"power2.out"},0).set(r,{autoAlpha:1},n+.01).set(e,{autoAlpha:0,y:90,filter:"blur(10px)"},n+.01).to(e,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.55,ease:"power3.out",stagger:{each:.06,from:"start"}},n+.02)}try{i()}catch(r){}window.addEventListener("archive:filterChanged",i)}})
		);
