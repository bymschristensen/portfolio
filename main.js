...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1;n.style.transformOrigin="50% 50%";n.style.willChange="transform";n.style.transform="translate3d(0,0,0)";var o=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9");o&&(n.style.aspectRatio="16/9");var a={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1},s=gsap.quickSetter(n,"x","px"),L=3;function c(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();a.w=e.width||n.offsetWidth||0,a.tw=t.width||r.offsetWidth||0,a.left=t.left,a.right=t.right,a.baseC=e.left+e.width/2-a.x,!o&&a.w&&(n.style.height=a.w*9/16+"px")}function i(e,t,r){return e<t?t:e>r?r:e}function l(e){var t=i(e,a.left,a.right),o=t+a.w/2,s=a.left+a.w/2,l=a.right-a.w/2;s>l&&(s=l=(a.left+a.right)/2);var u=i(o,s,l);return u-a.baseC}function d(e){a.hasMove=!0,a.px=e.clientX}function u(e){a.last||(a.last=e);var t=Math.min(.05,(e-a.last)/1e3);a.last=e,c();if(!a.hasMove||null==a.px){a.raf=requestAnimationFrame(u);return}var r=l(a.px),o=1-Math.exp(-L*t);a.x+=o*(r-a.x),s(a.x),a.raf=requestAnimationFrame(u)}c(),addEventListener("pointermove",d,{passive:!0}),addEventListener("resize",c,{passive:!0}),a.raf=requestAnimationFrame(u),t.__hsDestroy=function(){try{removeEventListener("pointermove",d)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{a.raf&&cancelAnimationFrame(a.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
