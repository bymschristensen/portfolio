	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(e){if(!window.gsap)return;e=e||document;var t=e.querySelector('[data-barba="container"]')||e;if(t.__almCleanup)try{t.__almCleanup()}catch(v){}var i=[].slice.call(t.querySelectorAll(".archive-playful-item,.archive-minimal-item"));if(!i.length)return;var a=t.querySelector(".archive-minimal-item-visual");a&&(a.__almVisDone=0,gsap.set(a,{autoAlpha:0,filter:"blur(10px)",willChange:"opacity,filter"}));var o=0,r=2,n=!1;function l(){if(n||!a||a.__almVisDone)return;n=!0,a.__almVisDone=1,gsap.to(a,{autoAlpha:1,filter:"blur(0px)",duration:1,ease:"sine.out",overwrite:!0,clearProps:"filter,willChange"})}var s=new IntersectionObserver(function(e){e.forEach(function(e){var t=e.target;if(!e.isIntersecting||"none"===t.style.display||t.__almDone)return;t.__almDone=1,o++;gsap.fromTo(t,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.55,ease:"power3.out",overwrite:!0,clearProps:"y,filter,willChange"}),a&&!n&&o>=r&&l()})},{root:null,threshold:.15});i.forEach(function(e){s.observe(e)}),t.__almCleanup=function(){try{s.disconnect()}catch(e){}t.__almCleanup=null}
			}),
			feature({
