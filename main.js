	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				stage: "main",
				namespaces: ["archive"],
				selectors: [".section-archive-playful",".section-archive-minimal",".archive-playful-list",".archive-minimal-list",".archive-playful-item",".archive-minimal-item"],
				init: async function(r){if(!window.gsap||!window.ScrollTrigger)return;var t=window.gsap,e=window.ScrollTrigger;if(window.matchMedia&&matchMedia("(prefers-reduced-motion: reduce)").matches)return;var n={tr:[],tw:[],root:null,run:0},i=function(){n.tw.forEach(function(r){try{r.kill&&r.kill()}catch(r){}}),n.tr.forEach(function(r){try{r.kill&&r.kill()}catch(r){}}),n.tw.length=0,n.tr.length=0,n.root=null},o=function(r){if(!r)return;var i=r.querySelectorAll(".archive-playful-item,.archive-minimal-item");if(!i||!i.length)return;var o=++n.run;i.forEach(function(r){r.__almDone=0,r.__almRun=o,t.set(r,{autoAlpha:0,y:24})});var a=t.utils.toArray(i);a.forEach(function(r){var i=e.create({trigger:r,start:"top 85%",once:!0,onEnter:function(){if(r.__almRun!==o||r.__almDone)return;r.__almDone=1;var e=t.to(r,{autoAlpha:1,y:0,duration:.55,ease:"power2.out",overwrite:!0});n.tw.push(e)}});n.tr.push(i)});try{e.refresh()}catch(r){}},a=function(r){i(),n.root=r,o(r)};window.__archiveListMotion=window.__archiveListMotion||{},window.__archiveListMotion.resetAndRun=a,window.__archiveListMotion.destroy=i}
			}),
			feature({
