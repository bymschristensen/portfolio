	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(e){if(!window.gsap)return;e=e||document;var t=e.querySelector('[data-barba="container"]')||e;if(t.__almCleanup)try{t.__almCleanup()}catch(_){}var i=[].slice.call(t.querySelectorAll(".archive-playful-item,.archive-minimal-item"));if(!i.length)return;i.forEach(function(e){var t=e.classList.contains("archive-minimal-item")?e.querySelector(".archive-minimal-item-visual"):null;t&&!t.__almVisDone&&gsap.set(t,{autoAlpha:0,filter:"blur(10px)",willChange:"opacity,filter"})});var r=new IntersectionObserver(function(e){e.forEach(function(e){var t=e.target;if(!e.isIntersecting||"none"===t.style.display)return;var i=t.classList.contains("archive-minimal-item")?t.querySelector(".archive-minimal-item-visual"):null;i&&!i.__almVisDone&&(i.__almVisDone=1,gsap.fromTo(i,{autoAlpha:0,filter:"blur(10px)"},{autoAlpha:1,filter:"blur(0px)",delay:.35,duration:1,ease:"sine.out",overwrite:!0,clearProps:"filter,willChange"}));if(t.__almDone)return;t.__almDone=1,gsap.fromTo(t,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.55,ease:"power3.out",overwrite:!0,clearProps:"y,filter,willChange"})})},{root:null,threshold:.15});i.forEach(function(e){r.observe(e)}),t.__almCleanup=function(){try{r.disconnect()}catch(_){}t.__almCleanup=null}}
			}),
			feature({
