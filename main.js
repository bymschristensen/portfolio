	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init:async function(root){root=root||document;if(!window.matchMedia)return;var gs=window.gsap,rm=matchMedia("(prefers-reduced-motion: reduce)"),mq=matchMedia("(min-width: 1024px) and (pointer: fine)"),S=root.__archiveMinimalExperience||(root.__archiveMinimalExperience={});if(S._bound)return;S._bound=1;S.sel={section:".section-archive-minimal",list:".archive-minimal-list",item:".archive-minimal-item",hiddenImg:"img.archive-minimal-item-hidden-img",stickyImg:".archive-minimal-visual-img",viewport:".archive-minimal-visual-viewport",stack:".archive-minimal-visual-stack"};function $(q,c){return(c||root).querySelector(q)}function $$(q,c){return[].slice.call((c||root).querySelectorAll(q))}function isVisible(el){if(!el)return!1;var cs=getComputedStyle(el);return!!(cs&&cs.display!=="none"&&cs.visibility!=="hidden"&&el.offsetParent!==null)}S.section=$(S.sel.section)||root;S.list=$(S.sel.list,S.section)||S.section;S.stickyImg=$(S.sel.stickyImg,root);S.viewport=$(S.sel.viewport,root);S.stack=$(S.sel.stack,root);if(!S.list||!S.stickyImg){S.destroy=function(){S._bound=0;try{delete root.__archiveMinimalExperience}catch(e){}};return}S.stack||(S.stack=S.stickyImg.parentElement||S.stickyImg);S.viewport||(S.viewport=S.stack.parentElement||S.stack);try{getComputedStyle(S.viewport).overflow!=="hidden"&&(S.viewport.style.overflow="hidden")}catch(e){}try{S.stack.style.position=S.stack.style.position||"relative"}catch(e){}try{S.stickyImg.style.position=S.stickyImg.style.position||"absolute",S.stickyImg.style.inset=S.stickyImg.style.inset||"0",S.stickyImg.style.width=S.stickyImg.style.width||"100%",S.stickyImg.style.height=S.stickyImg.style.height||"100%"}catch(e){}var curKey="",hoverActive=!1,animating=!1,seq=0,MAX=20,HOLD=.24;function keyFromImg(img){return img&&(img.currentSrc||img.src)||""}function srcFromImg(img){return img&&(img.currentSrc||img.src)||""}function applyAttrs(dst,src){if(!dst||!src)return!1;var s=srcFromImg(src);if(!s)return!1;dst.alt=src.alt||"";var ss=src.getAttribute("srcset"),sz=src.getAttribute("sizes");ss?dst.setAttribute("srcset",ss):dst.removeAttribute("srcset");sz?dst.setAttribute("sizes",sz):dst.removeAttribute("sizes");dst.src=s;return!0}function hiddenFromItem(it){return it?$(S.sel.hiddenImg,it):null}function firstVisible(){return $$(S.sel.item,S.list).filter(isVisible)[0]||null}function trimStack(){try{for(var kids=[].slice.call(S.stack.children).filter(function(n){return n&&n.__ameTemp}),extra=kids.length-MAX,i=0;i<extra;i++)try{kids[i].remove()}catch(e){}}catch(e){}}function killAllTemps(){try{for(var kids=[].slice.call(S.stack.children),i=0;i<kids.length;i++){var n=kids[i];if(n&&n.__ameTemp){try{gs&&gs.killTweensOf&&gs.killTweensOf(n)}catch(e){}try{n.remove()}catch(e){}}}}catch(e){}animating=!1}function instantTo(img){if(!img)return;var k=keyFromImg(img);if(k&&k===curKey)return;killAllTemps();applyAttrs(S.stickyImg,img);curKey=k;try{gs&&gs.set&&gs.set(S.stickyImg,{clearProps:"transform,filter,opacity,visibility,willChange"})}catch(e){}}function animateTo(img){if(!img)return;var k=keyFromImg(img),s=srcFromImg(img);if(!s)return;if(!gs||rm.matches){instantTo(img);return}seq++;animating=!0;var cur=S.stickyImg,incoming=cur.cloneNode(!1);incoming.__ameTemp=1;incoming.__ameSeq=seq;try{incoming.removeAttribute("id")}catch(e){}try{incoming.setAttribute("aria-hidden","true")}catch(e){}applyAttrs(incoming,img);try{incoming.style.position="absolute",incoming.style.inset="0",incoming.style.width="100%",incoming.style.height="100%",incoming.style.zIndex=String(10+seq);cur.style.zIndex=cur.style.zIndex||"1"}catch(e){}try{S.stack.appendChild(incoming)}catch(e){}trimStack();try{gs.set(incoming,{yPercent:-120,scale:1.3,transformOrigin:"50% 0%",willChange:"transform",force3D:!0})}catch(e){}try{gs.to(incoming,{yPercent:0,scale:1,duration:1,ease:"power3.out",overwrite:!1,force3D:!0,onComplete:function(){try{applyAttrs(cur,img);curKey=k}catch(e){}try{gs.set(cur,{clearProps:"transform,filter,opacity,visibility,willChange"})}catch(e){}try{gs.delayedCall(HOLD,function(){try{incoming.remove()}catch(e){}try{animating=[].slice.call(S.stack.children).some(function(n){return n&&n.__ameTemp})}catch(e){animating=!1}})}catch(e){try{incoming.remove()}catch(e2){}try{animating=[].slice.call(S.stack.children).some(function(n){return n&&n.__ameTemp})}catch(e3){animating=!1}}}})}catch(e){instantTo(img)}}function bindHover(){for(var items=$$(S.sel.item,S.list),i=0;i<items.length;i++){var it=items[i];if(it.__ameH)continue;it.__ameH=1;it.__ameEnter=function(ev){if(!mq.matches)return;var im=hiddenFromItem(ev.currentTarget);if(!im)return;hoverActive=!0;animateTo(im)};it.__ameLeave=function(){if(!mq.matches)return;hoverActive=!1};it.addEventListener("mouseenter",it.__ameEnter,{passive:!0});it.addEventListener("mouseleave",it.__ameLeave,{passive:!0})}}function refresh(){if(!(mq.matches&&hoverActive)&&!animating){var it=firstVisible();instantTo(hiddenFromItem(it))}bindHover()}bindHover();instantTo(hiddenFromItem(firstVisible()));var mo=new MutationObserver(function(){refresh()});try{mo.observe(S.list,{subtree:!0,childList:!0,attributes:!0,attributeFilter:["style","class"]})}catch(e){}function onView(){try{refresh()}catch(e){}}function onFilter(){try{refresh()}catch(e){}}document.addEventListener("archive:view",onView,{passive:!0});document.addEventListener("archive:filter:applied",onFilter,{passive:!0});S.refresh=function(){try{refresh()}catch(e){}};S.destroy=function(){try{mo.disconnect()}catch(e){}try{document.removeEventListener("archive:view",onView)}catch(e){}try{document.removeEventListener("archive:filter:applied",onFilter)}catch(e){}killAllTemps();for(var items=$$(S.sel.item,S.list),i=0;i<items.length;i++){var it=items[i];if(!it.__ameH)continue;it.__ameH=0;try{it.__ameEnter&&it.removeEventListener("mouseenter",it.__ameEnter)}catch(e){}try{it.__ameLeave&&it.removeEventListener("mouseleave",it.__ameLeave)}catch(e){}try{delete it.__ameEnter;delete it.__ameLeave}catch(e){}}S._bound=0;try{delete root.__archiveMinimalExperience}catch(e){}};}
