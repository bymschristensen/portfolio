...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({id:"archiveController",stage:"main",namespaces:["archive"],selectors:[".section-archive-playful",".section-archive-minimal",".archive-playful-list",".archive-minimal-list",".archive-playful-item",".archive-minimal-item",".archive-categories .cms-categories",".archive-switch-block",".archive-switch",".archive-switch-dot","#archive-filter-all","#archive-filter-appswebapps","#archive-filter-websites","#archive-filter-ecommerce","#archive-filter-platforms-systems","#archive-filter-other","#nav-archive-filter-all","#nav-archive-filter-appswebapps","#nav-archive-filter-websites","#nav-archive-filter-ecommerce","#nav-archive-filter-platforms-systems","#nav-archive-filter-other"],init:function(e){if(!window.gsap)return;e=e||document;var t=e.querySelector('[data-barba="container"]')||e;if(t.__archiveControllerBound)return;t.__archiveControllerBound=1;var a=t.querySelector(".section-archive-playful"),r=t.querySelector(".section-archive-minimal"),n=t.querySelector(".archive-playful-list"),o=t.querySelector(".archive-minimal-list"),i=[].slice.call(t.querySelectorAll(".archive-playful-item")),c=[].slice.call(t.querySelectorAll(".archive-minimal-item")),s=t.querySelector(".archive-switch-block"),l=t.querySelector(".archive-switch"),u=t.querySelector(".archive-switch-dot");if(!a||!r||!n||!o)return;function d(e){return(e||"").toLowerCase().replace(/\s+/g," ").trim()}function f(e){try{return[].slice.call(e.querySelectorAll(".archive-categories .cms-categories")).map(e=>d(e.textContent)).filter(Boolean)}catch(e){return[]}}var p=new WeakMap;i.forEach(e=>p.set(e,f(e))),c.forEach(e=>p.set(e,f(e)));var m=["#archive-filter-all","#archive-filter-appswebapps","#archive-filter-websites","#archive-filter-ecommerce","#archive-filter-platforms-systems","#archive-filter-other"].map(e=>t.querySelector(e)).filter(Boolean),v=["#nav-archive-filter-all","#nav-archive-filter-appswebapps","#nav-archive-filter-websites","#nav-archive-filter-ecommerce","#nav-archive-filter-platforms-systems","#nav-archive-filter-other"].map(e=>t.querySelector(e)).filter(Boolean);function g(e){var t=(e||"").replace(/^#?/,"");return t.indexOf("appswebapps")>-1?"apps webapps":t.indexOf("platforms-systems")>-1?"platforms systems":t.indexOf("ecommerce")>-1?"ecommerce":t.indexOf("websites")>-1?"websites":t.indexOf("other")>-1?"other":"all"}function h(e){m.concat(v).forEach(t=>{t.classList.toggle("is-active",t===e)})}function y(e){var t=e==="all";function a(e){var a=p.get(e)||[],r=t||a.some(t=>t.indexOf(e)>-1||e.indexOf(t)>-1);e.style.display=r?"":"none"}i.forEach(a),c.forEach(a)}function b(e){a.style.display=e==="playful"?"":"none",r.style.display=e==="minimal"?"":"none"}function w(){return a.style.display==="none"?"minimal":"playful"}function k(e,t){if(!u)return;var a=e==="minimal"?100:0;t?gsap.set(u,{xPercent:a}):gsap.to(u,{xPercent:a,duration:.35,ease:"power3.out",overwrite:!0})}function x(e){try{localStorage.setItem("archive:view",e)}catch(e){}}function q(){try{return localStorage.getItem("archive:view")}catch(e){return null}}function E(e){var t="all";for(var a=0;a<m.length;a++)if(m[a].classList.contains("is-active")){t=g(m[a].id);break}y(t),k(e,!1)}function C(e){e.preventDefault();var t=w(),a=t==="playful"?"minimal":"playful";x(a),b(a),k(a,!1),E(a)}var A=q()||"playful";b(A),k(A,!0),y("all");m.concat(v).forEach(e=>{if(!e||e.__archiveFilterBound)return;e.__archiveFilterBound=1;e.addEventListener("click",function(t){t.preventDefault();var a=g(e.id);h(e),y(a)},!1)});[s,l].filter(Boolean).forEach(e=>{if(e.__archiveSwitchBound)return;e.__archiveSwitchBound=1;e.addEventListener("click",C,{passive:!1})})}}),
			feature({id:"archiveListMotion",stage:"main",namespaces:["archive"],selectors:[".archive-playful-item",".archive-minimal-item"],init:function(e){if(!window.gsap)return;e=e||document;var t=e.querySelector('[data-barba="container"]')||e;if(t.__almCleanup)try{t.__almCleanup()}catch(e){}var r=[].slice.call(t.querySelectorAll(".archive-playful-item,.archive-minimal-item"));if(!r.length)return;r.forEach(e=>{e.__almDone=0,gsap.set(e,{autoAlpha:1})});var a=new IntersectionObserver(e=>{e.forEach(e=>{var t=e.target;if(!e.isIntersecting||t.__almDone||t.style.display==="none")return;t.__almDone=1;gsap.fromTo(t,{y:18,autoAlpha:0},{y:0,autoAlpha:1,duration:.6,ease:"power3.out",overwrite:!0})})},{root:null,threshold:.15});r.forEach(e=>a.observe(e));t.__almCleanup=function(){try{a.disconnect()}catch(e){}t.__almCleanup=null}}})
		);
