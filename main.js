...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1;n.style.transformOrigin="center center";n.style.willChange="transform";try{gsap.set(n,{force3D:!0})}catch{}var o={x:0,sc:1,tsc:1,px:0,hasMove:!1,raf:0,last:0,w:0,tw:0,lock:!1},i=20,a=.96,c=1.1,l=1.1,s=60,u=10,d=6,f=gsap.quickSetter(n,"x","px"),h=gsap.quickSetter(n,"scale");function p(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0,o.tw=t.width||r.offsetWidth||0}function m(){return Math.max(0,(o.tw-o.w*o.sc)/2)}function g(e){var t=r.getBoundingClientRect(),s=(e-t.left)+i+o.w*o.sc/2-(o.tw/2),u=m(),d=Math.max(-u,Math.min(u,s)),f=u?d/u:0,h=Math.tanh(f*l)/Math.tanh(l);return h*u}function y(e){o.hasMove=!0,o.px=e.clientX}function v(){var e=r.getBoundingClientRect(),t=(innerHeight||document.documentElement.clientHeight||0)/2,n=e.top+e.height/2,s=Math.abs(n-t),l=1-Math.min(1,s/((innerHeight||document.documentElement.clientHeight||0)*.75));o.tsc=a+l*(c-a),o.lock=o.w*o.sc>=o.tw-1}function w(){p()}function S(e){o.last||(o.last=e);var t=Math.min(.05,(e-o.last)/1e3);o.last=e;var i=innerWidth||document.documentElement.clientWidth||1,l=.5*i,s=((l-(o.px||l))/i)*s,u=m(),d=o.lock?0:o.hasMove?g(o.px)+s:0,p=1-Math.exp(-u=t?u:0),y=1-Math.exp(-(d=t?d:0);p=1-Math.exp(-u=t?u:0));var pX=1-Math.exp(-(u=u?u:10)*t),pS=1-Math.exp(-(d=d?d:6)*t);o.sc+=pS*(o.tsc-o.sc),o.x+=pX*(d-o.x),f(o.x),h(o.sc),o.raf=requestAnimationFrame(S)}p(),v(),addEventListener("pointermove",y,{passive:!0}),addEventListener("scroll",v,{passive:!0}),addEventListener("resize",w,{passive:!0}),o.raf=requestAnimationFrame(S),t.__hsDestroy=function(){try{removeEventListener("pointermove",y)}catch(e){}try{removeEventListener("scroll",v)}catch(e){}try{removeEventListener("resize",w)}catch(e){}try{cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
