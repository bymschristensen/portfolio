...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		EntryAnimations.capabilities=function(e,t){e=e||document;var a=!!(t=t||{}).delayHero,o=gsap.timeline(),r=e.querySelector(".section-table-of-contents");r&&gsap.set(r,{autoAlpha:0});var l=e.querySelector(".approach-mask");l&&(gsap.set(l,{scale:0,transformOrigin:"0% 100%",willChange:"transform"}),o.to(l,{scale:1,duration:1.2,ease:"power2.out"},0));var i=e.querySelector(".section-hero .headline-lg");if(i){gsap.set(i,{autoAlpha:0});var n=a?.2:0;o.addLabel("heroStart",n).set(i,{autoAlpha:1},"heroStart").call((function(){(CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready?CoreUtilities.Fonts.ready():Promise.resolve()).then((function(){if(window.SplitText){var e=splitAndMask(i);animateLines(e.lines).eventCallback("onComplete",(function(){safelyRevertSplit(e,i)}))}else gsap.to(i,{y:0,opacity:1,duration:.6,ease:"power2.out"})}))}),null,"heroStart")}var s=e.querySelector(".section-hero .button-primary");s&&(gsap.set(s,{autoAlpha:0,y:20,filter:"blur(10px)"}),o.fromTo(s,{autoAlpha:0,y:20,filter:"blur(10px)"},{autoAlpha:1,y:0,filter:"blur(0px)",duration:.6,ease:"power2.out"},"heroStart+=0.4"));var p=[].slice.call(e.querySelectorAll(".table-of-contents-item"));return p.length&&o.from(p,{autoAlpha:0,paddingTop:"6rem",paddingBottom:"6rem",duration:1,ease:"power2.out",stagger:.15},0),r&&o.to(r,{autoAlpha:1,duration:.6,ease:"power2.out"},0),o};
