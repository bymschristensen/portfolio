...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1;var i=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9"),o={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0,wbA:0,wbP:0,wasMin:!1,wasMax:!1},L=2.2,M=.3,V=1300,S=.16,H={base:.88,min:.8,max:1},D=6,F=18;function c(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0,o.tw=t.width||r.offsetWidth||0,o.left=t.left,o.right=t.right,o.baseC=e.left+e.width/2-o.x,!i&&o.w&&(n.style.height=o.w*9/16+"px")}function l(e,t,r){return e<t?t:e>r?r:e}function a(e){var t=l(e,o.left,o.right),i=t+o.w/2,c=o.left+o.w/2,a=o.right-o.w/2;c>a&&(c=a=(o.left+o.right)/2);var s=l(i,c,a);return s-o.baseC}function s(e){var t=e.clientX;o.hasMove&&(o.vx+=t-(null==o.px?t:o.px)),o.hasMove=!0,o.px=t}function u(e){o.last||(o.last=e);if(!o.hasMove||null==o.px)return o.last=e,void(o.raf=requestAnimationFrame(u));var t=Math.min(.05,(e-o.last)/1e3);o.last=e,c();var i=a(o.px),r=1-Math.exp(-L*t);o.x+=r*(i-o.x),o.vx*=.94,Math.abs(o.vx)<.02&&(o.vx=0);var s=0;o.vx&&(s=-o.vx/V,s>M?s=M:s<-M&&(s=-M)),o.sq+=S*(s-o.sq);var f=H.base+o.sq,d=f<=H.min,v=f>=H.max;d&&!o.wasMin?(o.wbA=.02,o.wbP=0):v&&!o.wasMax&&(o.wbA=.02,o.wbP=0),o.wasMin=d,o.wasMax=v,o.wbA&&(o.wbA*=Math.exp(-D*t),o.wbP+=F*t);var p=o.wbA?o.wbA*Math.sin(o.wbP):0,h=f+p;h<H.min&&(h=H.min),h>H.max&&(h=H.max),n.style.transform="translate3d("+o.x+"px,0,0) scale("+h+")",o.raf=requestAnimationFrame(u)}c(),addEventListener("pointermove",s,{passive:!0}),addEventListener("resize",c,{passive:!0}),o.raf=requestAnimationFrame(u),t.__hsDestroy=function(){try{removeEventListener("pointermove",s)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
