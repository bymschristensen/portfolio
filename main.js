...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1;var i=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9"),o={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0,wA:0,wP:0,hitMin:!1,hitMax:!1},L=2.2,M=.3,V=1300,S=.16,H={base:.88,min:.8,max:1},WAMP=.055,WF=18,WD=2.4,TH=.01,PAD=.03;function c(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0,o.tw=t.width||r.offsetWidth||0,o.left=t.left,o.right=t.right,o.baseC=e.left+e.width/2-o.x,i||(n.style.height=o.w*9/16+"px")}function d(e,t,r){return e<t?t:e>r?r:e}function u(e){var t=d(e,o.left,o.right),i=t+o.w/2,c=o.left+o.w/2,l=o.right-o.w/2;c>l&&(c=l=(o.left+o.right)/2);var f=d(i,c,l);return f-o.baseC}function a(e){var t=e.clientX;o.hasMove&&(o.vx+=t-(null==o.px?t:o.px)),o.hasMove=!0,o.px=t}function s(e){o.last||(o.last=e);var t=(e-o.last)/1e3;t<0&&(t=0),t>0.05&&(t=.05),o.last=e;if(!o.hasMove||null==o.px)return o.raf=requestAnimationFrame(s);c();var r=u(o.px),i=1-Math.exp(-L*t);o.x+=i*(r-o.x),o.vx*=.94,Math.abs(o.vx)<.02&&(o.vx=0);var d=o.vx?Math.max(-M,Math.min(M,-o.vx/V)):0;o.sq+=S*(d-o.sq);var l=H.base+o.sq;l<H.min?l=H.min:l>H.max&&(l=H.max);var f=l<=H.min+TH,h=l>=H.max-TH;if(f&&!o.hitMin&&o.sq<0)o.wA=WAMP,o.wP=0,o.hitMin=!0,o.hitMax=!1;else if(!f&&o.hitMin&&o.sq>- .002)o.hitMin=!1;if(h&&!o.hitMax&&o.sq>0)o.wA=-WAMP,o.wP=0,o.hitMax=!0,o.hitMin=!1;else if(!h&&o.hitMax&&o.sq<.002)o.hitMax=!1;Math.abs(o.wA)>1e-4?(o.wP+=WF*t,o.wA*=Math.exp(-WD*t)):o.wA=0;var p=o.wA?1+o.wA*Math.sin(o.wP):1,m=l*p;m<H.min-PAD?m=H.min-PAD:m>H.max+PAD&&(m=H.max+PAD),n.style.transform="translate3d("+o.x+"px,0,0) scale("+m+")",o.raf=requestAnimationFrame(s)}c(),addEventListener("pointermove",a,{passive:!0}),addEventListener("resize",c,{passive:!0}),o.raf=requestAnimationFrame(s),t.__hsDestroy=function(){try{removeEventListener("pointermove",a)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
