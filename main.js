...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		EntryAnimations.caseStudy=function(e){e=e||document;var t=gsap.timeline(),i=e.querySelector(".cs-hero-image"),n=e.querySelector(".cs-headline"),a=n&&(n.querySelector("h1, .headline-xl, .headline-lg, .headline, [data-split], [role='heading'][aria-level='1']")||n),o=e.querySelector(".cs-titles-inner .headline-m");i&&(gsap.set(i,{autoAlpha:0,y:100,filter:"blur(10px)"}),t.to(i,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.7,ease:"power2.out"},0));if(a){gsap.set(a,{autoAlpha:0});o&&gsap.set(o,{autoAlpha:0,y:20,filter:"blur(10px)"});t.addLabel("h",.15).set(a,{autoAlpha:1},"h").call(function(){(CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready?CoreUtilities.Fonts.ready():Promise.resolve()).then(function(){if(window.SplitText&&window.splitAndMask&&window.animateLines&&window.safelyRevertSplit){var e=splitAndMask(a);animateLines(e.lines).eventCallback("onComplete",function(){safelyRevertSplit(e,a)})}else gsap.to(a,{y:0,opacity:1,duration:.6,ease:"power2.out"})})},null,"h");o&&t.to(o,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.5,ease:"power2.out"},"h+=0.6")}return t};
