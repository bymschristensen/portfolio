...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(r){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;r=r||document;var s=r.querySelector(".hero-section-showreel");if(!s||s.__hsBound)return;var t=s.querySelector(".showreel-track"),n=s.querySelector(".showreel-container");if(!t||!n)return;s.__hsBound=1;n.style.transformOrigin="center center";n.style.willChange="transform";try{gsap.set(n,{x:0,scale:1,force3D:!0})}catch(e){}var o={x:0,sc:1,tsc:1,px:0,hasMove:!1,raf:0,last:0,w:0,tw:0,lock:!1},O=20,S0=.96,S1=1.1,EDGE=1.1,NUD=60,FREQX=10,FREQS=6,setX=gsap.quickSetter(n,"x","px"),setS=gsap.quickSetter(n,"scale");function a(){var e=n.getBoundingClientRect(),i=t.getBoundingClientRect();o.w=e.width||n.offsetWidth||0,o.tw=i.width||t.offsetWidth||0}function c(){return Math.max(0,(o.tw-o.w*o.sc)/2)}function l(e){var i=t.getBoundingClientRect(),d=(e-i.left)+O+o.w*o.sc/2-(o.tw/2),u=c(),f=Math.max(-u,Math.min(u,d)),h=u?f/u:0,p=Math.tanh(h*EDGE)/Math.tanh(EDGE);return p*u}function i(e){o.hasMove=!0,o.px=e.clientX}function d(){var e=t.getBoundingClientRect(),i=(innerHeight||document.documentElement.clientHeight||0),d=e.top+e.height/2,u=Math.abs(d-i/2),f=1-Math.min(1,u/(i*.75));o.tsc=S0+f*(S1-S0),o.lock=o.w*o.sc>=o.tw-1}function u(){a()}function f(e){o.last||(o.last=e);var i=Math.min(.05,(e-o.last)/1e3);o.last=e;c();var d=(innerWidth||document.documentElement.clientWidth||1),u=.5*d,f=o.px||u,h=((u-f)/d)*NUD,p=o.lock?0:o.hasMove?l(f)+h:0,m=1-Math.exp(-FREQX*i),g=1-Math.exp(-FREQS*i);o.sc+=g*(o.tsc-o.sc),o.x+=m*(p-o.x),setX(o.x),setS(o.sc),o.raf=requestAnimationFrame(f)}a(),d(),addEventListener("pointermove",i,{passive:!0}),addEventListener("scroll",d,{passive:!0}),addEventListener("resize",u,{passive:!0}),o.raf=requestAnimationFrame(f),s.__hsDestroy=function(){try{removeEventListener("pointermove",i)}catch(e){}try{removeEventListener("scroll",d)}catch(e){}try{removeEventListener("resize",u)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(r){r=r||document;var s=r.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{s&&s.__hsDestroy&&s.__hsDestroy()}catch(e){}}}),
			feature({
