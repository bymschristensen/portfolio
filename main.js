	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(e){e=e||document;var t="archiveView",i=matchMedia("(min-width: 1024px)"),a=e.querySelector(".section-archive-playful"),l=e.querySelector(".section-archive-minimal"),r=e.querySelector(".archive-switch-block"),s=e.querySelector(".archive-switch"),n=e.querySelector(".archive-switch-dot");if(!a||!l||e.__archiveViewBound)return;e.__archiveViewBound=1;var c=[r,s].filter(Boolean),o=null,busy=0;function u(){try{window.gsap&&gsap.set&&gsap.set([a,l],{display:"none"})}catch(_){}a.style.display="none",l.style.display="none"}function m(){try{var e=localStorage.getItem(t);return"playful"===e||"minimal"===e?e:null}catch(_){return null}}function f(){return i.matches?m()||"playful":"minimal"}function p(e){var t2="playful"===e;r&&(r.dataset.view=e,r.setAttribute("aria-pressed",String(t2)),r.classList.toggle("is-playful",t2),r.classList.toggle("is-minimal",!t2)),s&&(s.dataset.view=e,s.classList.toggle("is-playful",t2),s.classList.toggle("is-minimal",!t2)),n&&(n.dataset.view=e,n.classList.toggle("is-playful",t2),n.classList.toggle("is-minimal",!t2))}function g(e){try{document.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:e}}))}catch(_){}}function h(e){u();var t2="playful"===e?a:l;t2.style.display="block";try{window.gsap&&gsap.set&&gsap.set(t2,{autoAlpha:1,filter:"none",clearProps:"opacity,visibility"})}catch(_){}p(e),g(e);try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}}function v(e){if(!window.gsap)return[];var t2="playful"===e?a:l,i2="playful"===e?".archive-playful-item":".archive-minimal-item",r2=[].slice.call(t2.querySelectorAll(i2)||[]);return r2.forEach(function(e2){e2.__almDone=0,gsap.killTweensOf(e2),gsap.set(e2,{y:18,autoAlpha:0,filter:"blur(10px)",willChange:"transform,opacity,filter"})}),r2}function y(e){if(!window.gsap)return;var t2=v(e);t2.length&&gsap.timeline({defaults:{ease:"power3.out"}}).to(t2,{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"y,filter,willChange"},0).add(function(){try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}g(e)})}function B(e){if(!window.gsap)return h(e),void function(e2){try{localStorage.setItem(t,e2)}catch(_){}}(e);if(busy)return;busy=1;var n2=(r&&r.dataset.view)||(s&&s.dataset.view)||("none"!==a.style.display?"playful":"minimal");if(n2===e)return busy=0,void 0;var c2="playful"===n2?a:l,o2="playful"===e?a:l;p(e);try{localStorage.setItem(t,e)}catch(_){}gsap.killTweensOf([c2,o2]),u(),c2.style.display="block",o2.style.display="none";var d2=v(e);gsap.timeline({defaults:{ease:"power2.out"},onComplete:function(){busy=0}}).set(c2,{display:"block",autoAlpha:1,filter:"none"},0).to(c2,{autoAlpha:0,filter:"blur(10px)",duration:.22,overwrite:!0},0).add(function(){c2.style.display="none",o2.style.display="block",gsap.set(o2,{autoAlpha:1,filter:"none"})}).to(d2,{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"y,filter,willChange"},"-=0.02").add(function(){try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}g(e)})}function w(e){e&&e.preventDefault&&e.preventDefault();if(i.matches){var t2=("playful"===(r&&r.dataset.view||s&&s.dataset.view||("none"!==a.style.display?"playful":"minimal"))?"minimal":"playful");B(t2)}else h("minimal")}function k(){h(f()),window.gsap?y(f()):S()}function S(){if(o)return;var e2=0;o=setInterval(function(){if(window.gsap){clearInterval(o),o=null,y(f())}else e2+=50,e2>=2000&&(clearInterval(o),o=null)},50)}u(),h(f()),window.gsap?y(f()):S(),c.forEach(function(e2){e2&&e2.addEventListener("click",w,{passive:!1})}),i.addEventListener?i.addEventListener("change",k):i.addListener(k),e.__archiveViewDestroy=function(){try{o&&(clearInterval(o),o=null)}catch(_){}try{i.removeEventListener?i.removeEventListener("change",k):i.removeListener(k)}catch(_){}c.forEach(function(e2){try{e2&&e2.removeEventListener("click",w)}catch(_){}}),e.__archiveViewBound=0,e.__archiveViewDestroy=null}}
			}),
			feature({
