...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		EntryAnimations.info=function(e){e=e||document;var t=gsap.timeline(),n=e.querySelector(".hero-section-text h1"),i=e.querySelector(".hero-subtext"),o=[...e.querySelectorAll('.bio-photo-wrapper[data-photo]')].sort((e,t)=>(+e.getAttribute("data-photo")||0)-(+t.getAttribute("data-photo")||0));if(o.length){gsap.set(o,{autoAlpha:0,y:120,filter:"blur(10px)",visibility:"visible",willChange:"transform,opacity,filter"});var r=.9,a=.16;t.addLabel("p",0).to(o,{autoAlpha:1,y:0,filter:"blur(0px)",duration:r,ease:"power2.out",stagger:a,clearProps:"y,filter,willChange"},"p").addLabel("h","p="+(r+.15))}else t.addLabel("h",0);n&&(gsap.set(n,{autoAlpha:0,visibility:"visible"}),t.set(n,{autoAlpha:1},"h").call((function(){(CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready?CoreUtilities.Fonts.ready():Promise.resolve()).then((function(){if(window.splitAndMask&&window.animateLines&&window.safelyRevertSplit){var e=splitAndMask(n);animateLines(e.lines).eventCallback("onComplete",(function(){safelyRevertSplit(e,n)}))}else gsap.to(n,{y:0,opacity:1,duration:.6,ease:"power2.out"})}))}),null,"h"));i&&(gsap.set(i,{autoAlpha:0,y:20,filter:"blur(10px)",visibility:"visible"}),t.to(i,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.6,ease:"power2.out"},"h+=0.48"));return t};
