	...
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({
				...
				init: async e=>{if(matchMedia("(prefers-reduced-motion: reduce)").matches)return;const t=[...e.querySelectorAll(".infinite-gallery")];if(!t.length)return;const r=!!(window.CSS&&CSS.supports&&CSS.supports("aspect-ratio: 1/1")),a=e=>{let t=0;const r=parseFloat(getComputedStyle(e).gap||"0")||0;return e.childNodes.forEach(e=>{1===e.nodeType&&(t+=(e.getBoundingClientRect().width||0)+r)}),t},i=e=>{const t=parseFloat(e.getAttribute("data-ratio"));if(t&&t>0)return t;const r=(e.className||"").match(/sv-ratio-(\d+)/);if(r){const e=r[1];if("169"===e)return 16/9;if("133"===e||"43"===e)return 4/3;if("11"===e)return 1}const a=e.querySelector("img,video");if(a){const e=parseInt(a.getAttribute("width"),10)||a.naturalWidth||a.videoWidth||0,t=parseInt(a.getAttribute("height"),10)||a.naturalHeight||a.videoHeight||0;if(e>0&&t>0)return e/t}return 1.5};t.forEach(async e=>{const t=e.querySelector(".infinite-gallery-wrapper");if(!t||t.__inited)return;t.__inited=!0,e.setAttribute("data-armed","measure");const s=[...t.querySelectorAll(".service-visual-wrapper:not([data-clone])")];if(!s.length)return void e.setAttribute("data-armed","1");await(e=>{const t=[...e.querySelectorAll("img,video")];if(!t.length)return Promise.resolve();const r=e=>e.naturalWidth>0&&e.naturalHeight>0||e.videoWidth>0&&e.videoHeight>0,a=[];return Promise.race([Promise.all(t.map(e=>{if(r(e))return Promise.resolve();const t="function"==typeof e.decode?e.decode().catch(()=>{}):Promise.resolve(),a=new Promise(t=>{const r=()=>{e.removeEventListener("load",r),t()};e.addEventListener("load",r,{once:!0})}),i=new Promise(t=>{let a=0;!function i(){if(r(e)||a++>80)return t();setTimeout(i,40)}()});return Promise.race([t,a,i])})),new Promise(e=>a.push(setTimeout(e,3500)))]).finally(()=>a.forEach(clearTimeout))})(t);const o=new Set,l="right"===(e.dataset.direction||"left").toLowerCase()?-1:1,n=parseFloat(e.dataset.speed)||.6;s.forEach((e,a)=>{const s=i(e),o=((e,t)=>{const r=parseFloat(e.getAttribute("data-size")),a=(e.className||"").match(/sv-size-(\d+)/),i=r||(a?parseFloat(a[1]):0),s=t.clientHeight||0;if(i>0&&s>0)return Math.max(1,Math.round(s*i/100));const o=e.style.height;e.style.height="";const l=parseFloat(getComputedStyle(e).height)||e.getBoundingClientRect().height||0;return e.style.height=o,l>8?Math.round(l):s>0?Math.round(.6*s):360})(e,t),l=Math.max(1,Math.round(o*s));e.dataset.key=String(a),e.dataset.ratio=String(s),e.dataset.targetH=String(o),e.dataset.revealed="0",e.style.overflow="hidden",e.style.flex="0 0 auto",e.style.willChange="height,transform",e.style.minWidth=l+"px",e.style.maxWidth=l+"px",r&&(e.style.aspectRatio=s+" / 1"),e.style.height="0px"});const d=()=>{[...t.querySelectorAll('.service-visual-wrapper[data-clone="1"]')].forEach(e=>e.remove())},c=e=>{const a=e.cloneNode(!0),s=e.dataset.key||"",o=parseFloat(e.dataset.ratio)||i(e),l=+e.dataset.targetH||0,n=Math.max(1,Math.round(l*o));return a.setAttribute("data-clone","1"),a.dataset.key=s,a.style.overflow="hidden",a.style.flex="0 0 auto",a.style.willChange="height,transform",a.style.minWidth=n+"px",a.style.maxWidth=n+"px",r&&(a.style.aspectRatio=o+" / 1"),a.style.height="0px",t.appendChild(a),a},h=()=>{s.forEach(c)},u=()=>{d(),h(),h();let e=0;const r=3*Math.max(document.documentElement.clientWidth,window.innerWidth||0);for(;a(t)<r&&e++<8;)h()};u(),e.setAttribute("data-armed","1");let p=0;const m=(e,r)=>{p-=l*((r||16.6667)/1e3)*(60*n);const a=parseFloat(getComputedStyle(t).gap||"0")||0,i=e=>(e.getBoundingClientRect().width||0)+a;let s=t.firstElementChild,o=0;for(;s&&p<-i(s)&&o++<50;)p+=i(s),t.appendChild(s),s=t.firstElementChild;let d=t.lastElementChild,c=0;for(;d&&p>0&&c++<50;)p-=i(d),t.insertBefore(d,t.firstElementChild),d=t.lastElementChild;gsap.set(t,{x:p});const h=(innerWidth||0)/2;t.querySelectorAll(".service-visual").forEach(e=>{const t=e.closest(".service-visual-wrapper");if(!t)return;const r=t.getBoundingClientRect(),a=(h-(r.left+r.width/2))/(innerWidth||1);e.style.setProperty("--drift",40*a+"px")})};gsap.ticker.add(m),CoreUtilities.Observers.addTicker(m);let g=!1;const f=()=>{if(g)return;g=!0;(e=>{const r=gsap.timeline();e.forEach((e,a)=>{const i=+e.dataset.targetH||0,s=e.dataset.key||"";r.fromTo(e,{height:0},{height:i,duration:.9,ease:"power2.out",onComplete:()=>{e.style.height="",e.dataset.revealed="1",o.add(s),t.querySelectorAll(`.service-visual-wrapper[data-clone="1"][data-key="${s}"]`).forEach(e=>e.style.height=i+"px")}},.12*a)}),s.forEach(r=>{if(e.includes(r))return;const a=+r.dataset.targetH||0,i=r.dataset.key||"";"1"!==r.dataset.revealed&&(r.style.height="",r.dataset.revealed="1",o.add(i),t.querySelectorAll(`.service-visual-wrapper[data-clone="1"][data-key="${i}"]`).forEach(e=>e.style.height=a+"px"))})})(((t=7)=>{const r=e.getBoundingClientRect(),a=r.left,i=r.right,o=r.top,l=r.bottom,n=(a+i)/2,d=s.map(e=>{const t=e.getBoundingClientRect(),r=Math.max(0,Math.min(t.right,i)-Math.max(t.left,a))*Math.max(0,Math.min(t.bottom,l)-Math.max(t.top,o)),s=(t.left+t.right)/2;return{el:e,rect:t,area:r,dist:Math.abs(s-n)}}),c=d.filter(e=>e.area>1).sort((e,t)=>e.rect.left-t.rect.left);if(c.length){const e=c.slice().sort((e,t)=>e.dist-t.dist).slice(0,t),r=new Set(e.map(e=>e.el));return d.filter(e=>r.has(e.el)).sort((e,t)=>e.rect.left-t.rect.left).map(e=>e.el)}return d.sort((e,t)=>e.dist-t.dist).slice(0,t).sort((e,t)=>e.rect.left-t.rect.left).map(e=>e.el)})(7))},y=new IntersectionObserver(t=>{t.forEach(t=>{t.target===e&&t.isIntersecting&&(f(),y.unobserve(e))})},{root:null,threshold:.05,rootMargin:"0px 0px -5% 0px"});y.observe(e),CoreUtilities.Observers.addDom(y);const v=new ResizeObserver(()=>{d(),u(),s.forEach(e=>{const a=e.dataset.key||"",s=parseFloat(e.dataset.ratio)||i(e),o=+e.dataset.targetH||0,l=Math.max(1,Math.round(o*s));e.style.minWidth=l+"px",e.style.maxWidth=l+"px",r&&(e.style.aspectRatio=s+" / 1"),t.querySelectorAll(`.service-visual-wrapper[data-clone="1"][data-key="${a}"]`).forEach(e=>{e.style.minWidth=l+"px",e.style.maxWidth=l+"px",r&&(e.style.aspectRatio=s+" / 1")})})});v.observe(t),CoreUtilities.Observers.addDom(v)})}
			})
		);
