...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1;n.style.transformOrigin="50% 50%";n.style.willChange="transform";n.style.transform="translate3d(0,0,0)";var a=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9");a&&(n.style.aspectRatio="16/9");var o={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0,sc:1,tsc:1,lock:!1},m=gsap.quickSetter(n,"x","px"),g=gsap.quickSetter(n,"scale"),L=3,F=6,M=.06;function c(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0,o.tw=t.width||r.offsetWidth||0,o.left=t.left,o.right=t.right,o.baseC=e.left+e.width/2-o.x,a||(n.style.height=o.w*9/16+"px"),o.lock=o.w>=o.tw-1}function u(e,t,r){return e<t?t:e>r?r:e}function l(e){var t=u(e,o.left,o.right),a=t+o.w/2,m=o.left+o.w/2,g=o.right-o.w/2;m>g&&(m=g=(o.left+o.right)/2);var L=u(a,m,g);return L-o.baseC}function f(e){var t=e.clientX;o.hasMove&&(o.vx+=t-(null==o.px?t:o.px)),o.hasMove=!0,o.px=t}function d(e){if(o.last||(o.last=e),!o.hasMove||null==o.px)return o.last=e,void(o.raf=requestAnimationFrame(d));var t=Math.min(.05,(e-o.last)/1e3);o.last=e,c();var a=(innerWidth||document.documentElement.clientWidth||1)/2,s=o.px||a,p=l(s),f=1-Math.exp(-L*t);o.x+=f*(p-o.x);var h=1-Math.exp(-F*t);o.sc+=h*(o.tsc-o.sc);o.vx*=.82,Math.abs(o.vx)<.1&&(o.vx=0);var v=0;if(o.vx){v=-o.vx/2000,v>M&&(v=M),v<-M&&(v=-M)}o.sq+=.18*(v-o.sq);var S=o.sc*(1+o.sq);m(o.x),g(S),o.raf=requestAnimationFrame(d)}c(),addEventListener("pointermove",f,{passive:!0}),addEventListener("resize",c,{passive:!0}),o.raf=requestAnimationFrame(d),t.__hsDestroy=function(){try{removeEventListener("pointermove",f)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
