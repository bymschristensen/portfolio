...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({id:"productGallery",stage:"main",namespaces:["capabilities"],selectors:[".infinite-gallery"],init:async e=>{if(matchMedia("(prefers-reduced-motion: reduce)").matches)return;const t=[...e.querySelectorAll(".infinite-gallery")];if(!t.length)return;const a=!!(window.CSS&&CSS.supports&&CSS.supports("aspect-ratio: 1/1")),r=e=>{let t=0;const a=parseFloat(getComputedStyle(e).gap||"0")||0;return e.childNodes.forEach(e=>{1===e.nodeType&&(t+=(e.getBoundingClientRect().width||0)+a)}),t},i=e=>{const t=parseFloat(e.getAttribute("data-ratio"));if(t&&t>0)return t;const a=(e.className||"").match(/sv-ratio-(\d+)/);if(a){const e=a[1];if("169"===e)return 16/9;if("133"===e||"43"===e)return 4/3;if("11"===e)return 1}const r=e.querySelector("img,video");if(r){const e=parseInt(r.getAttribute("width"),10)||r.naturalWidth||r.videoWidth||0,t=parseInt(r.getAttribute("height"),10)||r.naturalHeight||r.videoHeight||0;if(e>0&&t>0)return e/t}return 1.5};t.forEach(async e=>{const t=e.querySelector(".infinite-gallery-wrapper");if(!t||t.__inited)return;t.__inited=!0,e.setAttribute("data-armed","measure");const s=[...t.querySelectorAll(".service-visual-wrapper:not([data-clone])")];if(!s.length)return void e.setAttribute("data-armed","1");await(e=>{const t=[...e.querySelectorAll("img,video")];if(!t.length)return Promise.resolve();const a=e=>e.naturalWidth>0&&e.naturalHeight>0||e.videoWidth>0&&e.videoHeight>0,r=[];return Promise.race([Promise.all(t.map(e=>{if(a(e))return Promise.resolve();const t="function"==typeof e.decode?e.decode().catch(()=>{}):Promise.resolve(),r=new Promise(t=>{const a=()=>{e.removeEventListener("load",a),t()};e.addEventListener("load",a,{once:!0})}),i=new Promise(t=>{let r=0;!function i(){if(a(e)||r++>80)return t();setTimeout(i,40)}()});return Promise.race([t,r,i])})),new Promise(e=>r.push(setTimeout(e,3500)))]).finally(()=>r.forEach(clearTimeout))})(t);const o=new Set,l="right"===(e.dataset.direction||"left").toLowerCase()?-1:1,n=parseFloat(e.dataset.speed)||.6;s.forEach((e,r)=>{const s=i(e),o=((e,t)=>{const a=parseFloat(e.getAttribute("data-size")),r=(e.className||"").match(/sv-size-(\d+)/),i=a||(r?parseFloat(r[1]):0),s=t.clientHeight||0;if(i>0&&s>0)return Math.max(1,Math.round(s*i/100));const o=e.style.height;e.style.height="";const l=parseFloat(getComputedStyle(e).height)||e.getBoundingClientRect().height||0;return e.style.height=o,l>8?Math.round(l):s>0?Math.round(.6*s):360})(e,t),l=Math.max(1,Math.round(o*s));e.dataset.key=String(r),e.dataset.ratio=String(s),e.dataset.targetH=String(o),e.dataset.revealed="0",e.style.overflow="hidden",e.style.flex="0 0 auto",e.style.willChange="max-height,transform",e.style.minWidth=l+"px",e.style.maxWidth=l+"px",a&&(e.style.aspectRatio=s+" / 1"),e.style.maxHeight="0px";const n=e.querySelector(".service-visual");n&&gsap.set(n,{scaleY:0,transformOrigin:"bottom center",opacity:.001,willChange:"transform,opacity"})});const c=()=>{[...t.querySelectorAll('.service-visual-wrapper[data-clone="1"]')].forEach(e=>e.remove())},d=e=>{const r=e.cloneNode(!0),s=e.dataset.key||"",o=parseFloat(e.dataset.ratio)||i(e),l=+e.dataset.targetH||0,n=Math.max(1,Math.round(l*o));return r.setAttribute("data-clone","1"),r.dataset.key=s,r.style.overflow="hidden",r.style.flex="0 0 auto",r.style.willChange="max-height,transform",r.style.minWidth=n+"px",r.style.maxWidth=n+"px",a&&(r.style.aspectRatio=o+" / 1"),r.style.maxHeight="0px",t.appendChild(r),r},h=()=>{s.forEach(d)},u=()=>{c(),h(),h();let e=0;const a=3*Math.max(document.documentElement.clientWidth,window.innerWidth||0);for(;r(t)<a&&e++<8;)h()};u(),e.setAttribute("data-armed","1");let p=0;const m=(e,a)=>{p-=l*((a||16.6667)/1e3)*(60*n);const r=parseFloat(getComputedStyle(t).gap||"0")||0,i=e=>(e.getBoundingClientRect().width||0)+r;let s=t.firstElementChild,o=0;for(;s&&p<-i(s)&&o++<50;)p+=i(s),t.appendChild(s),s=t.firstElementChild;let c=t.lastElementChild,d=0;for(;c&&p>0&&d++<50;)p-=i(c),t.insertBefore(c,t.firstElementChild),c=t.lastElementChild;gsap.set(t,{x:p});const h=(innerWidth||0)/2;t.querySelectorAll(".service-visual").forEach(e=>{const t=e.closest(".service-visual-wrapper");if(!t)return;const a=t.getBoundingClientRect(),r=(h-(a.left+a.width/2))/(innerWidth||1);e.style.setProperty("--drift",40*r+"px")})};gsap.ticker.add(m),CoreUtilities.Observers.addTicker(m);let g=!1;const f=()=>{if(g)return;g=!0;(e=>{const a=gsap.timeline({defaults:{ease:"power2.out"}});e.forEach((e,r)=>{const i=+e.dataset.targetH||0,s=e.dataset.key||"",l=e.querySelector(".service-visual");a.to(e,{maxHeight:i,duration:.9},.12*r),l&&a.to(l,{scaleY:1,opacity:1,duration:.9,transformOrigin:"bottom center"},.12*r+0),a.add(()=>{e.style.maxHeight="",e.dataset.revealed="1",o.add(s),t.querySelectorAll(`.service-visual-wrapper[data-clone="1"][data-key="${s}"]`).forEach(e=>e.style.maxHeight=i+"px")},.12*r+.9)}),s.forEach(a=>{if(e.includes(a))return;const r=+a.dataset.targetH||0,i=a.dataset.key||"";if("1"===a.dataset.revealed)return;a.style.maxHeight="",a.dataset.revealed="1";const s=a.querySelector(".service-visual");s&&gsap.set(s,{scaleY:1,opacity:1,clearProps:"transform,opacity,willChange"}),o.add(i),t.querySelectorAll(`.service-visual-wrapper[data-clone="1"][data-key="${i}"]`).forEach(e=>e.style.maxHeight=r+"px")})})(((t=7)=>{const a=e.getBoundingClientRect(),r=a.left,i=a.right,o=a.top,l=a.bottom,n=(r+i)/2,c=s.map(e=>{const t=e.getBoundingClientRect(),a=Math.max(0,Math.min(t.right,i)-Math.max(t.left,r))*Math.max(0,Math.min(t.bottom,l)-Math.max(t.top,o)),s=(t.left+t.right)/2;return{el:e,rect:t,area:a,dist:Math.abs(s-n)}}),d=c.filter(e=>e.area>1).sort((e,t)=>e.rect.left-t.rect.left);if(d.length){const e=d.slice().sort((e,t)=>e.dist-t.dist).slice(0,t),a=new Set(e.map(e=>e.el));return c.filter(e=>a.has(e.el)).sort((e,t)=>e.rect.left-t.rect.left).map(e=>e.el)}return c.sort((e,t)=>e.dist-t.dist).slice(0,t).sort((e,t)=>e.rect.left-t.rect.left).map(e=>e.el)})(7))},y=new IntersectionObserver(t=>{t.forEach(t=>{t.target===e&&t.isIntersecting&&(f(),y.unobserve(e))})},{root:null,threshold:.05,rootMargin:"0px 0px -5% 0px"});y.observe(e),CoreUtilities.Observers.addDom(y);const v=new ResizeObserver(()=>{c(),u(),s.forEach(e=>{const r=e.dataset.key||"",s=parseFloat(e.dataset.ratio)||i(e),o=+e.dataset.targetH||0,l=Math.max(1,Math.round(o*s));e.style.minWidth=l+"px",e.style.maxWidth=l+"px",a&&(e.style.aspectRatio=s+" / 1"),t.querySelectorAll(`.service-visual-wrapper[data-clone="1"][data-key="${r}"]`).forEach(e=>{e.style.minWidth=l+"px",e.style.maxWidth=l+"px",a&&(e.style.aspectRatio=s+" / 1")})})});v.observe(t),CoreUtilities.Observers.addDom(v)})}})
		);
