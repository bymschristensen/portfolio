...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		const EntryAnimations = {
			...
			capabilities:function(e,{delayHero:t=!1}={}){var n=gsap.timeline(),o=e.querySelector(".section-table-of-contents");o&&gsap.set(o,{autoAlpha:0});n.to({},{duration:.01});var r=e.querySelector(".section-hero .headline-lg"),i=e.querySelector(".section-hero .button-primary");if(r){var a=t?0.2:0;gsap.set(r,{autoAlpha:0,visibility:"hidden"}),n.addLabel("heroStart",a).call(function(){gsap.set(r,{autoAlpha:1,visibility:"visible"});var d=CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready?CoreUtilities.Fonts.ready():Promise.resolve(),u=0,f=function(){try{if(window.SplitText&&window.splitAndMask&&window.animateLines&&window.safelyRevertSplit){var s=splitAndMask(r);animateLines(s.lines).eventCallback("onComplete",function(){safelyRevertSplit(s,r)})}else gsap.to(r,{y:0,opacity:1,duration:.6,ease:"power2.out"})}catch{}};f(),function p(){if(window.SplitText&&window.splitAndMask&&window.animateLines)return;u++,u>40||setTimeout(p,50)}();d.catch(function(){})},null,"heroStart")}i&&(gsap.set(i,{autoAlpha:0,y:20,filter:"blur(10px)"}),n.to(i,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.6,ease:"power2.out"},"heroStart+=0.4"));var l=gsap.utils.toArray(e.querySelectorAll(".table-of-contents-item"));return l.length&&n.from(l,{autoAlpha:0,paddingTop:"6rem",paddingBottom:"6rem",duration:1,ease:"power2.out",stagger:.15},0),o&&n.to(o,{autoAlpha:1,duration:.6,ease:"power2.out"},0),n},
