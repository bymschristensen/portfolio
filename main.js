	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r,t=[].slice.call(e.querySelectorAll(".filters-tab"));if(!t.length)return;function n(){var r=e.querySelector(".list-archive.is-playful")||e.querySelector('[data-archive-list="playful"]')||null,t=e.querySelector(".list-archive.is-minimal")||e.querySelector('[data-archive-list="minimal"]')||null,n=r&&!r.classList.contains("is-hidden")?r:t&&!t.classList.contains("is-hidden")?t:r||t;return{playful:r,minimal:t,active:n}}function a(r){return(r||"").toString().trim().toLowerCase()}function i(r){var e=r.getAttribute("data-filter")||r.getAttribute("data-category")||r.getAttribute("data-archive-filter");return a(e||r.textContent)}function o(r,e){if(!e||"all"===e)return!0;for(var t=r.querySelectorAll(".cms-categories, .list-categories, .archive-categories, [data-category], [data-cms-category]"),n="",i=0;i<t.length;i++)n+=" "+(t[i].textContent||"");return a(n).indexOf(e)>-1}function l(r){var e=n().active;if(!e)return;for(var t=[].slice.call(e.querySelectorAll(".list-item-archive-project")),a=0;a<t.length;a++){var i=t[a],l=o(i,r);i.style.display=l?"":"none",i.setAttribute("aria-hidden",l?"false":"true")}try{window.dispatchEvent(new CustomEvent("archive:filterChanged",{detail:{key:r}}))}catch(r){}}function s(r){for(var e=0;e<t.length;e++)t[e].classList.remove("is-active");r.classList.add("is-active")}function c(){var r=e.querySelector(".filters-tab.is-active")||t[0];return i(r)||"all"}if(e.__archiveControllerBound)return;e.__archiveControllerBound=1,l(c());for(var u=0;u<t.length;u++)!function(r){r.addEventListener("click",function(e){e.preventDefault(),s(r),l(i(r)||"all")},{passive:!1})}(t[u])}
			}),
			feature({
				...
				namespaces: ["archive"],
				selectors: [".archive-playful-list",".archive-minimal-list"],
				init: function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveListMotionBound)return;e.__archiveListMotionBound=1;var t=null;function n(){var r=e.querySelector(".list-archive.is-playful")||e.querySelector('[data-archive-list="playful"]')||null,t=e.querySelector(".list-archive.is-minimal")||e.querySelector('[data-archive-list="minimal"]')||null,n=r&&!r.classList.contains("is-hidden")?r:t&&!t.classList.contains("is-hidden")?t:r||t;return{playful:r,minimal:t,active:n}}function a(r){return window.getComputedStyle(r).display!=="none"&&r.offsetParent!==null}function i(){var r=n().active;if(!r)return[];for(var e=[].slice.call(r.querySelectorAll(".list-item-archive-project")),t=[],i=0;i<e.length;i++)a(e[i])&&t.push(e[i]);return t}function o(){var r=n().active;if(!r)return;var e=i();t&&t.kill&&t.kill(),gsap.killTweensOf([r].concat(e)),t=gsap.timeline();var a=Math.min(.25,.12+.03*e.length);t.to(r,{autoAlpha:0,duration:a,ease:"power2.out"},0),t.set(r,{autoAlpha:1},a+.01),t.set(e,{autoAlpha:0,y:100,filter:"blur(10px)"},a+.01),t.to(e,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.55,ease:"power3.out",stagger:{each:.06,from:"start"}},a+.02)}try{o()}catch(r){}window.addEventListener("archive:filterChanged",function(){o()});window.addEventListener("archive:viewChanged",function(){o()})}
			})
		);
