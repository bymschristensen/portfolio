...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			feature({id:"capabilitiesHeroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-container"],init:async e=>{const t=e.querySelector(".hero-section-showreel"),o=t&&t.querySelector(".showreel-outer"),r=t&&t.querySelector(".showreel-outer .container"),n=t&&t.querySelector(".showreel-container"),i=t&&t.querySelector(".showreel-headline"),c=t&&t.querySelector(".showreel-subtext"),l=t&&t.querySelector(".toc-outer"),s=[i,c,l].filter(Boolean);if(!t||!o||!r||!n)return;const a=e=>Math.max(0,Math.min(1,e)),u=(e,t,o)=>e+(t-e)*o;function d(e){let t=!1;const o=()=>{t=!1,e()},r=()=>{t||(t=!0,requestAnimationFrame(o))};return window.addEventListener("scroll",r,{passive:!0}),()=>window.removeEventListener("scroll",r)}let h=window.innerHeight,m=1,p=.5;const f=getComputedStyle(n).transform||"none",y="none"===f?"":f+" ";function g(){const e=n.style.transform;n.style.transform=f;const t=n.getBoundingClientRect().width||1,o=r.clientWidth||1;return n.style.transform=e,Math.max(1,o/t)}function S(){const e=t.getBoundingClientRect(),o=e.height-h;return o<=0?0:a((-e.top)/o)}function v(){const e=S(),t=u(1,m,e);const o=r.clientWidth||1,i=n.getBoundingClientRect().width||1,d=Math.max(0,o-i);let g=(p-.5)*d;n.style.transform=`${y}translate3d(${g}px,0,0) scale(${t})`;const x=-.45*h,E=1-e;s.forEach((t=>{t.style.transform=`translate3d(0, ${u(0,x,e)}px, 0)`,t.style.opacity=E}))}function x(e){const o=r.getBoundingClientRect(),n=Math.max(o.left,Math.min(e.clientX,o.right));p=(n-o.left)/(o.width||1)}function E(){h=window.innerHeight,m=g(),v()}m=g();const q=d(v);t.addEventListener("mousemove",x,{passive:!0}),window.addEventListener("resize",E),v(),document.__capHero={offScroll:q,onResize:E,onMouseMove:x,container:t,media:n,copyEls:s,base:y}},destroy:async()=>{const e=document.__capHero;if(!e)return;try{e.offScroll&&e.offScroll()}catch{}try{e.container&&e.onMouseMove&&e.container.removeEventListener("mousemove",e.onMouseMove)}catch{}try{e.onResize&&window.removeEventListener("resize",e.onResize)}catch{}try{e.media&&(e.media.style.transform=e.base||"");(e.copyEls||[]).forEach((e=>{e.style.transform="",e.style.opacity=""}))}catch{}document.__capHero=null}}),
			feature({
