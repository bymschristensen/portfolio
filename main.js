	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(r){if(!window.gsap)return;r=r||document;var t=r.querySelector('[data-barba="container"]')||r;t.__almCleanup&&function(){try{t.__almCleanup()}catch(e){}}();var e=[].slice.call(t.querySelectorAll(".archive-playful-item,.archive-minimal-item"));if(!e.length)return;e.forEach(function(e){var r=e.querySelector(".archive-minimal-item-visual");r&&(r.__almVisDone=0,gsap.set(r,{autoAlpha:0,filter:"blur(10px)",willChange:"opacity,filter"}))});var n=new IntersectionObserver(function(r){r.forEach(function(r){var t=r.target;if(!r.isIntersecting||t.__almDone||"none"===t.style.display)return;t.__almDone=1,gsap.fromTo(t,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.55,ease:"power3.out",clearProps:"y,filter,willChange"});var e=t.querySelector(".archive-minimal-item-visual");e&&!e.__almVisDone&&(e.__almVisDone=1,gsap.to(e,{autoAlpha:1,filter:"blur(0px)",delay:.35,duration:1,ease:"power2.out",clearProps:"filter,willChange"}))})},{threshold:.15});e.forEach(function(e){n.observe(e)}),t.__almCleanup=function(){try{n.disconnect()}catch(e){}t.__almCleanup=null}}
			}),
			feature({
