	...
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({
				...
				//init: function(r){if(!gsap||!ScrollTrigger)return;r=r||document;var s=[].slice.call(r.querySelectorAll(".section-single-service"));if(!s.length)return;var p=ScrollTrigger._ppsPins||[];ScrollTrigger._ppsPins=p;s.forEach(function(sec){var small=sec.offsetHeight<window.innerHeight,tl=gsap.timeline({scrollTrigger:{trigger:sec,start:small?"top top":"bottom bottom",pin:!0,pinSpacing:!1,scrub:1}}).to(sec,{ease:"none",startAt:{filter:"contrast(100%) blur(0px)"},filter:"contrast(10%) blur(10px)"},0);tl.scrollTrigger&&p.indexOf(tl.scrollTrigger)===-1&&p.push(tl.scrollTrigger)});if(ScrollTrigger._ppsHooksInstalled)return;ScrollTrigger._ppsHooksInstalled=!0;ScrollTrigger.addEventListener("refreshInit",function(){var list=ScrollTrigger._ppsPins||[];list.forEach(function(st){st&&(st._ppsPrevProgress=st.progress)})});ScrollTrigger.addEventListener("refresh",function(){var list=ScrollTrigger._ppsPins||[];list.forEach(function(st){if(!st||!st.animation)return;var p=st._ppsPrevProgress;null!=p&&st.animation.progress(p).pause()})})}
				init:function(r){if(!gsap||!ScrollTrigger)return;r=r||document;var s=[].slice.call(r.querySelectorAll(".section-single-service"));if(!s.length)return;var p=[];s.forEach(function(e){var t=e.offsetHeight<window.innerHeight,l=gsap.timeline({scrollTrigger:{trigger:e,start:t?"top top":"bottom bottom",pin:!0,pinSpacing:!1,scrub:1}}).to(e,{ease:"none",startAt:{filter:"contrast(100%) blur(0px)"},filter:"contrast(10%) blur(10px)"},0);l.scrollTrigger&&p.push(l.scrollTrigger)});if(!p.length)return;ScrollTrigger._ppsPins=(ScrollTrigger._ppsPins||[]).concat(p);if(!ScrollTrigger._ppsHandlerBound){ScrollTrigger._ppsHandlerBound=!0;ScrollTrigger.addEventListener("refresh",function(){var t=ScrollTrigger._ppsPins||[];if(!t.length)return;var l=window.innerHeight||document.documentElement.clientHeight||0;t.forEach(function(e){if(!e)return;var r=e.animation,n=e.trigger;if(!r||!n)return;var i=n.getBoundingClientRect(),o;i.bottom<=0?o=1:i.top>=l?o=0:o=0;r.progress(o)})})}}
			}),
			feature({
				id: "productGallery",
				stage: "main",
