...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		EntryAnimations.capabilities=function(e,i){e=e||document,i=i||{};var t=!!i.delayHero,a=gsap.timeline(),l=e.querySelector(".showreel-headline"),o=e.querySelector(".showreel-container");if(!l&&!o)return a;l&&gsap.set(l,{autoAlpha:0,visibility:"visible"});if(o){gsap.set(o,{autoAlpha:1,visibility:"visible",overflow:"hidden"});gsap.set(o,{clipPath:"polygon(100% 100%,100% 100%,100% 100%,100% 100%)",willChange:"clip-path"})}a.addLabel("hero",t?0.2:0);l&&a.set(l,{autoAlpha:1},"hero").call(function(){var r=CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready?CoreUtilities.Fonts.ready():Promise.resolve();r.then(function(){try{if(window.SplitText&&window.splitAndMask&&window.animateLines&&window.safelyRevertSplit){var n=splitAndMask(l);animateLines(n.lines).eventCallback("onComplete",function(){safelyRevertSplit(n,l)})}else gsap.to(l,{autoAlpha:1,duration:.01})}catch(s){gsap.to(l,{autoAlpha:1,duration:.01})}})},null,"hero");o&&a.to(o,{clipPath:"polygon(0% 0%,100% 0%,100% 100%,0% 100%)",duration:1.05,ease:"power3.inOut",clearProps:"willChange"},"hero+=0.45");return a};
