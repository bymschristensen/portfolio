	...
	window.InitManager = (function () {
		...
		registries.common.push(
			...
			feature({
				...
				//init:async r=>{if(window.__CC_LOCK)return window.__customCursorDestroy||(()=>{});window.__CC_LOCK=1;try{window.__customCursorDestroy&&window.__customCursorDestroy()}catch{}try{document.getElementById("cc-webgl")?.remove();document.getElementById("cc-dom")?.remove()}catch{}if(!matchMedia("(pointer:fine)").matches||!matchMedia("(hover:hover)").matches)return document.body.classList.remove("cursor--disable-all-cursors"),window.__customCursorDestroy=()=>{},CoreUtilities.Cursor.setDestroy(window.__customCursorDestroy),window.__CC_LOCK=0,window.__customCursorDestroy;const c=document.createElement("canvas");c.className="cursor-webgl",c.id="cc-webgl",document.body.appendChild(c);const a=c.getContext("2d"),w=document.createElement("div");w.className="custom-cursor",w.id="cc-dom";const y=document.createElement("div");y.className="cursor-content",w.appendChild(y);const k=document.createElement("div");k.className="cursor-label",k.setAttribute("aria-hidden","true");const B=document.createElement("div");B.className="cursor-label__inner";const C=document.createElement("div");C.className="cursor-label__text",B.appendChild(C),k.appendChild(B),w.appendChild(k),document.body.appendChild(w);const W=innerWidth/2,H=innerHeight/2,p={x:W,y:H,tx:W,ty:H},Q=gsap.quickSetter(w,"x","px"),K=gsap.quickSetter(w,"y","px"),j=gsap.quickSetter(k,"x","px"),z=gsap.quickSetter(k,"y","px");gsap.set(w,{x:p.x,y:p.y,scale:1,opacity:0,transformOrigin:"center center",pointerEvents:"none"}),gsap.set(y,{scale:1,transformOrigin:"center center"});gsap.set(k,{position:"absolute",top:"50%",left:"0px",x:8,yPercent:-50,autoAlpha:0,clipPath:"inset(0% 100% 100% 0%)",pointerEvents:"none",background:"var(--colors--primary)",color:"var(--colors--bg-alternative)",borderRadius:"999px",padding:"8px 10px",whiteSpace:"nowrap",lineHeight:1,willChange:"transform,clip-path,opacity"});gsap.set(B,{display:"block"});let L=0,E=0;function R(){L=innerWidth,E=innerHeight,c.width=L,c.height=E}R();const h=Array.from({length:40},()=>({x:p.x,y:p.y,vx:0,vy:0})),S={s:1};let I=null,T=null,b=null,N=null,A=!1,O=!1;const U=.01,V=.005;let i=p.x,l=p.y;function J(){clearTimeout(N),N=setTimeout(Z,1e4)}function G(){const e=document.documentElement;i=(.25+.5*Math.random())*e.clientWidth,l=(.25+.5*Math.random())*e.clientHeight}function Z(){if(A||O)return;A=!0,G();const e=()=>{A&&!O&&(Math.random()<V&&G(),p.tx+=(i-p.tx)*U,p.ty+=(l-p.ty)*U,b=requestAnimationFrame(e))};b=requestAnimationFrame(e)}function x(){A=!1,b&&cancelAnimationFrame(b),b=null}let P=0,M=0,tt=0,et=0,rt=0,nt=0,ot=0,st=0,lt=0,ct=0,at=0,ut=!1,dt=8,ft=0,pt=0,mt=0,gt=0;const ht=(e,t,n)=>Math.max(t,Math.min(n,e)),yt=t=>t.split("").map(e=>`<span class="cc-char" style="display:inline-block;will-change:transform,opacity">${" "===e?"&nbsp;":e}</span>`).join("");function vt(e){ut=!!e;const t=k.offsetWidth||0,n=innerWidth-(t+28);let o=p.tx>n;const s=o?-1:1,l=o?-100:0;ft=s*dt,pt=0,gsap.set(k,{x:ft,xPercent:l,left:"0px",right:"auto"}),k.classList.toggle("cursor-label--left",o),k.classList.toggle("cursor-label--right",!o);const c=o?"inset(0% 0% 100% 100%)":"inset(0% 100% 100% 0%)",a="inset(0% 0% 0% 0%)";gsap.killTweensOf(k),gsap.to(k,{autoAlpha:1,duration:.15,ease:"power2.out",overwrite:!0}),gsap.set(k,{clipPath:c}),gsap.to(k,{clipPath:a,duration:.38,ease:"power3.out",overwrite:!0});const w=C.querySelectorAll(".cc-char");gsap.killTweensOf(w),gsap.set(w,{y:10,opacity:0});const r={y:0,opacity:1,duration:.38,ease:"power3.out",delay:.05,overwrite:!0,stagger:{each:.018,from:o?"end":"start"}};gsap.to(w,r)}function bt(){if(!ut)return;ut=!1;const e=k.classList.contains("cursor-label--left"),t=e?"inset(0% 0% 100% 100%)":"inset(0% 100% 100% 0%)";const n=C.querySelectorAll(".cc-char");gsap.killTweensOf(n),gsap.to(n,{y:10,opacity:0,duration:.18,ease:"power2.in",overwrite:!0,stagger:{each:.012,from:e?"start":"end"}}),gsap.killTweensOf(k),gsap.to(k,{clipPath:t,duration:.22,ease:"power2.in",overwrite:!0,onComplete:()=>{gsap.set(k,{autoAlpha:0})}})}const Dt=e=>{if(O)return;x(),J();const t=e.clientX,n=e.clientY;rt=t-P,nt=n-M,P=t,M=n;const o=ht(rt*.35,-14,14),s=ht(nt*.35,-10,10);mt=o,gt=s,p.tx=t,p.ty=n},Ft=()=>{document.hidden?x():J()},qt=e=>{const t=e.target.closest("[data-cursor]");if(!t)return;y.innerHTML="",w.className="custom-cursor",document.body.classList.remove("cursor--disable-all-cursors"),S.s=1,bt();const n=(t.dataset.cursor||"").toLowerCase();if("hide"===n)return w.classList.add("cursor--hide"),document.body.classList.add("cursor--disable-all-cursors"),gsap.set(w,{scale:0,opacity:0,overwrite:!0}),void gsap.set(S,{s:0,overwrite:!0});let o=1;if("scaleup"===n)o=3,w.classList.add("cursor--scaleup"),bt();else if("text"===n){const e=(t.dataset.text||"").trim();C.innerHTML=yt(e||""),w.classList.add("cursor--active"),o=1,gsap.set(y,{scale:1}),vt(!0)}gsap.to(w,{scale:o,opacity:1,duration:.35,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:o,duration:.35,ease:"power2.out",overwrite:!0})},Mt=e=>{if(!e.target.closest("[data-cursor]"))return;y.innerHTML="",w.className="custom-cursor",document.body.classList.remove("cursor--disable-all-cursors"),bt(),gsap.killTweensOf(y),gsap.set(y,{scale:1}),gsap.to(w,{scale:1,opacity:0,duration:.35,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:1,duration:.35,ease:"power2.out",overwrite:!0})};function Y(){if(O)return;O=!0,x(),I&&cancelAnimationFrame(I),T&&cancelAnimationFrame(T),removeEventListener("resize",R),document.removeEventListener("mousemove",Dt),document.removeEventListener("pointerover",qt),document.removeEventListener("pointerout",Mt),document.removeEventListener("visibilitychange",Ft);try{c.remove()}catch{}try{w.remove()}catch{}window.__customCursorDestroy=null,window.__CC_LOCK=0}addEventListener("resize",R),document.addEventListener("mousemove",Dt,{passive:!0}),document.addEventListener("pointerover",qt,{passive:!0}),document.addEventListener("pointerout",Mt,{passive:!0}),document.addEventListener("visibilitychange",Ft),I=requestAnimationFrame(function e(){a.clearRect(0,0,L,E),p.x+=.45*(p.tx-p.x),p.y+=.45*(p.ty-p.y),h.forEach((e,t)=>{if(0===t)return e.x=p.x,void(e.y=p.y);const n=h[t-1];e.vx+=.4*(n.x-e.x),e.vy+=.4*(n.y-e.y),e.vx*=.5,e.vy*=.5,e.x+=e.vx,e.y+=e.vy});const t=getComputedStyle(document.documentElement).getPropertyValue("--colors--highlight").trim()||"#000";a.strokeStyle=t;for(let e=0;e<h.length-1;e++){const n=h[e],o=h[e+1],s=e/(h.length-1);a.lineWidth=16*(1-s)+2*s,a.lineCap="round",a.beginPath(),a.moveTo(n.x,n.y),a.lineTo(o.x,o.y),a.stroke()}a.beginPath(),a.fillStyle=t,a.arc(p.x,p.y,10*S.s,0,2*Math.PI),a.fill(),I=requestAnimationFrame(e)}),T=requestAnimationFrame(function e(){Q(p.x),K(p.y);if(ut){tt+=(mt-tt)*.18,et+=(gt-et)*.18;const t=(k.classList.contains("cursor-label--left")?-dt:dt)+tt;const n=et;ot+=(t-ot)*.22,st+=(n-st)*.22,j(ot),z(st)}T=requestAnimationFrame(e)}),J(),window.__customCursorDestroy=Y,CoreUtilities.Cursor.setDestroy(Y);return window.__CC_LOCK=0,Y}
				init:async r=>{if(window.__CC_LOCK)return window.__customCursorDestroy||(()=>{});window.__CC_LOCK=1;try{window.__customCursorDestroy&&window.__customCursorDestroy()}catch{}try{document.getElementById("cc-webgl")?.remove();document.getElementById("cc-dom")?.remove()}catch{}if(!matchMedia("(pointer:fine)").matches||!matchMedia("(hover:hover)").matches)return document.body.classList.remove("cursor--disable-all-cursors"),window.__customCursorDestroy=()=>{},CoreUtilities.Cursor.setDestroy(window.__customCursorDestroy),window.__CC_LOCK=0,window.__customCursorDestroy;const c=document.createElement("canvas");c.className="cursor-webgl",c.id="cc-webgl",document.body.appendChild(c);const a=c.getContext("2d"),w=document.createElement("div");w.className="custom-cursor",w.id="cc-dom";const y=document.createElement("div");y.className="cursor-content",w.appendChild(y);const k=document.createElement("div");k.className="cursor-label",k.setAttribute("aria-hidden","true");const B=document.createElement("div");B.className="cursor-label__inner";const C=document.createElement("div");C.className="cursor-label__text",B.appendChild(C),k.appendChild(B),w.appendChild(k),document.body.appendChild(w);const W=innerWidth/2,H=innerHeight/2,p={x:W,y:H,tx:W,ty:H},Q=gsap.quickSetter(w,"x","px"),K=gsap.quickSetter(w,"y","px"),j=gsap.quickSetter(k,"x","px"),z=gsap.quickSetter(k,"y","px");gsap.set(w,{x:p.x,y:p.y,scale:1,opacity:0,transformOrigin:"center center",pointerEvents:"none"}),gsap.set(y,{scale:1,transformOrigin:"center center"}),gsap.set(k,{position:"absolute",top:"50%",left:"0px",x:8,yPercent:-50,autoAlpha:0,clipPath:"inset(0% 100% 100% 0%)",pointerEvents:"none",background:"var(--colors--primary)",color:"var(--colors--bg-alternative)",borderRadius:"999px",padding:"8px 10px",whiteSpace:"nowrap",lineHeight:1,willChange:"transform,clip-path,opacity"}),gsap.set(B,{display:"block"});let L=0,E=0;function R(){L=innerWidth,E=innerHeight,c.width=L,c.height=E}R();const h=Array.from({length:40},()=>({x:p.x,y:p.y,vx:0,vy:0})),S={s:1};let I=null,T=null,b=null,N=null,A=!1,O=!1;const U=.01,V=.005;let i=p.x,l=p.y;function J(){clearTimeout(N),N=setTimeout(Z,1e4)}function G(){const e=document.documentElement;i=(.25+.5*Math.random())*e.clientWidth,l=(.25+.5*Math.random())*e.clientHeight}function Z(){if(A||O)return;A=!0,G();const e=()=>{A&&!O&&(Math.random()<V&&G(),p.tx+=(i-p.tx)*U,p.ty+=(l-p.ty)*U,b=requestAnimationFrame(e))};b=requestAnimationFrame(e)}function x(){A=!1,b&&cancelAnimationFrame(b),b=null}let P=0,M=0,tt=0,et=0,rt=0,nt=0,ot=0,st=0,lt=0,ct=0,at=0,ut=!1,dt=8,ft=0,pt=0,mt=0,gt=0;const ht=(e,t,n)=>Math.max(t,Math.min(n,e)),yt=t=>t.split("").map(e=>`<span class="cc-char" style="display:inline-block;will-change:transform,opacity">${" "===e?"&nbsp;":e}</span>`).join("");function vt(){ut||(ut=!0,function(){const e=k.offsetWidth||0,t=innerWidth-(e+28),n=p.tx>t,o=n?-1:1,s=n?-100:0;ft=o*dt,pt=0,gsap.set(k,{x:ft,xPercent:s,left:"0px",right:"auto"}),k.classList.toggle("cursor-label--left",n),k.classList.toggle("cursor-label--right",!n);const e=n?"inset(0% 0% 100% 100%)":"inset(0% 100% 100% 0%)",t="inset(0% 0% 0% 0%)";gsap.killTweensOf(k),gsap.to(k,{autoAlpha:1,duration:.15,ease:"power2.out",overwrite:!0}),gsap.set(k,{clipPath:e}),gsap.to(k,{clipPath:t,duration:.38,ease:"power3.out",overwrite:!0});const o=C.querySelectorAll(".cc-char");gsap.killTweensOf(o),gsap.set(o,{y:10,opacity:0}),gsap.to(o,{y:0,opacity:1,duration:.38,ease:"power3.out",delay:.05,overwrite:!0,stagger:{each:.018,from:n?"end":"start"}})}())}function bt(){if(!ut)return;ut=!1;const e=k.classList.contains("cursor-label--left"),t=e?"inset(0% 0% 100% 100%)":"inset(0% 100% 100% 0%)",n=C.querySelectorAll(".cc-char");gsap.killTweensOf(n),gsap.to(n,{y:10,opacity:0,duration:.18,ease:"power2.in",overwrite:!0,stagger:{each:.012,from:e?"start":"end"}}),gsap.killTweensOf(k),gsap.to(k,{clipPath:t,duration:.22,ease:"power2.in",overwrite:!0,onComplete:()=>{gsap.set(k,{autoAlpha:0})}})}const Dt=e=>{if(O)return;x(),J();const t=e.clientX,n=e.clientY;rt=t-P,nt=n-M,P=t,M=n;const o=ht(.35*rt,-14,14),s=ht(.35*nt,-10,10);mt=o,gt=s,p.tx=t,p.ty=n},Ft=()=>{document.hidden?x():J()},qt=e=>{const t=e.target.closest("[data-cursor]");if(!t)return;y.innerHTML="",w.className="custom-cursor",document.body.classList.remove("cursor--disable-all-cursors"),S.s=1,bt();const n=(t.dataset.cursor||"").toLowerCase();if("hide"===n)return w.classList.add("cursor--hide"),document.body.classList.add("cursor--disable-all-cursors"),gsap.set(w,{scale:0,opacity:0,overwrite:!0}),void gsap.set(S,{s:0,overwrite:!0});let o=1;if("scaleup"===n)o=3,w.classList.add("cursor--scaleup"),bt();else if("text"===n){const e=(t.dataset.text||"").trim();C.innerHTML=yt(e||""),w.classList.add("cursor--active"),o=1,gsap.set(y,{scale:1}),vt()}else bt();gsap.to(w,{scale:o,opacity:1,duration:.35,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:o,duration:.35,ease:"power2.out",overwrite:!0})},Mt=e=>{if(!e.target.closest("[data-cursor]"))return;y.innerHTML="",w.className="custom-cursor",document.body.classList.remove("cursor--disable-all-cursors"),bt(),gsap.killTweensOf(y),gsap.set(y,{scale:1}),gsap.to(w,{scale:1,opacity:0,duration:.35,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:1,duration:.35,ease:"power2.out",overwrite:!0})};function Y(){if(O)return;O=!0,x(),I&&cancelAnimationFrame(I),T&&cancelAnimationFrame(T),removeEventListener("resize",R),document.removeEventListener("mousemove",Dt),document.removeEventListener("pointerover",qt),document.removeEventListener("pointerout",Mt),document.removeEventListener("visibilitychange",Ft);try{c.remove()}catch{}try{w.remove()}catch{}window.__customCursorDestroy=null,window.__CC_LOCK=0}addEventListener("resize",R),document.addEventListener("mousemove",Dt,{passive:!0}),document.addEventListener("pointerover",qt,{passive:!0}),document.addEventListener("pointerout",Mt,{passive:!0}),document.addEventListener("visibilitychange",Ft),I=requestAnimationFrame(function e(){a.clearRect(0,0,L,E),p.x+=.45*(p.tx-p.x),p.y+=.45*(p.ty-p.y),h.forEach((e,t)=>{if(0===t)return e.x=p.x,void(e.y=p.y);const n=h[t-1];e.vx+=.4*(n.x-e.x),e.vy+=.4*(n.y-e.y),e.vx*=.5,e.vy*=.5,e.x+=e.vx,e.y+=e.vy});const t=getComputedStyle(document.documentElement).getPropertyValue("--colors--highlight").trim()||"#000";a.strokeStyle=t;for(let e=0;e<h.length-1;e++){const n=h[e],o=h[e+1],s=e/(h.length-1);a.lineWidth=16*(1-s)+2*s,a.lineCap="round",a.beginPath(),a.moveTo(n.x,n.y),a.lineTo(o.x,o.y),a.stroke()}a.beginPath(),a.fillStyle=t,a.arc(p.x,p.y,10*S.s,0,2*Math.PI),a.fill(),I=requestAnimationFrame(e)}),T=requestAnimationFrame(function e(){Q(p.x),K(p.y);if(ut){tt+=(mt-tt)*.18,et+=(gt-et)*.18;const t=(k.classList.contains("cursor-label--left")?-dt:dt)+tt,n=et;ot+=(t-ot)*.22,st+=(n-st)*.22,j(ot),z(st)}T=requestAnimationFrame(e)}),J(),window.__customCursorDestroy=Y,CoreUtilities.Cursor.setDestroy(Y);return window.__CC_LOCK=0,Y}
			}),
