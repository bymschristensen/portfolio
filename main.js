...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({id:"archiveController",stage:"main",namespaces:["archive"],selectors:[".section-archive-playful",".section-archive-minimal",".archive-playful-list",".archive-minimal-list",".archive-switch-block",".filters-tab",".modal-filters-item"],init:function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveControllerBound)return;e.__archiveControllerBound=1;var t=[].slice.call(e.querySelectorAll(".filters-tab")),n=[].slice.call(e.querySelectorAll(".modal-filters-item")),a=t.concat(n),i=e.querySelector(".archive-switch-block");if(!a.length&&!i)return;function o(r){return(r||"").toString().trim().toLowerCase()}function l(r){var e=r&&r.getAttribute&&((r.getAttribute("data-filter")||r.getAttribute("data-category")||r.getAttribute("data-archive-filter")||r.getAttribute("data-value"))||"");return o(e||r.textContent)}function s(){var r=e.querySelector(".section-archive-playful")||null,t=e.querySelector(".section-archive-minimal")||null,n=(r&&r.querySelector(".list-archive"))||e.querySelector('.list-archive.is-playful')||e.querySelector('[data-archive-list="playful"]')||e.querySelector(".archive-playful-list")||null,a=(t&&t.querySelector(".list-archive"))||e.querySelector('.list-archive.is-minimal')||e.querySelector('[data-archive-list="minimal"]')||e.querySelector(".archive-minimal-list")||null,i=null;return r&&!r.classList.contains("is-hidden")&&r.style.display!=="none"?i=n:t&&!t.classList.contains("is-hidden")&&t.style.display!=="none"?i=a:i=n||a,{playfulWrap:r,minimalWrap:t,playfulList:n,minimalList:a,activeList:i}}function c(r,e){if(!e||"all"===e)return!0;for(var t=r.querySelectorAll(".cms-categories,.list-categories,.archive-categories,[data-category],[data-cms-category]"),n="",a=0;a<t.length;a++)n+=" "+(t[a].textContent||"");return o(n).indexOf(e)>-1}function u(r){var e=s().activeList;if(!e)return;for(var t=[].slice.call(e.querySelectorAll(".list-item-archive-project")),n=0;n<t.length;n++){var a=t[n],i=c(a,r);a.style.display=i?"":"none",a.setAttribute("aria-hidden",i?"false":"true")}try{window.dispatchEvent(new CustomEvent("archive:filterChanged",{detail:{key:r}}))}catch(r){}}function d(r){for(var e=0;e<a.length;e++)a[e].classList.remove("is-active");r&&r.classList&&r.classList.add("is-active")}function f(){var r=e.querySelector(".filters-tab.is-active")||e.querySelector(".modal-filters-item.is-active")||a[0];return r?l(r)||"all":"all"}function v(r){for(var e=0;e<a.length;e++){var t=a[e],n=l(t)||"all";n===(r||"all")?t.classList.add("is-active"):t.classList.remove("is-active")}}function m(r){var t=s(),n=t.playfulWrap,a=t.minimalWrap,i=t.playfulList,o=t.minimalList;if(!n&&!a&&!i&&!o)return;var l="playful"===r,s=l?n:a,c=l?a:n,u=l?i:o,d=l?o:i;s&&(s.classList.remove("is-hidden"),s.style.display="",s.setAttribute("aria-hidden","false"));u&&(u.classList.remove("is-hidden"),u.style.display="",u.setAttribute("aria-hidden","false"));c&&(c.classList.add("is-hidden"),c.style.display="none",c.setAttribute("aria-hidden","true"));d&&(d.classList.add("is-hidden"),d.style.display="none",d.setAttribute("aria-hidden","true"));try{window.dispatchEvent(new CustomEvent("archive:viewChanged",{detail:{view:r}}))}catch(r){}}u(f());v(f());for(var p=0;p<a.length;p++)!function(r){r.addEventListener("click",function(e){e.preventDefault();var t=l(r)||"all";v(t),d(r),u(t)},{passive:!1})}(a[p]);i&&i.addEventListener("click",function(r){r.preventDefault();var e=s(),t=e.playfulWrap,n=e.minimalWrap,a=e.playfulList,o=e.minimalList;if(!t&&!n&&!a&&!o)return;var l=t&&t.style.display!=="none"&&!t.classList.contains("is-hidden")?"playful":n&&n.style.display!=="none"&&!n.classList.contains("is-hidden")?"minimal":a&&a.style.display!=="none"&&!a.classList.contains("is-hidden")?"playful":"minimal";m("playful"===l?"minimal":"playful");var i=f();v(i),u(i)},{passive:!1})}}),

			feature({id:"archiveListMotion",stage:"main",namespaces:["archive"],selectors:[".archive-playful-list",".archive-minimal-list"],init:function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveListMotionBound)return;e.__archiveListMotionBound=1;var t=null;function n(){var r=e.querySelector(".section-archive-playful")||null,t=e.querySelector(".section-archive-minimal")||null,n=(r&&r.querySelector(".list-archive"))||e.querySelector('.list-archive.is-playful')||e.querySelector('[data-archive-list="playful"]')||e.querySelector(".archive-playful-list")||null,a=(t&&t.querySelector(".list-archive"))||e.querySelector('.list-archive.is-minimal')||e.querySelector('[data-archive-list="minimal"]')||e.querySelector(".archive-minimal-list")||null,i=null;return r&&r.style.display!=="none"&&!r.classList.contains("is-hidden")?i=n:t&&t.style.display!=="none"&&!t.classList.contains("is-hidden")?i=a:i=n||a,{active:i}}function a(r){if(!r)return!1;var e=window.getComputedStyle(r);return"none"!==e.display&&"hidden"!==e.visibility&&r.getClientRects&&r.getClientRects().length>0}function i(){var r=n().active;if(!r)return[];for(var e=[].slice.call(r.querySelectorAll(".list-item-archive-project")),t=[],n=0;n<e.length;n++)a(e[n])&&t.push(e[n]);return t}function o(){var r=n().active;if(!r)return;var e=i();t&&t.kill&&t.kill();gsap.killTweensOf(e);t=gsap.timeline({defaults:{overwrite:!0}});t.set(e,{autoAlpha:0,y:60,filter:"blur(10px)"}).to(e,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.5,ease:"power3.out",stagger:{each:.05,from:"start"}},0)}try{o()}catch(r){}window.addEventListener("archive:filterChanged",o);window.addEventListener("archive:viewChanged",o)}})
		);
