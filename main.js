	...
	window.InitManager = (function () {
		...
		registries.common.push(
			...
			feature({
				...
				init: async e=>{const t=.15,r=.8;e.querySelectorAll(".appear-in-line").forEach((function(o){if(o.__ailArmed)return;o.__ailArmed=!0;const a=[],n=[];Array.from(o.querySelectorAll(":scope > *")).forEach((e=>{const t=getComputedStyle(e),r=parseInt(t.columnCount,10)||1,o=e.getBoundingClientRect();if(r>1)try{gsap.set(e,{opacity:0});const t=new SplitText(e,{type:"lines",linesClass:"split-line"});a.push(t);const s=o.width/r,i=Array.from({length:r},(()=>[]));t.lines.forEach((e=>{const t=e.getBoundingClientRect().left-o.left,a=Math.min(Math.floor(t/s),r-1);i[a].push(e),gsap.set(e,{y:100,opacity:0,filter:"blur(10px)",willChange:"transform,opacity"})})),i.forEach((e=>n.push(e)))}catch(t){gsap.set(e,{y:100,opacity:0,filter:"blur(10px)",willChange:"transform,opacity"}),n.push([e])}else gsap.set(e,{y:100,opacity:0,filter:"blur(10px)",willChange:"transform,opacity"}),n.push([e])}));const s=new IntersectionObserver(((e,o)=>{e.forEach((e=>{if(!e.isIntersecting)return;o.unobserve(e.target),n.forEach(((e,o)=>{gsap.to(e,{y:0,opacity:1,filter:"blur(0px)",duration:r,ease:"power2.out",delay:o*t})}));const a=(n.length-1)*t+r;gsap.delayedCall(a+.05,(()=>{try{e.forEach((e=>e.revert()))}catch(e){}}))}))}),{root:null,rootMargin:"0px 0px -10% 0px",threshold:0});CoreUtilities.Observers.addDom(s),s.observe(o);const i=o.getBoundingClientRect();if(i.top<window.innerHeight&&i.bottom>0){s.unobserve(o),n.forEach(((e,o)=>{gsap.to(e,{y:0,opacity:1,filter:"blur(0px)",duration:r,ease:"power2.out",delay:o*t})}));const e=(n.length-1)*t+r;gsap.delayedCall(e+.05,(()=>{try{a.forEach((e=>e.revert()))}catch(e){}}))}if(e.querySelector(".w-tabs")){const e=o.closest(".w-tab-pane");if(e){const i=new MutationObserver((()=>{if(!e.classList.contains("w--tab-active"))return;s.observe(o);const i=o.getBoundingClientRect();if(i.top<window.innerHeight&&i.bottom>0){s.unobserve(o),n.forEach(((e,o)=>{gsap.to(e,{y:0,opacity:1,filter:"blur(0px)",duration:r,ease:"power2.out",delay:o*t})}));const e=(n.length-1)*t+r;gsap.delayedCall(e+.05,(()=>{try{a.forEach((e=>e.revert()))}catch(e){}}))}}));CoreUtilities.Observers.addDom(i),i.observe(e,{attributes:!0,attributeFilter:["class"]})}}}))}
			}),
