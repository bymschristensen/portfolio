...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({id:"archiveController",stage:"main",namespaces:["archive"],selectors:[".section-archive-playful",".section-archive-minimal",".archive-playful-list",".archive-minimal-list",".archive-switch-block",".archive-switch",".archive-switch-dot","#archive-filter-all","#archive-filter-appswebapps","#archive-filter-websites","#archive-filter-ecommerce","#archive-filter-platforms-systems","#archive-filter-other","#nav-archive-filter-all","#nav-archive-filter-appswebapps","#nav-archive-filter-websites","#nav-archive-filter-ecommerce","#nav-archive-filter-platforms-systems","#nav-archive-filter-other"],init:function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveControllerBound)return;e.__archiveControllerBound=1;var t=e.querySelector(".section-archive-playful"),n=e.querySelector(".section-archive-minimal"),a=e.querySelector(".archive-playful-list"),i=e.querySelector(".archive-minimal-list"),o=e.querySelector(".archive-switch-block"),l=e.querySelector(".archive-switch"),s=e.querySelector(".archive-switch-dot"),c=[].slice.call(e.querySelectorAll('#archive-filter-all,#archive-filter-appswebapps,#archive-filter-websites,#archive-filter-ecommerce,#archive-filter-platforms-systems,#archive-filter-other,#nav-archive-filter-all,#nav-archive-filter-appswebapps,#nav-archive-filter-websites,#nav-archive-filter-ecommerce,#nav-archive-filter-platforms-systems,#nav-archive-filter-other'));if(!a&&!i)return;function u(r){return(r||"").toString().trim().toLowerCase()}function d(r){var e=(r&&r.id||"").toLowerCase();return e.indexOf("appswebapps")>-1?"apps & web-apps":e.indexOf("websites")>-1?"websites":e.indexOf("ecommerce")>-1?"e-commerce":e.indexOf("platforms-systems")>-1||e.indexOf("platforms_systems")>-1?"platforms & systems":e.indexOf("other")>-1?"other":"all"}function f(){var r=a&&!a.classList.contains("is-hidden")&&a.getClientRects().length>0,e=i&&!i.classList.contains("is-hidden")&&i.getClientRects().length>0;return r&&!e?"playful":e&&!r?"minimal":a?"playful":"minimal"}function v(r){(a&&("playful"===r?(a.classList.remove("is-hidden"),a.setAttribute("aria-hidden","false")):(a.classList.add("is-hidden"),a.setAttribute("aria-hidden","true")))),(i&&("minimal"===r?(i.classList.remove("is-hidden"),i.setAttribute("aria-hidden","false")):(i.classList.add("is-hidden"),i.setAttribute("aria-hidden","true")))),(t&&("playful"===r?(t.classList.remove("is-hidden"),t.setAttribute("aria-hidden","false")):(t.classList.add("is-hidden"),t.setAttribute("aria-hidden","true")))),(n&&("minimal"===r?(n.classList.remove("is-hidden"),n.setAttribute("aria-hidden","false")):(n.classList.add("is-hidden"),n.setAttribute("aria-hidden","true"))));try{window.dispatchEvent(new CustomEvent("archive:viewChanged",{detail:{view:r}}))}catch(r){}}function m(r){for(var e=0;e<c.length;e++){var t=d(c[e]);t===r?c[e].classList.add("is-active"):c[e].classList.remove("is-active")}}function p(r){var e="all"===r?null:r;function t(r){for(var t=r.querySelectorAll(".archive-categories .cms-categories, .cms-categories,[data-category],[data-cms-category]"),n="",a=0;a<t.length;a++)n+=" "+(t[a].textContent||"");return u(n)}function n(r){return!e||t(r).indexOf(e)>-1}if(a)for(var i=[].slice.call(a.querySelectorAll(".archive-playful-item")),o=0;o<i.length;o++){var l=n(i[o]);i[o].style.display=l?"":"none",i[o].setAttribute("aria-hidden",l?"false":"true")}if(i)for(var s=[].slice.call(i.querySelectorAll(".archive-minimal-item")),c2=0;c2<s.length;c2++){var d2=n(s[c2]);s[c2].style.display=d2?"":"none",s[c2].setAttribute("aria-hidden",d2?"false":"true")}try{window.dispatchEvent(new CustomEvent("archive:filterChanged",{detail:{key:r}}))}catch(r){}}var g="playful";try{g=localStorage.getItem("archive:view")||g}catch(r){}v(g);var h="all";for(var y=0;y<c.length;y++)if(c[y].classList.contains("is-active")){h=d(c[y])||"all";break}m(h);p(h);for(var b=0;b<c.length;b++)!function(r){r.addEventListener("click",function(e){e.preventDefault();var t=d(r)||"all";m(t),p(t)},{passive:!1})}(c[b]);(o||l)&&((o||l).addEventListener("click",function(r){r.preventDefault();var e=f(),t="playful"===e?"minimal":"playful";try{localStorage.setItem("archive:view",t)}catch(r){}v(t);var n="all";for(var a2=0;a2<c.length;a2++)if(c[a2].classList.contains("is-active")){n=d(c[a2])||"all";break}m(n),p(n)},{passive:!1})),s&&gsap.set(s,{xPercent:0})}}),

			feature({id:"archiveListMotion",stage:"main",namespaces:["archive"],selectors:[".archive-playful-list",".archive-minimal-list",".archive-playful-item",".archive-minimal-item"],init:function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveListMotionBound)return;e.__archiveListMotionBound=1;var t=null;function n(){var r=e.querySelector(".archive-playful-list"),t2=e.querySelector(".archive-minimal-list"),n2=r&&!r.classList.contains("is-hidden")&&r.getClientRects().length>0,a2=t2&&!t2.classList.contains("is-hidden")&&t2.getClientRects().length>0,i2=n2&&!a2?"playful":a2&&!n2?"minimal":r?"playful":"minimal",o2="playful"===i2?r:t2;return{view:i2,list:o2}}function a(r){if(!r)return!1;var e=window.getComputedStyle(r);return"none"!==e.display&&"hidden"!==e.visibility&&r.getClientRects&&r.getClientRects().length>0}function i(){var r=n(),e=r.view,t=r.list;if(!t)return[];var i2="playful"===e?".archive-playful-item":".archive-minimal-item",o2=[].slice.call(t.querySelectorAll(i2)),l=[];for(var s=0;s<o2.length;s++)a(o2[s])&&l.push(o2[s]);return l}function o(){var r=n(),e=r.list;if(!e)return;var a2=i();t&&t.kill&&t.kill();gsap.killTweensOf([e].concat(a2));t=gsap.timeline({defaults:{overwrite:!0}});var o2=Math.min(.22,.10+.02*a2.length);t.to(e,{autoAlpha:0,duration:o2,ease:"power2.out"},0).set(e,{autoAlpha:1},o2+.01).set(a2,{autoAlpha:0,y:90,filter:"blur(10px)"},o2+.01).to(a2,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.55,ease:"power3.out",stagger:{each:.06,from:"start"}},o2+.02)}function l(){requestAnimationFrame(function(){requestAnimationFrame(o)})}try{o()}catch(r){}window.addEventListener("archive:filterChanged",l);window.addEventListener("archive:viewChanged",l)}})
		);
