...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".hero-section-showreel .showreel-container");if(!r||!n)return;t.__hsBound=1;var i=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9"),o={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0,wP:0,prevSq:0,wob:0,scroll:0},L=2.2,M=.3,V=1300,S=.13,H={base:.8,min:.65,max:1},WF=5,WS=.5,SR=.08,EPS=.002,ST=null,P={b0:.8,b1:1,mn0:.65,mn1:.97,mx0:1,mx1:1.02};function c(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0;o.tw=t.width||r.offsetWidth||0;o.left=t.left;o.right=t.right;o.baseC=e.left+e.width/2-o.x;!i&&o.w&&(n.style.height=o.w*9/16+"px")}function d(e,t,r){return e<t?t:e>r?r:e}function u(e){var t=d(e,o.left,o.right),i=t+o.w/2,c=o.left+o.w/2,l=o.right-o.w/2;c>l&&(c=l=(o.left+o.right)/2);var a=d(i,c,l);return a-o.baseC}function a(e){var t=e.clientX;o.hasMove&&(o.vx+=t-(null==o.px?t:o.px));o.hasMove=!0;o.px=t}function s(e){o.last||(o.last=e);var t=(e-o.last)/1e3;t<0&&(t=0);t>.05&&(t=.05);o.last=e;c();var l=o.scroll;l<0&&(l=0);l>1&&(l=1);H.base=P.b0+(P.b1-P.b0)*l;H.min=P.mn0+(P.mn1-P.mn0)*l;H.max=P.mx0+(P.mx1-P.mx0)*l;if(!o.hasMove||null==o.px){n.style.transform="translate3d("+o.x+"px,0,0) scale("+H.base+")";o.raf=requestAnimationFrame(s);return}var a=u(o.px),f=1-Math.exp(-L*t);o.x+=f*(a-o.x);o.vx*=.96;Math.abs(o.vx)<.02&&(o.vx=0);var h=0;o.vx&&(h=-o.vx/V,h>M?h=M:h<-M&&(h=-M));o.sq+=S*(h-o.sq);var v=H.base+o.sq;v<H.min?v=H.min:v>H.max&&(v=H.max);var p=1,m=v-H.base,y=o.prevSq,g=Math.abs(m),w=Math.abs(y),x=.02,C=.03,T=g<x&&w>C;if(T&&!o.wob){o.wob=1;o.wP=0}if(o.wob>0){o.wP+=WF*t;var E=WS*o.wob;p=1+E*Math.sin(o.wP);o.wob-=t/.9;o.wob<=.001&&(o.wob=0,o.wP=0,p=1)}else p=1;o.prevSq=m;var k=v*p;n.style.transform="translate3d("+o.x+"px,0,0) scale("+k+")";o.raf=requestAnimationFrame(s)}c();n.style.transform="translate3d(0,0,0) scale("+H.base+")";addEventListener("pointermove",a,{passive:!0});addEventListener("resize",c,{passive:!0});o.raf=requestAnimationFrame(s);if(window.gsap&&window.ScrollTrigger){gsap.registerPlugin(ScrollTrigger);ST=ScrollTrigger.create({trigger:t,start:"top top",end:"bottom top",onUpdate:function(e){o.scroll=e.progress}})}t.__hsDestroy=function(){try{removeEventListener("pointermove",a)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}try{ST&&ST.kill()}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
