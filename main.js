...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({id:"archiveFiltersController",stage:"early",namespaces:["archive"],selectors:["#archive-filter-all","#archive-filter-appswebapps","#archive-filter-websites","#archive-filter-ecommerce","#archive-filter-platforms-systems","#archive-filter-other","#nav-archive-filter-all","#nav-archive-filter-appswebapps","#nav-archive-filter-websites","#nav-archive-filter-ecommerce","#nav-archive-filter-platforms-systems","#nav-archive-filter-other"],init:function(e){if(!(e=e||document).__archiveFiltersBound)return e.__archiveFiltersBound=1,e.__archiveFiltersDestroy=function(){e.__archiveFiltersBound=0,e.__archiveFiltersDestroy=null}}}),
