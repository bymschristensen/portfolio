...
!function(){if(["portfolio-13-ec6f18.webflow.io"].includes(location.hostname)){var t="gh:portfolio:main:sha";try{var o=Date.now(),e=null;try{e=JSON.parse(sessionStorage.getItem(t)||"null")}catch{}if(e&&e.sha&&o-(e.t||0)<12e4)return void console.info("[BOOT] latest main commit (cached):",e.sha,e.date||"");var n=new AbortController,a=setTimeout((function(){try{n.abort()}catch{}}),3e3);fetch("https://api.github.com/repos/bymschristensen/portfolio/commits/main",{signal:n.signal,cache:"no-store",headers:{Accept:"application/vnd.github+json"}}).then((function(t){return t.ok?t.json():Promise.reject(t)})).then((function(o){var e=Array.isArray(o)?o[0]:o,n=(e&&e.sha?e.sha:"").slice(0,7),a=e&&e.commit&&e.commit.author&&e.commit.author.date||"";n&&(sessionStorage.setItem(t,JSON.stringify({sha:n,date:a,t:Date.now()})),console.info("[BOOT] latest main commit:",n,a))})).catch((function(){})).finally((function(){clearTimeout(a)}))}catch{}}}();
