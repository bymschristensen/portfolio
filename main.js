	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				namespaces: ["archive"],
				selectors: [".archive-playful-list",".archive-minimal-list"],
				init: function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveListMotionBound)return;e.__archiveListMotionBound=1;var t=null;function n(){var r=e.querySelector(".list-archive.is-playful")||e.querySelector('[data-archive-list="playful"]'),t=e.querySelector(".list-archive.is-minimal")||e.querySelector('[data-archive-list="minimal"]'),n=r&&!r.classList.contains("is-hidden")?r:t&&!t.classList.contains("is-hidden")?t:r||t;return{active:n}}function a(o){return o&&window.getComputedStyle(o).display!=="none"&&o.offsetParent!==null}function i(){var r=n().active;if(!r)return[];for(var e=[].slice.call(r.querySelectorAll(".list-item-archive-project")),t=[],o=0;o<e.length;o++)a(e[o])&&t.push(e[o]);return t}function o(){var r=n().active;if(!r)return;var e=i();t&&t.kill&&t.kill();gsap.killTweensOf([r].concat(e));t=gsap.timeline();var n=Math.min(.25,.12+.03*e.length);t.to(r,{autoAlpha:0,duration:n,ease:"power2.out"},0).set(r,{autoAlpha:1},n+.01).set(e,{autoAlpha:0,y:100,filter:"blur(10px)"},n+.01).to(e,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.55,ease:"power3.out",stagger:{each:.06,from:"start"}},n+.02)}try{o()}catch(r){}window.addEventListener("archive:filterChanged",o);window.addEventListener("archive:viewChanged",o)}
			})
		);
