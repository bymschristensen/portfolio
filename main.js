	...
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({
				...
				init: async R=>{if(matchMedia("(prefers-reduced-motion: reduce)").matches)return;const U=o=>{const e=[...o.querySelectorAll("img,video")];if(!e.length)return Promise.resolve();const t=o=>o.naturalWidth>0&&o.naturalHeight>0||o.videoWidth>0&&o.videoHeight>0;let r=[];return Promise.race([Promise.all(e.map(o=>{if(t(o))return Promise.resolve();const e="function"==typeof o.decode?o.decode().catch(()=>{}):Promise.resolve(),r=new Promise(e=>{const t=()=>{o.removeEventListener("load",t),e()};o.addEventListener("load",t,{once:!0})}),n=new Promise(e=>{let r=0;!function i(){if(t(o)||r++>80)return e();setTimeout(i,40)}()});return Promise.race([e,r,n])})),new Promise(o=>r.push(setTimeout(o,3500)))]).finally(()=>r.forEach(clearTimeout))},S=!!(window.CSS&&CSS.supports&&CSS.supports("aspect-ratio: 1/1")),A=o=>{const e=parseFloat(o.getAttribute("data-ratio"));if(e&&e>0)return e;const t=(o.className||"").match(/sv-ratio-(\d+)/);if(t){const o=t[1];if("169"===o)return 16/9;if("133"===o||"43"===o)return 4/3;if("11"===o)return 1}const r=o.querySelector("img,video");if(r){const o=parseInt(r.getAttribute("width"),10)||r.naturalWidth||r.videoWidth||0,e=parseInt(r.getAttribute("height"),10)||r.naturalHeight||r.videoHeight||0;if(o>0&&e>0)return o/e}return 3/2},H=(o,e)=>{const t=parseFloat(o.getAttribute("data-size"));if(t&&t>0)return Math.max(1,Math.round(e*t/100));const r=(o.className||"").match(/sv-size-(\d+)/);if(r){const o=parseFloat(r[1]);if(o>0)return Math.max(1,Math.round(e*o/100))}const n=o.getBoundingClientRect().height||0;return n>0?Math.round(n):Math.max(1,Math.round(.5*e))},g=()=>Math.max(document.documentElement.clientWidth,window.innerWidth||0),L=[...R.querySelectorAll(".infinite-gallery")];if(!L.length)return;L.forEach(E=>{const W=E.querySelector(".infinite-gallery-wrapper");if(!W||W.__inited)return;W.__inited=!0,E.setAttribute("data-armed","measure");const C=[...W.querySelectorAll(".service-visual-wrapper:not([data-clone])")];if(!C.length){E.setAttribute("data-armed","1");return}const k=new Set;let i=!1,a=0,l=0,c=0,d=("right"===(E.dataset.direction||"left").toLowerCase()?-1:1),u=parseFloat(E.dataset.speed)||.6;C.forEach((o,e)=>{const t=A(o);o.dataset.ratio=String(t),o.dataset.key=String(e),o.dataset.revealed="0",o.dataset.revealing="",o.style.overflow="hidden",o.style.flex="0 0 auto",o.style.height="0px",o.style.willChange="height,transform",S?(o.style.aspectRatio=t+" / 1",o.style.removeProperty("width"),o.style.removeProperty("min-width"),o.style.removeProperty("max-width")):(o.style.width="1px",o.style.minWidth="1px",o.style.maxWidth="1px")});const q=()=>{C.forEach(o=>{const e=parseFloat(o.dataset.ratio)||A(o),t=H(o,W.clientHeight);o.dataset.targetH=String(t),S?o.style.aspectRatio=e+" / 1":(()=>{const r=Math.max(1,Math.round(t*e));o.style.width=r+"px",o.style.minWidth=r+"px",o.style.maxWidth=r+"px"})()}),W.style.gap=getComputedStyle(W).gap||"0px"},x=()=>{C.forEach(o=>{const e=o.cloneNode(!0),t=o.dataset.key||"",r=parseFloat(o.dataset.ratio)||A(o),n=+o.dataset.targetH||0;e.setAttribute("data-clone","1"),e.dataset.key=t,e.dataset.ratio=String(r),e.style.overflow="hidden",e.style.flex="0 0 auto",e.style.willChange="height,transform",e.style.height=k.has(t)&&n>0?n+"px":"0px",S?e.style.aspectRatio=r+" / 1":(()=>{const o=Math.max(1,Math.round(Math.max(1,n)*r));e.style.width=o+"px",e.style.minWidth=o+"px",e.style.maxWidth=o+"px"})(),W.appendChild(e)})},y=()=>{[...W.querySelectorAll('.service-visual-wrapper[data-clone="1"]')].forEach(o=>o.remove())},V=()=>{let o=0;return W.childNodes.forEach(e=>{1===e.nodeType&&(o+=(e.getBoundingClientRect().width||0)+(parseFloat(getComputedStyle(W).gap||"0")||0))}),o},b=()=>{y(),x(),x();let o=0;for(;V()<3*g()&&o++<8;)x()},T=()=>{E.setAttribute("data-armed","1");const o=E.getBoundingClientRect(),e=innerHeight||document.documentElement.clientHeight||0;o.bottom>0&&o.top<e&&(i=!0,cancelAnimationFrame(a),a=requestAnimationFrame(M))},M=o=>{if(!i){cancelAnimationFrame(a);return}if((o||0)-l<32){a=requestAnimationFrame(M);return}l=o||performance.now();const e=innerWidth||document.documentElement.clientWidth||0,t=-.05*e,r=1.05*e,n=[...W.querySelectorAll('.service-visual-wrapper:not([data-clone])')].filter(o=>{const e=o.getBoundingClientRect();return e.right>t&&e.left<r}).filter(o=>"1"!==o.dataset.revealed&&"1"!==o.dataset.revealing).sort((o,e)=>o.getBoundingClientRect().left-e.getBoundingClientRect().left);if(n.length){const o=gsap.timeline();n.forEach((e,t)=>{const r=+e.dataset.targetH||0,n=e.dataset.key||"",s=parseFloat(e.dataset.ratio)||A(e);e.dataset.revealing="1",o.fromTo(e,{height:0},{height:r,duration:.9,ease:"power2.out",onComplete:()=>{if(e.style.height="",e.dataset.revealed="1",e.dataset.revealing="",k.add(n),W.querySelectorAll('.service-visual-wrapper[data-clone="1"][data-key="'+n+'"]').forEach(o=>{if(o.style.height=r+"px",!S){const e=Math.max(1,Math.round(r*s));o.style.width=e+"px",o.style.minWidth=e+"px",o.style.maxWidth=e+"px"}}),!S){const o=Math.max(1,Math.round(r*s));e.style.width=o+"px",e.style.minWidth=o+"px",e.style.maxWidth=o+"px"}}},.12*t)})}a=requestAnimationFrame(M)},P=(o,e)=>{const t=(e||16.6667)/1e3,r=60*u;c-=d*t*r;const n=o=>o.getBoundingClientRect().width+(parseFloat(getComputedStyle(W).gap||"0")||0);let s=W.firstElementChild,f=0;for(;s&&c<-n(s)&&f++<50;)c+=n(s),W.appendChild(s),s=W.firstElementChild;let m=W.lastElementChild;for(f=0;m&&c>0&&f++<50;)c-=n(m),W.insertBefore(m,W.firstElementChild),m=W.lastElementChild;gsap.set(W,{x:c});const h=(innerWidth||0)/2;W.querySelectorAll(".service-visual").forEach(o=>{const e=o.closest(".service-visual-wrapper");if(!e)return;const t=e.getBoundingClientRect(),r=(h-(t.left+t.width/2))/((innerWidth)||1);o.style.setProperty("--drift",40*r+"px")})},I=o=>{o.forEach(o=>{o.target===E&&(o.isIntersecting?(i=!0,cancelAnimationFrame(a),a=requestAnimationFrame(M)):(i=!1,cancelAnimationFrame(a)))})},RO=new ResizeObserver(()=>{q(),y(),b(),C.forEach(o=>{const e=o.dataset.key||"",t=+o.dataset.targetH||0;W.querySelectorAll('.service-visual-wrapper[data-clone="1"][data-key="'+e+'"]').forEach(o=>{o.style.height=t+"px"})}),T()});(async()=>{await U(W),q(),b(),T();const o=new IntersectionObserver(I,{root:null,threshold:0,rootMargin:"0px 0px -5% 0px"});o.observe(E),CoreUtilities.Observers.addDom(o),CoreUtilities.Observers.addDom({disconnect(){i=!1,cancelAnimationFrame(a)}});const e=(o,e)=>P(o,e);gsap.ticker.add(e),CoreUtilities.Observers.addTicker(e),RO.observe(W),CoreUtilities.Observers.addDom(RO)})();});}
			})
		);
