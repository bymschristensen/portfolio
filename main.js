...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1,n.style.transformOrigin="center center",n.style.willChange="transform";try{gsap.set(n,{x:0,scaleX:1,scaleY:1,force3D:!0})}catch(e){}var o={x:0,sc:1,tsc:1,px:0,hasMove:!1,raf:0,last:0,w:0,tw:0,lock:!1,vx:0,sq:0},E=1.1,P=20,S=.96,M=1.1,D=60,F=10,L=6,s=gsap.quickSetter(n,"scaleX"),a=gsap.quickSetter(n,"scaleY"),i=gsap.quickSetter(n,"x","px");function c(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0,o.tw=t.width||r.offsetWidth||0}function l(){return Math.max(0,(o.tw-o.w*o.sc)/2)}function u(e){var t=r.getBoundingClientRect(),n=(e-t.left)+P+o.w*o.sc/2-(o.tw/2),s=l(),i=Math.max(-s,Math.min(s,n)),c=s?i/s:0,u=Math.tanh(c*E)/Math.tanh(E);return u*s}function d(e){var t=e.clientX;o.hasMove&&(o.vx+=t-(o.px||t)),o.hasMove=!0,o.px=t}function f(){var e=r.getBoundingClientRect(),t=(innerHeight||document.documentElement.clientHeight||0),n=e.top+e.height/2,s=Math.abs(n-t/2),i=1-Math.min(1,s/(.75*t));o.tsc=S+i*(M-S),o.lock=o.w*o.sc>=o.tw-1}function h(){c()}function m(e){if(!o.hasMove){o.last=e,o.raf=requestAnimationFrame(m);return}o.last||(o.last=e);var t=Math.min(.05,(e-o.last)/1e3);o.last=e,l();var n=innerWidth||document.documentElement.clientWidth||1,c=.5*n,p=o.px||c,h=(c-p)/n*D,g=o.lock?0:o.hasMove?u(p)+h:0,v=1-Math.exp(-F*t),x=1-Math.exp(-L*t);o.sc+=x*(o.tsc-o.sc),o.x+=v*(g-o.x),o.vx*=.9;var y=0;if(Math.abs(o.vx)>.1){var w=-(o.vx/400);w>.22?w=.22:w<-.22&&(w=-.22),y=w}o.sq+=.18*(y-o.sq);var C=o.sc*(1+o.sq),T=o.sc*(1-.55*o.sq);i(o.x),s(C),a(T),o.raf=requestAnimationFrame(m)}c(),f(),addEventListener("pointermove",d,{passive:!0}),addEventListener("scroll",f,{passive:!0}),addEventListener("resize",h,{passive:!0}),o.raf=requestAnimationFrame(m),t.__hsDestroy=function(){try{removeEventListener("pointermove",d)}catch(e){}try{removeEventListener("scroll",f)}catch(e){}try{removeEventListener("resize",h)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
