	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init:function(r){r=r||document;var h=r.querySelector('[data-barba="container"][data-barba-namespace="archive"]')||r.querySelector('[data-barba="container"]')||r;if(h.__apx2Bound)return;h.__apx2Bound=1;if(!window.gsap||!window.ScrollTrigger)return void(h.__apx2Bound=0);var g=window.gsap,S=window.ScrollTrigger,mm=matchMedia("(min-width:1024px)"),pr=matchMedia("(prefers-reduced-motion: reduce)");if(pr.matches)return void(h.__apx2Bound=0);var P=h.querySelector(".section-archive-playful");if(!P)return void(h.__apx2Bound=0);var un=[],sts=[],tls=[],made=!1;function on(n,e,f,o){n&&n.addEventListener(e,f,o),un.push(function(){try{n.removeEventListener(e,f,o)}catch(_){}})}function q(a,s){return a?a.querySelector(s):null}function qs(a,s){return a?[].slice.call(a.querySelectorAll(s)):[]}function vis(){try{return!!(P&&getComputedStyle(P).display!=="none")}catch(_){return!0}}function items(){return[].slice.call(P.querySelectorAll(".archive-playful-item"))}function prep(it){if(!it||it.__apx2Prep)return;it.__apx2Prep=1;var v=q(it,".archive-playful-visuals"),imgs=qs(it,".archive-playful-visual-img"),di=q(it,".archive-playful-data-inner"),dp=qs(it,".archive-playful-data-inner .archive-playful-data-product, .archive-playful-data-inner .archive-playful-data-expertise"),ln=q(it,".archive-playful-item-data-outer .case-study-url");v&&g.set(v,{overflow:"hidden",transformOrigin:"50% 0%",scaleY:1,willChange:"transform"});imgs.length&&imgs.forEach(function(im){try{g.set(im,{yPercent:-15,scale:1,transformOrigin:"50% 50%",willChange:"transform"})}catch(_){}});di&&g.set(di,{willChange:"margin-top,margin-bottom"});dp.length&&dp.forEach(function(el){try{g.set(el,{transformOrigin:"50% 0%",scaleY:1,willChange:"transform,opacity"})}catch(_){}});ln&&g.set(ln,{transformOrigin:"50% 0%",scaleY:1,willChange:"transform,opacity"})}function tl(it){var v=q(it,".archive-playful-visuals"),imgs=qs(it,".archive-playful-visual-img"),di=q(it,".archive-playful-data-inner"),dp=qs(it,".archive-playful-data-inner .archive-playful-data-product, .archive-playful-data-inner .archive-playful-data-expertise"),ln=q(it,".archive-playful-item-data-outer .case-study-url"),t=g.timeline({paused:!0,defaults:{ease:"none"}});imgs.length&&t.to(imgs,{yPercent:15,duration:1},0);dp.length&&t.to(dp,{opacity:0,duration:.08},.70);di&&t.to(di,{marginTop:0,marginBottom:0,duration:.08},.70);dp.length&&t.to(dp,{scaleY:0,duration:.08},.75);ln&&t.to(ln,{opacity:0,duration:.08},.75);ln&&t.to(ln,{scaleY:0,duration:.08},.80);imgs.length&&t.to(imgs,{scale:1.5,duration:.20},.80);v&&t.to(v,{scaleY:0,duration:.20},.80);return t}function kill(){for(var i=0;i<sts.length;i++)try{sts[i]&&sts[i].kill&&sts[i].kill()}catch(_){}for(i=0;i<tls.length;i++)try{tls[i]&&tls[i].kill&&tls[i].kill()}catch(_){}sts.length=0;tls.length=0;made=!1}function build(){if(made)return;var list=items();if(!list.length)return;for(var i=0;i<list.length;i++){var it=list[i];prep(it);var T=tl(it);tls.push(T);sts.push(S.create({trigger:it,start:"top 100%",end:"top 0%",scrub:!0,animation:T,invalidateOnRefresh:!0}))}made=!0;try{S.refresh()}catch(_){}}function enable(){if(!mm.matches||!vis())return;build();for(var i=0;i<sts.length;i++)try{sts[i]&&sts[i].enable&&sts[i].enable()}catch(_){}}function disable(){for(var i=0;i<sts.length;i++)try{sts[i]&&sts[i].disable&&sts[i].disable()}catch(_){}}function sync(){mm.matches&&vis()?enable():disable()}function ref(){try{S.refresh()}catch(_){}}function onMQ(){sync();requestAnimationFrame(ref)}function onView(){sync();requestAnimationFrame(ref)}function onFilter(){sync();requestAnimationFrame(ref)}on(document,"archive:view",onView,{passive:!0});on(document,"archive:filter:applied",onFilter,{passive:!0});try{mm.addEventListener?mm.addEventListener("change",onMQ):mm.addListener(onMQ)}catch(_){ }un.push(function(){try{mm.removeEventListener?mm.removeEventListener("change",onMQ):mm.removeListener(onMQ)}catch(_){}});on(window,"load",function(){requestAnimationFrame(ref)},{once:!0,passive:!0});requestAnimationFrame(sync);setTimeout(function(){try{S.refresh()}catch(_){}} ,350);return function(){try{kill()}catch(_){ }un.forEach(function(fn){fn()});un.length=0;try{h.__apx2Bound=0}catch(_){}}}
			})
		);
