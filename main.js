...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1;var i=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9"),o={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0,wP:0},L=2.4,M=.3,V=1300,S=.16,H={base:.80,min:.70,max:90},WF=6,WS=.2,SR=.12,EPS=.003;function c(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0,o.tw=t.width||r.offsetWidth||0,o.left=t.left,o.right=t.right,o.baseC=e.left+e.width/2-o.x,!i&&o.w&&(n.style.height=o.w*9/16+"px")}function u(e,t,r){return e<t?t:e>r?r:e}function l(e){var t=u(e,o.left,o.right),i=t+o.w/2,c=o.left+o.w/2,l=o.right-o.w/2;c>l&&(c=l=(o.left+o.right)/2);var a=u(i,c,l);return a-o.baseC}function a(e){var t=e.clientX;o.hasMove&&(o.vx+=t-(null==o.px?t:o.px)),o.hasMove=!0,o.px=t}function s(e){o.last||(o.last=e);var t=Math.min(.05,(e-o.last)/1e3)||0;o.last=e,c();var i=0;o.hasMove&&null!=o.px&&(i=l(o.px));var a=1-Math.exp(-L*t);o.x+=a*(i-o.x);if(o.hasMove&&null!=o.px){o.vx*=.94,Math.abs(o.vx)<.02&&(o.vx=0);var s=-o.vx/V;s>M?s=M:s<-M&&(s=-M),o.sq+=S*(s-o.sq)}else o.vx*=.9,o.sq+=S*(0-o.sq);var f=H.base+o.sq;f<H.min?f=H.min:f>H.max&&(f=H.max);var d=Math.abs(o.sq),p=1;if(d>EPS){var v=Math.min(1,d/SR);o.wP+=WF*t,p=1+WS*v*Math.sin(o.wP)}else o.wP=0;var h=f*p;n.style.transform="translate3d("+o.x+"px,0,0) scale("+h+")",o.raf=requestAnimationFrame(s)}c(),o.raf=requestAnimationFrame(s),addEventListener("pointermove",a,{passive:!0}),addEventListener("resize",c,{passive:!0}),t.__hsDestroy=function(){try{removeEventListener("pointermove",a)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
