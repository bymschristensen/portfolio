	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(e){if(!window.gsap)return;e=e||document;var t=e.querySelector('[data-barba="container"][data-barba-namespace="archive"]')||e.querySelector('[data-barba="container"]')||e,r=null,n=0,o=0,i=45;function a(){try{r&&r.disconnect&&r.disconnect()}catch(e){}r=null}t.__almCleanup&&function(){try{t.__almCleanup()}catch(e){}}(),t.__almCleanup=a;function c(e){if(!e)return!1;try{if(e.style&&"none"===e.style.display)return!1;var t=getComputedStyle(e);return!(t&&("none"===t.display||"hidden"===t.visibility))}catch(e){return!0}}function l(e){return[].slice.call((e||t).querySelectorAll(".archive-playful-item,.archive-minimal-item"))}function u(e){n++,e.forEach(function(e){if(!c(e))return;e.__almRun=n,e.__almDone=0,gsap.killTweensOf(e),gsap.set(e,{y:100,autoAlpha:0,filter:"blur(12px)",willChange:"transform,opacity,filter"});var t=e.classList.contains("archive-minimal-item")?(e.querySelector(".archive-minimal-item-visual")||e.querySelector(".archive-minimal-visual")||e.querySelector(".archive-minimal-visual-wrap")):null;t&&(gsap.killTweensOf(t),gsap.set(t,{autoAlpha:0,filter:"blur(12px)",willChange:"opacity,filter"}))})}function f(e,t){if(!e||!c(e)||e.__almDone||e.__almRun!==n)return;e.__almDone=1,gsap.to(e,{delay:t||0,y:0,autoAlpha:1,filter:"blur(0px)",duration:.75,ease:"power3.out",overwrite:!0,clearProps:"y,filter,willChange"});var r=e.classList.contains("archive-minimal-item")?(e.querySelector(".archive-minimal-item-visual")||e.querySelector(".archive-minimal-visual")||e.querySelector(".archive-minimal-visual-wrap")):null;r&&gsap.to(r,{delay:(t||0)+.06,autoAlpha:1,filter:"blur(0px)",duration:.6,ease:"power2.out",overwrite:!0,clearProps:"filter,willChange"})}function d(e){e.sort(function(e,t){return e.getBoundingClientRect().top-t.getBoundingClientRect().top}),e.forEach(function(e,t){f(e,.08*t)})}function s(e){a(),r=new IntersectionObserver(function(e){var t=[];e.forEach(function(e){e.isIntersecting&&t.push(e.target)}),t.length&&d(t)},{threshold:.12,rootMargin:"0px 0px -10% 0px"}),e.forEach(function(e){try{r.observe(e)}catch(e){}}),requestAnimationFrame(function(){var t=e.filter(function(e){if(!c(e)||e.__almDone||e.__almRun!==n)return!1;var t=e.getBoundingClientRect();return t.top<(innerHeight||0)&&t.bottom>0});t.length&&d(t)})}function m(e){var t=l(e);t.length? (u(t),s(t)) : o++<i&&requestAnimationFrame(function(){m(e)})}m(t),window.__archiveListMotion=window.__archiveListMotion||{},window.__archiveListMotion.resetAndRun=function(e){try{a()}catch(e){}o=0,m(e||t)},window.__archiveListMotion.destroy=function(){try{a()}catch(e){}try{t.__almCleanup=null}catch(e){}}}
			}),
			feature({
