...
// Entry Animation Controller
	window.EntryGate=function(){const a="data-entry-gated";function t(e){return e&&(e.__gateTarget||(e.__gateTarget=e.closest&&e.closest(".page-wrapper")||e),e.__gateTarget)}function r(e){const n=t(e)||e;if(!n)return;try{n.removeAttribute(a)}catch{}try{n.style.visibility="visible"}catch{}try{gsap&&gsap.set?gsap.set(n,{autoAlpha:1,clearProps:"opacity,visibility"}):n.style.opacity="1"}catch{try{n.style.opacity="1"}catch{}}}return{arm:function(e){const n=t(e)||e;if(!n)return;if("1"!==n.getAttribute(a)){try{n.setAttribute(a,"1")}catch{}try{n.style.visibility="hidden"}catch{}try{gsap&&gsap.set?gsap.set(n,{autoAlpha:0}):n.style.opacity="0"}catch{try{n.style.opacity="0"}catch{}}}},release:r,clear:function(){document.querySelectorAll("["+a+'="1"]').forEach(r)}}}();
...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		EntryAnimations.capabilities=function(e,t){e=e||document,t=t||{};var n=!!t.delayHero,o=gsap.timeline(),r=e.querySelector(".showreel-headline"),a=e.querySelector(".showreel-container");if(!r&&!a)return o;r&&gsap.set(r,{autoAlpha:0,visibility:"visible"});a&&(gsap.set(a,{autoAlpha:1,visibility:"visible"}),gsap.set(a,{overflow:"hidden"}),gsap.set(a,{clipPath:"polygon(100% 100%,100% 100%,100% 100%,100% 100%)",willChange:"clip-path"}));o.addLabel("hero",n?0.2:0);r&&o.set(r,{autoAlpha:1},"hero").call(function(){var e=window.CoreUtilities&&CoreUtilities.Fonts&&CoreUtilities.Fonts.ready?CoreUtilities.Fonts.ready():Promise.resolve();e.then(function(){try{if(window.SplitText&&window.splitAndMask&&window.animateLines&&window.safelyRevertSplit){var e=splitAndMask(r);animateLines(e.lines).eventCallback("onComplete",function(){safelyRevertSplit(e,r)})}else gsap.to(r,{autoAlpha:1,duration:.01})}catch(t){gsap.to(r,{autoAlpha:1,duration:.01})}})},null,"hero");a&&o.to(a,{clipPath:"polygon(0% 0%,100% 0%,100% 100%,0% 100%)",duration:1.05,ease:"power3.inOut",clearProps:"willChange"},"hero+=0.45");return o};
		...
		function runPageEntryAnimations(e){const{delayHero:t,entryOffset:r}=getEntryConfig(e),a=gsap.timeline(),n=(e.dataset&&e.dataset.barbaNamespace)||"";return"info"===n&&a.add(EntryAnimations.info(e),0),("capabilities"===n||e.querySelector(".showreel-headline")||e.querySelector(".showreel-container"))&&a.add(EntryAnimations.capabilities(e,{delayHero:t}),0),e.querySelector(".selected-item-outer")&&a.add(EntryAnimations.selected(e),0),(e.querySelector(".cs-hero-image")||e.querySelector(".cs-headline"))&&a.add(EntryAnimations.caseStudy(e),0),{tl:a,entryOffset:r}}
	...
	(function () {
		function waitFor(t,n,o){var r=0,e=o||160;!function o(){try{if(t())return void n()}catch(t){}r++<e?setTimeout(o,25):console.warn("[BOOT] deps not ready")}()}
	  	function boot() {
		    ...
		    function fallback(){if(!window.__ENTRY_FALLBACK_RAN){window.__ENTRY_FALLBACK_RAN=1;try{var r=document.querySelector('[data-barba="container"]')||document.body;EntryOrchestrator&&EntryOrchestrator.runEntryFlow&&r?EntryOrchestrator.runEntryFlow(r,{withCoverOut:!1}):console.warn("[BOOT] runEntryFlow missing")}catch(r){console.warn("[BOOT] fallback entry failed",r);try{EntryGate&&EntryGate.clear&&EntryGate.clear()}catch(r){}}}}
