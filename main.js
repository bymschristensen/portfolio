	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(e){e=e||document;var t="archiveView",i=matchMedia("(min-width: 1024px)"),a=e.querySelector(".section-archive-playful"),l=e.querySelector(".section-archive-minimal"),r=e.querySelector(".archive-switch-block"),s=e.querySelector(".archive-switch"),n=e.querySelector(".archive-switch-dot");if(!a||!l||e.__archiveViewBound)return;e.__archiveViewBound=1;var c=[r,s].filter(Boolean),o=0,d=0,u=null;function m(){try{window.gsap&&gsap.set&&gsap.set([a,l],{display:"none"})}catch(_){}a.style.display="none",l.style.display="none"}function f(){try{var e=localStorage.getItem(t);return"playful"===e||"minimal"===e?e:null}catch(_){}return null}function p(e){var t="playful"===e;r&&(r.dataset.view=e,r.setAttribute("aria-pressed",String(t)),r.classList.toggle("is-playful",t),r.classList.toggle("is-minimal",!t)),s&&(s.dataset.view=e,s.classList.toggle("is-playful",t),s.classList.toggle("is-minimal",!t)),n&&(n.dataset.view=e,n.classList.toggle("is-playful",t),n.classList.toggle("is-minimal",!t))}function g(e){try{document.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:e}}))}catch(_){}}function h(){return i.matches?f()||"playful":"minimal"}function v(e){m();var t="playful"===e?a:l;t.style.display="block";try{window.gsap&&gsap.set&&gsap.set(t,{autoAlpha:1,filter:"none",clearProps:"opacity,visibility"})}catch(_){}p(e),g(e);try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}}function y(e){if(!window.gsap||d)return;d=1;var t="playful"===e?a:l,i=[].slice.call(t.querySelectorAll("playful"===e?".archive-playful-item":".archive-minimal-item")||[]);if(!i.length)return;try{i.forEach(function(e){e.__almDone=1,gsap.killTweensOf(e),gsap.set(e,{y:18,autoAlpha:0,filter:"blur(10px)",willChange:"transform,opacity,filter"})})}catch(_){}gsap.timeline({defaults:{ease:"power3.out"}}).to(i,{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"y,filter,willChange"},0).add(function(){try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}g(e)})}function b(e){if(!window.gsap)return v(e),void function(e){try{localStorage.setItem(t,e)}catch(_){}}(e);var n=(r&&r.dataset.view)||(s&&s.dataset.view)||("none"!==a.style.display?"playful":"minimal");if(n===e)return;var c="playful"===n?a:l,o="playful"===e?a:l;p(e);try{localStorage.setItem(t,e)}catch(_){}gsap.killTweensOf([c,o]),m(),c.style.display="block",o.style.display="none";var d=[].slice.call(o.querySelectorAll("playful"===e?".archive-playful-item":".archive-minimal-item")||[]);d.forEach(function(e){e.__almDone=1,gsap.killTweensOf(e),gsap.set(e,{y:18,autoAlpha:0,filter:"blur(10px)",willChange:"transform,opacity,filter"})});gsap.timeline({defaults:{ease:"power2.out"}}).set(c,{display:"block",autoAlpha:1,filter:"none"},0).to(c,{autoAlpha:0,filter:"blur(10px)",duration:.22,overwrite:!0},0).add(function(){c.style.display="none",o.style.display="block",gsap.set(o,{autoAlpha:1,filter:"none"})}).to(d,{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"y,filter,willChange"},"-=0.02").add(function(){try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}g(e)})}function w(e){e&&e.preventDefault&&e.preventDefault();if(i.matches){var t=("playful"===(r&&r.dataset.view||s&&s.dataset.view||("none"!==a.style.display?"playful":"minimal"))?"minimal":"playful");b(t)}else v("minimal")}function k(){v(h())}function S(){if(o)return;o=1;var e=h();v(e);if(window.gsap)y(e);else{var t=0;u=setInterval(function(){if(window.gsap){try{clearInterval(u)}catch(_){}u=null,y(e)}else t+=50,t>=2000&&(try{clearInterval(u)}catch(_){}u=null)},50)}}m(),S(),c.forEach(function(e){e&&e.addEventListener("click",w,{passive:!1})}),i.addEventListener?i.addEventListener("change",k):i.addListener(k),e.__archiveViewDestroy=function(){try{u&&(clearInterval(u),u=null)}catch(_){}try{i.removeEventListener?i.removeEventListener("change",k):i.removeListener(k)}catch(_){}c.forEach(function(e){try{e&&e.removeEventListener("click",w)}catch(_){}}),e.__archiveViewBound=0,e.__archiveViewDestroy=null}}
			}),
			feature({
				...
				init: function(e){if(!window.gsap)return;e=e||document;var t=e.querySelector('[data-barba="container"]')||e;if(t.__almCleanup)try{t.__almCleanup()}catch(_){}var i=[].slice.call(t.querySelectorAll(".archive-playful-item,.archive-minimal-item"));if(!i.length)return;var r=new IntersectionObserver(function(e){e.forEach(function(e){var i=e.target;if(!e.isIntersecting||i.__almDone||"none"===i.style.display)return;i.__almDone=1;var r=i.classList.contains("archive-minimal-item")?i.querySelector(".archive-minimal-item-visual"):null;r&&!r.__almVisDone&&(r.__almVisDone=1,gsap.fromTo(r,{autoAlpha:0,filter:"blur(10px)"},{autoAlpha:1,filter:"blur(0px)",delay:.35,duration:1,ease:"sine.out",overwrite:!0,clearProps:"filter,willChange"})),gsap.fromTo(i,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.55,ease:"power3.out",overwrite:!0,clearProps:"y,filter,willChange"})})},{root:null,threshold:.15});i.forEach(function(e){r.observe(e)}),t.__almCleanup=function(){try{r.disconnect()}catch(_){}t.__almCleanup=null}}
			}),
			feature({
