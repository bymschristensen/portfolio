...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({id:"archiveController",stage:"main",namespaces:["archive"],selectors:[".section-archive-playful",".section-archive-minimal",".archive-playful-list",".archive-minimal-list",".archive-switch-block",".filters-tab",".modal-filters-item"],init:function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveControllerBound)return;e.__archiveControllerBound=1;var t=[].slice.call(e.querySelectorAll(".filters-tab")),n=[].slice.call(e.querySelectorAll(".modal-filters-item")),a=t.concat(n),i=e.querySelector(".archive-switch-block");if(!a.length&&!i)return;function o(r){return(r||"").toString().trim().toLowerCase()}function l(r){var e=r&&r.getAttribute&&((r.getAttribute("data-filter")||r.getAttribute("data-category")||r.getAttribute("data-archive-filter")||r.getAttribute("data-value"))||"");return o(e||r.textContent)}function s(r,e){if(!e||"all"===e)return!0;for(var t=r.querySelectorAll(".cms-categories,.list-categories,.archive-categories,[data-category],[data-cms-category]"),n="",a=0;a<t.length;a++)n+=" "+(t[a].textContent||"");return o(n).indexOf(e)>-1}var getState=function(){var r=e.querySelector(".section-archive-playful")||null,t=e.querySelector(".section-archive-minimal")||null,n=(r&&r.querySelector(".list-archive"))||e.querySelector(".list-archive.is-playful")||e.querySelector('[data-archive-list="playful"]')||e.querySelector(".archive-playful-list")||null,a=(t&&t.querySelector(".list-archive"))||e.querySelector(".list-archive.is-minimal")||e.querySelector('[data-archive-list="minimal"]')||e.querySelector(".archive-minimal-list")||null,i=null;return r&&r.style.display!=="none"&&!r.classList.contains("is-hidden")?i=n:t&&t.style.display!=="none"&&!t.classList.contains("is-hidden")?i=a:i=n||a,{playfulWrap:r,minimalWrap:t,playfulList:n,minimalList:a,activeList:i}};function isVisible(r){if(!r)return!1;var e=window.getComputedStyle(r);return"none"!==e.display&&"hidden"!==e.visibility&&r.getClientRects&&r.getClientRects().length>0}function getVisibleItems(r){if(!r)return[];for(var e=[].slice.call(r.querySelectorAll(".list-item-archive-project")),t=[],n=0;n<e.length;n++)isVisible(e[n])&&"none"!==e[n].style.display&&t.push(e[n]);return t}function applyFilter(r){var e=getState().activeList;if(!e)return;for(var t=[].slice.call(e.querySelectorAll(".list-item-archive-project")),n=0;n<t.length;n++){var a=t[n],i=s(a,r);a.style.display=i?"":"none",a.setAttribute("aria-hidden",i?"false":"true")}try{window.dispatchEvent(new CustomEvent("archive:filterChanged",{detail:{key:r}}))}catch(r){}}function setActiveEl(r){for(var e=0;e<a.length;e++)a[e].classList.remove("is-active");r&&r.classList&&r.classList.add("is-active")}function getActiveKey(){var r=e.querySelector(".filters-tab.is-active")||e.querySelector(".modal-filters-item.is-active")||a[0];return r?l(r)||"all":"all"}function syncActiveKey(r){for(var e=0;e<a.length;e++){var t=a[e],n=l(t)||"all";n===(r||"all")?t.classList.add("is-active"):t.classList.remove("is-active")}}function setView(r){var e=getState(),t=e.playfulWrap,n=e.minimalWrap,a=e.playfulList,i=e.minimalList;if(!t&&!n&&!a&&!i)return;var o="playful"===r,l=o?t:n,s=o?n:t,c=o?a:i,u=o?i:a;l&&(l.classList.remove("is-hidden"),l.style.display="",l.setAttribute("aria-hidden","false"));c&&(c.classList.remove("is-hidden"),c.style.display="",c.setAttribute("aria-hidden","false"));s&&(s.classList.add("is-hidden"),s.style.display="none",s.setAttribute("aria-hidden","true"));u&&(u.classList.add("is-hidden"),u.style.display="none",u.setAttribute("aria-hidden","true"));try{window.dispatchEvent(new CustomEvent("archive:viewChanged",{detail:{view:r}}))}catch(r){}}applyFilter(getActiveKey());syncActiveKey(getActiveKey());for(var c=0;c<a.length;c++)!function(r){r.addEventListener("click",function(e){e.preventDefault();var t=l(r)||"all";syncActiveKey(t),setActiveEl(r),applyFilter(t)},{passive:!1})}(a[c]);i&&i.addEventListener("click",function(r){r.preventDefault();var e=getState(),t=e.playfulWrap,n=e.minimalWrap,a=e.playfulList,i=e.minimalList;if(!t&&!n&&!a&&!i)return;var o=t&&t.style.display!=="none"&&!t.classList.contains("is-hidden")?"playful":n&&n.style.display!=="none"&&!n.classList.contains("is-hidden")?"minimal":a&&a.style.display!=="none"&&!a.classList.contains("is-hidden")?"playful":"minimal",l="playful"===o?"minimal":"playful",s="playful"===o?a:i,c="playful"===o?i:a,u=getVisibleItems(s),d=getVisibleItems(c);gsap.killTweensOf([s,c].concat(u,d));var f=gsap.timeline({defaults:{overwrite:!0}}),v=.18;f.to(s,{autoAlpha:0,duration:v,ease:"power2.out"},0).add(function(){setView(l)},v*.85).set(c,{autoAlpha:1},v*.85+.01).set(d,{autoAlpha:0,y:90,filter:"blur(10px)"},v*.85+.01).to(d,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.55,ease:"power3.out",stagger:{each:.06,from:"start"}},v*.85+.02).add(function(){var r=getActiveKey();syncActiveKey(r),applyFilter(r)},v*.85+.03)},{passive:!1})}}),
			feature({id:"archiveListMotion",stage:"main",namespaces:["archive"],selectors:[".archive-playful-list",".archive-minimal-list",".section-archive-playful",".section-archive-minimal"],init:function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveListMotionBound)return;e.__archiveListMotionBound=1;var t=null;function n(r){if(!r)return!1;var e=window.getComputedStyle(r);return"none"!==e.display&&"hidden"!==e.visibility&&r.getClientRects&&r.getClientRects().length>0}function a(){var r=e.querySelector(".section-archive-playful"),t=e.querySelector(".section-archive-minimal"),a=r&&(n(r)||!r.classList.contains("is-hidden")),i=t&&(n(t)||!t.classList.contains("is-hidden")),o=e.querySelector(".archive-playful-list")||e.querySelector(".list-archive.is-playful")||e.querySelector('[data-archive-list="playful"]'),l=e.querySelector(".archive-minimal-list")||e.querySelector(".list-archive.is-minimal")||e.querySelector('[data-archive-list="minimal"]');return a?o:i?l:o&&!o.classList.contains("is-hidden")?o:l&&!l.classList.contains("is-hidden")?l:o||l}function i(r){if(!r)return[];for(var e=[].slice.call(r.querySelectorAll(".archive-playful-item,.archive-minimal-item")),t=[],a=0;a<e.length;a++)n(e[a])&&"none"!==e[a].style.display&&t.push(e[a]);return t}function o(){var r=a();if(!r)return;var e=i(r);t&&t.kill&&t.kill(),gsap.killTweensOf([r].concat(e)),t=gsap.timeline({defaults:{overwrite:!0}});var n=Math.min(.22,.1+.02*e.length);t.to(r,{autoAlpha:0,duration:n,ease:"power2.out"},0).set(r,{autoAlpha:1},n+.01).set(e,{autoAlpha:0,y:90,filter:"blur(10px)"},n+.01).to(e,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.55,ease:"power3.out",stagger:{each:.06,from:"start"}},n+.02)}try{o()}catch(r){}window.addEventListener("archive:filterChanged",o);window.addEventListener("archive:viewChanged",o)}})
		);
