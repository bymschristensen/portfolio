...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1;var i=CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9"),o={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0,wbA:0,wbP:0},L=2.2,M=.30,V=1.3e3,S=.16,H={base:.88,min:.80,max:1},B_T=0.02,B_G=1.1,B_F=18,B_S=4;function c(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0,o.tw=t.width||r.offsetWidth||0,o.left=t.left,o.right=t.right,o.baseC=e.left+e.width/2-o.x,i||(n.style.height=o.w*9/16+"px")}function l(e,t,r){return e<t?t:e>r?r:e}function a(e){var t=l(e,o.left,o.right),i=t+o.w/2,c=o.left+o.w/2,s=o.right-o.w/2;c>s&&(c=s=(o.left+o.right)/2);var f=l(i,c,s);return f-o.baseC}function u(e){var t=e.clientX;o.hasMove&&(o.vx+=t-(null==o.px?t:o.px)),o.hasMove=!0,o.px=t}function f(e){o.last||(o.last=e);if(!o.hasMove||null==o.px)return o.last=e,void(o.raf=requestAnimationFrame(f));var t=Math.min(.05,(e-o.last)/1e3);o.last=e;c();var i=a(o.px),r=1-Math.exp(-L*t);o.x+=r*(i-o.x),o.vx*=.94,Math.abs(o.vx)<.02&&(o.vx=0);var s=0;o.vx&&(s=-o.vx/V,s>M?s=M:s<-M&&(s=-M));o.sq+=S*(s-o.sq);var p=Math.max(0,Math.abs(o.sq)-B_T)*B_G;o.wbA+=B_S*t*(p-o.wbA),o.wbP+=B_F*t;var d=o.wbA*Math.sin(o.wbP),v=H.base+o.sq+d;v<H.min&&(v=H.min),v>H.max&&(v=H.max),n.style.transform="translate3d("+o.x+"px,0,0) scale("+v+")",o.raf=requestAnimationFrame(f)}c(),addEventListener("pointermove",u,{passive:!0}),addEventListener("resize",c,{passive:!0}),o.raf=requestAnimationFrame(f),t.__hsDestroy=function(){try{removeEventListener("pointermove",u)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
