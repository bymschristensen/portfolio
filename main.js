...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({id:"archiveController",stage:"main",namespaces:["archive"],selectors:[".section-archive-playful",".section-archive-minimal",".archive-playful-list",".archive-minimal-list",".archive-switch-block",".filters-tab",".modal-filters-item"],init:function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveControllerBound)return;e.__archiveControllerBound=1;var t=[].slice.call(e.querySelectorAll(".filters-tab")),n=[].slice.call(e.querySelectorAll(".modal-filters-item")),a=t.concat(n),i=e.querySelector(".archive-switch-block");if(!a.length&&!i)return;function o(r){return(r||"").toString().trim().toLowerCase()}function l(r){var e=r&&r.getAttribute&&((r.getAttribute("data-filter")||r.getAttribute("data-category")||r.getAttribute("data-archive-filter")||r.getAttribute("data-value"))||"");return o(e||r.textContent)}var getState=function(){var r=e.querySelector(".section-archive-playful")||null,t=e.querySelector(".section-archive-minimal")||null,n=(r&&r.querySelector(".list-archive"))||e.querySelector('.list-archive.is-playful')||e.querySelector('[data-archive-list="playful"]')||e.querySelector(".archive-playful-list")||null,a=(t&&t.querySelector(".list-archive"))||e.querySelector('.list-archive.is-minimal')||e.querySelector('[data-archive-list="minimal"]')||e.querySelector(".archive-minimal-list")||null,i=null;return r&&r.style.display!=="none"&&!r.classList.contains("is-hidden")?i=n:t&&t.style.display!=="none"&&!t.classList.contains("is-hidden")?i=a:i=n||a,{playfulWrap:r,minimalWrap:t,playfulList:n,minimalList:a,activeList:i}};function s(r,e){if(!e||"all"===e)return!0;for(var t=r.querySelectorAll(".cms-categories,.list-categories,.archive-categories,[data-category],[data-cms-category]"),n="",a=0;a<t.length;a++)n+=" "+(t[a].textContent||"");return o(n).indexOf(e)>-1}function c(r){var e=getState().activeList;if(!e)return;for(var t=[].slice.call(e.querySelectorAll(".list-item-archive-project")),n=0;n<t.length;n++){var a=t[n],i=s(a,r);a.style.display=i?"":"none",a.setAttribute("aria-hidden",i?"false":"true")}try{window.dispatchEvent(new CustomEvent("archive:filterChanged",{detail:{key:r}}))}catch(r){}}function u(r){for(var e=0;e<a.length;e++)a[e].classList.remove("is-active");r&&r.classList&&r.classList.add("is-active")}function d(){var r=e.querySelector(".filters-tab.is-active")||e.querySelector(".modal-filters-item.is-active")||a[0];return r?l(r)||"all":"all"}function f(r){for(var e=0;e<a.length;e++){var t=a[e],n=l(t)||"all";n===(r||"all")?t.classList.add("is-active"):t.classList.remove("is-active")}}function v(r){var e=getState(),t=e.playfulWrap,n=e.minimalWrap,a=e.playfulList,i=e.minimalList;if(!t&&!n&&!a&&!i)return;var o="playful"===r,l=o?t:n,s=o?n:t,c=o?a:i,u=o?i:a;l&&(l.classList.remove("is-hidden"),l.style.display="",l.setAttribute("aria-hidden","false"));c&&(c.classList.remove("is-hidden"),c.style.display="",c.setAttribute("aria-hidden","false"));s&&(s.classList.add("is-hidden"),s.style.display="none",s.setAttribute("aria-hidden","true"));u&&(u.classList.add("is-hidden"),u.style.display="none",u.setAttribute("aria-hidden","true"));try{window.dispatchEvent(new CustomEvent("archive:viewChanged",{detail:{view:r}}))}catch(r){}}c(d());f(d());for(var m=0;m<a.length;m++)!function(r){r.addEventListener("click",function(e){e.preventDefault();var t=l(r)||"all";f(t),u(r),c(t)},{passive:!1})}(a[m]);i&&i.addEventListener("click",function(r){r.preventDefault();var e=getState(),t=e.playfulWrap,n=e.minimalWrap,a=e.playfulList,i=e.minimalList;if(!t&&!n&&!a&&!i)return;var o=t&&t.style.display!=="none"&&!t.classList.contains("is-hidden")?"playful":n&&n.style.display!=="none"&&!n.classList.contains("is-hidden")?"minimal":a&&a.style.display!=="none"&&!a.classList.contains("is-hidden")?"playful":"minimal";v("playful"===o?"minimal":"playful");var l=d();f(l),c(l)},{passive:!1})}}),
