	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				//init: function(e){e=e||document;var t="archiveView",i=matchMedia("(min-width: 1024px)"),a=e.querySelector(".section-archive-playful"),l=e.querySelector(".section-archive-minimal"),r=e.querySelector(".archive-switch-block"),s=e.querySelector(".archive-switch"),n=e.querySelector(".archive-switch-dot");if(!a||!l||e.__archiveViewBound)return;e.__archiveViewBound=1;var c=[r,s].filter(Boolean);function o(){try{window.gsap&&gsap.set&&gsap.set([a,l],{display:"none"})}catch(e){}a.style.display="none",l.style.display="none"}function d(){try{var e=localStorage.getItem(t);return"playful"===e||"minimal"===e?e:null}catch(e){}return null}function u(e){var t="playful"===e;r&&(r.dataset.view=e,r.setAttribute("aria-pressed",String(t)),r.classList.toggle("is-playful",t),r.classList.toggle("is-minimal",!t)),s&&(s.dataset.view=e,s.classList.toggle("is-playful",t),s.classList.toggle("is-minimal",!t)),n&&(n.dataset.view=e,n.classList.toggle("is-playful",t),n.classList.toggle("is-minimal",!t))}function m(e){if(!window.gsap)return[];var t=[].slice.call(("playful"===e?a:l).querySelectorAll("playful"===e?".archive-playful-item":".archive-minimal-item")||[]);return t.forEach(function(e){e.__almDone=1,gsap.killTweensOf(e),gsap.set(e,{y:18,autoAlpha:0,filter:"blur(10px)",willChange:"transform,opacity,filter"})}),t}function f(e){try{e.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:e}}))}catch(e){}}function p(){return i.matches?d()||"playful":"minimal"}function g(e){o();var t="playful"===e?a:l;t.style.display="block";try{window.gsap&&gsap.set&&gsap.set(t,{autoAlpha:1,filter:"none",clearProps:"opacity,visibility"})}catch(e){}u(e),f(e);try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(e){}}function h(e){if(!window.gsap)return g(e),void function(e){try{localStorage.setItem(t,e)}catch(e){}}(e);var s=r&&r.dataset.view||s&&s.dataset.view||("none"!==a.style.display?"playful":"minimal");if(s===e)return;var n="playful"===s?a:l,c="playful"===e?a:l;u(e);try{localStorage.setItem(t,e)}catch(e){}gsap.killTweensOf([n,c]),o(),n.style.display="block",c.style.display="none";var d=m(e);gsap.timeline({defaults:{ease:"power2.out"}}).set(n,{display:"block",autoAlpha:1,filter:"none"},0).to(n,{autoAlpha:0,filter:"blur(10px)",duration:.22,overwrite:!0},0).add(function(){n.style.display="none",c.style.display="block",gsap.set(c,{autoAlpha:1,filter:"none"})}).to(d,{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"y,filter,willChange"},"-=0.02").add(function(){try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(e){}f(e)})}o(),g(p());function v(e){e&&e.preventDefault&&e.preventDefault(),i.matches?h(("playful"===(r&&r.dataset.view||s&&s.dataset.view||("none"!==a.style.display?"playful":"minimal"))?"minimal":"playful")):g("minimal")}c.forEach(function(e){e&&e.addEventListener("click",v,{passive:!1})});function y(){g(p())}i.addEventListener?i.addEventListener("change",y):i.addListener(y),e.__archiveViewDestroy=function(){try{i.removeEventListener?i.removeEventListener("change",y):i.removeListener(y)}catch(e){}c.forEach(function(e){try{e&&e.removeEventListener("click",v)}catch(e){}}),e.__archiveViewBound=0,e.__archiveViewDestroy=null}}
			...
			feature({
				...
				init: function(root){if(!window.gsap)return;root=root||document;var c=root.querySelector('[data-barba="container"]')||root;if(c.__alm2Cleanup)try{c.__alm2Cleanup()}catch(e){}var r=matchMedia("(prefers-reduced-motion: reduce)").matches,i=".archive-playful-item, .archive-minimal-item",v=".archive-minimal-item-visual",io=null,mo=null,raf=0,alive=1;function shown(el){if(!el||!c.contains(el))return!1;try{if(getComputedStyle(el).display==="none")return!1;var s=el.closest(".section-archive-playful, .section-archive-minimal");if(s&&getComputedStyle(s).display==="none")return!1}catch(e){}return!0}function prep(it){if(!it||it.__almPrep||r)return;it.__almPrep=1,gsap.killTweensOf(it),gsap.set(it,{y:18,autoAlpha:0,filter:"blur(10px)",willChange:"transform,opacity,filter"});if(it.classList.contains("archive-minimal-item")){var m=it.querySelector(v);m&&(gsap.killTweensOf(m),gsap.set(m,{autoAlpha:0,filter:"blur(10px)",willChange:"opacity,filter"}))}}function reveal(it){if(!alive||!it||it.__almDone||!shown(it))return;it.__almDone=1;if(it.classList.contains("archive-minimal-item")){var m=it.querySelector(v);m&&!m.__almVisDone&&(m.__almVisDone=1,gsap.fromTo(m,{autoAlpha:0,filter:"blur(10px)"},{autoAlpha:1,filter:"blur(0px)",delay:.2,duration:.8,ease:"sine.out",overwrite:!0,clearProps:"filter,willChange"}))}gsap.fromTo(it,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,ease:"power3.out",overwrite:!0,clearProps:"y,filter,willChange"})}function buildIO(){io&&function(){try{io.disconnect()}catch(e){}}();io=new IntersectionObserver(function(ents){for(var k=0;k<ents.length;k++){var ent=ents[k];if(!ent.isIntersecting)continue;var it=ent.target;io.unobserve(it),reveal(it)}},{threshold:.15,root:null,rootMargin:"0px 0px -10% 0px"})}function scan(){if(!alive)return;var items=[].slice.call(c.querySelectorAll(i));for(var k=0;k<items.length;k++){var it=items[k];prep(it),it.__almObs||(!io&&buildIO(),it.__almObs=1,io.observe(it))}}function scheduleScan(){alive&&(raf||(raf=requestAnimationFrame(function(){raf=0,scan()})))}buildIO(),scan();mo=new MutationObserver(scheduleScan);try{mo.observe(c,{childList:!0,subtree:!0})}catch(e){}c.__alm2Cleanup=function(){alive=0,raf&&(cancelAnimationFrame(raf),raf=0),io&&function(){try{io.disconnect()}catch(e){}}(),mo&&function(){try{mo.disconnect()}catch(e){}}();try{var items=[].slice.call(c.querySelectorAll(i));for(var k=0;k<items.length;k++){var it=items[k];delete it.__almPrep,delete it.__almDone,delete it.__almObs;if(it.classList.contains("archive-minimal-item")){var m=it.querySelector(v);m&&(delete m.__almVisDone)}}}catch(e){}delete c.__alm2Cleanup}}
			}),
			feature({
