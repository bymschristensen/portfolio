...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({id:"productPinnedSections",stage:"main",namespaces:["capabilities"],selectors:[".section-single-service"],init:function(root){if(!gsap||!ScrollTrigger)return;root=root||document;var sections=[].slice.call(root.querySelectorAll(".section-single-service"));if(!sections.length)return;sections.forEach(function(sec){gsap.set(sec,{filter:"contrast(100%) blur(0px)"});gsap.timeline({scrollTrigger:{trigger:sec,start:"top top+=80",end:"bottom top",pin:!0,pinSpacing:!0,scrub:!1,invalidateOnRefresh:!0}}).to(sec,{filter:"contrast(80%) blur(2px)",duration:.4,ease:"power2.out"}).to(sec,{filter:"contrast(100%) blur(0px)",duration:.3,ease:"power2.in"})})}}),
			feature({
				id: "productGallery",
				stage: "main",
				namespaces: ["capabilities"],
