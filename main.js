...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			feature({
				id: "capabilitiesHeroShowreel",
				stage: "main",
				namespaces: ["capabilities"],
				selectors: [".hero-section-showreel .showreel-container"],
				init: async e=>{const t=e.querySelector(".hero-section-showreel"),o=t&&t.querySelector(".showreel-outer"),r=t&&t.querySelector(".showreel-outer .container"),n=t&&t.querySelector(".showreel-container"),i=t&&t.querySelector(".showreel-headline"),c=t&&t.querySelector(".showreel-subtext"),l=t&&t.querySelector(".toc-outer"),s=[i,c,l].filter(Boolean);if(!t||!o||!r||!n)return;const a=e=>Math.max(0,Math.min(1,e)),u=(e,t,o)=>e+(t-e)*o;function d(e){let t=!1;const o=()=>{t=!1,e()},r=()=>{t||(t=!0,requestAnimationFrame(o))};return window.addEventListener("scroll",r,{passive:!0}),()=>window.removeEventListener("scroll",r)}let h=window.innerHeight,m=1,w=0,p=.5;function f(){const e=n.style.transform;n.style.transform="translate3d(0,0,0) scale(1)";const t=n.getBoundingClientRect().width||1,o=r.clientWidth||1;return n.style.transform=e,Math.max(1,o/t)}function y(){const e=t.getBoundingClientRect(),o=e.height-h;return o<=0?0:a((-e.top)/o)}function g(){const e=n.getBoundingClientRect().width,t=r.clientWidth;w=Math.max(0,e-t)}function S(){const e=y(),t=u(1,m,e);g();let o=0;w>1&&(o=(p-.5)*w*-1),n.style.transform=`translate3d(${o}px,0,0) scale(${t})`;const i=-.6*h,c=1-e;s.forEach((t=>{t.style.transform=`translate3d(0, ${u(0,i,e)}px, 0)`,t.style.opacity=c}))}function v(e){const t=r.getBoundingClientRect(),o=Math.max(t.left,Math.min(e.clientX,t.right));p=(o-t.left)/(t.width||1)}function x(){h=window.innerHeight,m=f(),S()}m=f();const E=d(S);r.addEventListener("mousemove",v),window.addEventListener("resize",x),S(),document.__capHero={offScroll:E,onResize:x,onMouseMove:v,container:r,media:n,copyEls:s}},destroy:async()=>{const e=document.__capHero;if(!e)return;try{e.offScroll&&e.offScroll()}catch{}try{e.container&&e.onMouseMove&&e.container.removeEventListener("mousemove",e.onMouseMove)}catch{}try{e.onResize&&window.removeEventListener("resize",e.onResize)}catch{}try{e.media&&(e.media.style.transform=""),(e.copyEls||[]).forEach((e=>{e.style.transform="",e.style.opacity=""}))}catch{}document.__capHero=null}
			}),
			feature({
