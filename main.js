...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			// Regular feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var r=e.querySelector(".hero-section-showreel");if(!r||r.__hsBound)return;var t=r.querySelector(".showreel-track"),n=r.querySelector(".showreel-container");if(!t||!n)return;r.__hsBound=1;n.style.transformOrigin="50% 50%";n.style.willChange="transform";n.style.transform="translate3d(0,0,0)";var o=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9");o&&(n.style.aspectRatio="16/9");var s={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1},a=gsap.quickSetter(n,"x","px"),L=3;function c(){var e=n.getBoundingClientRect(),r=t.getBoundingClientRect();s.w=e.width||n.offsetWidth||0;s.tw=r.width||t.offsetWidth||0;s.left=r.left;s.right=r.right;s.baseC=e.left+e.width/2-s.x;!o&&s.w&&(n.style.height=s.w*9/16+"px")}function i(e,r,t){return e<r?r:e>t?t:e}function l(e){var r=i(e,s.left,s.right),o=r+s.w/2,c=s.left+s.w/2,l=s.right-s.w/2;c>l&&(c=l=(s.left+s.right)/2);var u=i(o,c,l);return u-s.baseC}function d(e){s.hasMove=!0;s.px=e.clientX}function u(e){s.last||(s.last=e);var r=Math.min(.05,(e-s.last)/1e3);s.last=e;c();if(!s.hasMove||null==s.px){s.raf=requestAnimationFrame(u);return}var t=l(s.px),o=1-Math.exp(-L*r);s.x+=o*(t-s.x);a(s.x);s.raf=requestAnimationFrame(u)}c();addEventListener("pointermove",d,{passive:!0});addEventListener("resize",c,{passive:!0});s.raf=requestAnimationFrame(u);r.__hsDestroy=function(){try{removeEventListener("pointermove",d)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{s.raf&&cancelAnimationFrame(s.raf)}catch(e){}}},destroy:async function(e){e=e||document;var r=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{r&&r.__hsDestroy&&r.__hsDestroy()}catch(e){}}}),
			// Wobble (left/right) feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var r=e.querySelector(".hero-section-showreel");if(!r||r.__hsBound)return;var t=r.querySelector(".showreel-track"),n=r.querySelector(".showreel-container");if(!t||!n)return;r.__hsBound=1;n.style.transformOrigin="50% 50%";n.style.willChange="transform";n.style.transform="translate3d(0,0,0)";var s=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9");s&&(n.style.aspectRatio="16/9");var o={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0},a=gsap.quickSetter(n,"x","px"),c=gsap.quickSetter(n,"scaleX"),l=gsap.quickSetter(n,"scaleY"),L=3;function i(){var e=n.getBoundingClientRect(),r=t.getBoundingClientRect();o.w=e.width||n.offsetWidth||0,o.tw=r.width||t.offsetWidth||0,o.left=r.left,o.right=r.right,o.baseC=e.left+e.width/2-o.x,!s&&o.w&&(n.style.height=o.w*9/16+"px")}function d(e,r,t){return e<r?r:e>t?t:e}function u(e){var r=d(e,o.left,o.right),n=r+o.w/2,s=o.left+o.w/2,a=o.right-o.w/2;return s>a&&(s=a=(o.left+o.right)/2),d(n,s,a)-o.baseC}function f(e){var r=e.clientX;o.hasMove&&null!=o.px&&(o.vx+=r-o.px),o.hasMove=!0,o.px=r}function h(e){if(!o.hasMove||null==o.px)o.last=e;else{o.last||(o.last=e);var r=Math.min(.05,(e-o.last)/1e3);o.last=e;var t=u(o.px),n=1-Math.exp(-L*r);o.x+=n*(t-o.x)}o.vx*=.86;var s=o.vx,v=0;if(Math.abs(s)>.1){var w=-(s/900),g=.06;w>g?w=g:w<-g&&(w=-g),v=w}o.sq+=.15*(v-o.sq);var y=1+o.sq,m=1-.35*o.sq;a(o.x),c(y),l(m),o.raf=requestAnimationFrame(h)}i(),o.raf=requestAnimationFrame(h),addEventListener("pointermove",f,{passive:!0}),addEventListener("resize",i,{passive:!0}),r.__hsDestroy=function(){try{removeEventListener("pointermove",f)}catch(e){}try{removeEventListener("resize",i)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var r=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{r&&r.__hsDestroy&&r.__hsDestroy()}catch(e){}}}),
			// Wobble (all around) feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1;n.style.transformOrigin="50% 50%";n.style.willChange="transform";n.style.transform="translate3d(0,0,0)";var i=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9");i&&(n.style.aspectRatio="16/9");var o={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0},L=3,M=.06;function c(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0;o.tw=t.width||r.offsetWidth||0;o.left=t.left;o.right=t.right;o.baseC=e.left+e.width/2-o.x;i||(n.style.height=o.w*9/16+"px")}function u(e,t,r){return e<t?t:e>r?r:e}function l(e){var t=u(e,o.left,o.right),i=t+o.w/2,a=o.left+o.w/2,s=o.right-o.w/2;a>s&&(a=s=(o.left+o.right)/2);var f=u(i,a,s);return f-o.baseC}function p(e){var t=e.clientX;o.hasMove&&(o.vx+=t-(null==o.px?t:o.px));o.hasMove=!0;o.px=t}function d(e){o.last||(o.last=e);if(!o.hasMove||null==o.px){o.last=e;o.raf=requestAnimationFrame(d);return}var t=Math.min(.05,(e-o.last)/1e3);o.last=e;c();var r=l(o.px),i=1-Math.exp(-L*t);o.x+=i*(r-o.x);o.vx*=.82;Math.abs(o.vx)<.1&&(o.vx=0);var a=0;if(o.vx){a=-o.vx/2000;a>M?a=M:a<-M&&(a=-M)}o.sq+=.18*(a-o.sq);var s=1+o.sq;n.style.transform="translate3d("+o.x+"px,0,0) scale("+s+")";o.raf=requestAnimationFrame(d)}c();addEventListener("pointermove",p,{passive:!0});addEventListener("resize",c,{passive:!0});o.raf=requestAnimationFrame(d);t.__hsDestroy=function(){try{removeEventListener("pointermove",p)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1;n.style.transformOrigin="50% 50%";n.style.willChange="transform";n.style.transform="translate3d(0,0,0)";var i=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9");i&&(n.style.aspectRatio="16/9");var o={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0,sc:1,tsc:1,lock:!1},a=gsap.quickSetter(n,"x","px"),s=gsap.quickSetter(n,"scale"),L=3,F=6,M=.10,D=.25;function c(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0,o.tw=t.width||r.offsetWidth||0,o.left=t.left,o.right=t.right,o.baseC=e.left+e.width/2-o.x,i||(n.style.height=o.w*9/16+"px"),o.lock=o.w>=o.tw-1}function u(e,t,r){return e<t?t:e>r?r:e}function l(e){var t=u(e,o.left,o.right),i=t+o.w/2,a=o.left+o.w/2,s=o.right-o.w/2;a>s&&(a=s=(o.left+o.right)/2);var l=u(i,a,s);return l-o.baseC}function f(e){var t=e.clientX;o.hasMove&&(o.vx+=t-(o.px==null?t:o.px)),o.hasMove=!0,o.px=t}function d(e){if(!o.last&&(o.last=e),!o.hasMove||null==o.px)return o.last=e,void(o.raf=requestAnimationFrame(d));var t=Math.min(.05,(e-o.last)/1e3);o.last=e;c();var i=(innerWidth||document.documentElement.clientWidth||1)/2,a=o.px||i,u=l(a),f=1-Math.exp(-L*t);o.x+=f*(u-o.x);var d=1-Math.exp(-F*t);o.sc+=d*(o.tsc-o.sc);o.vx*=.82,Math.abs(o.vx)<.1&&(o.vx=0);var v=0;if(o.vx){v=-o.vx/2000,v>M&&(v=M),v<-M&&(v=-M)}o.sq+=D*(v-o.sq);var p=o.sc*(1+o.sq);a?o.px:a=i,a&&o.hasMove?(o.px=a):0;a:o.x,s(p);o.raf=requestAnimationFrame(d)}c(),addEventListener("pointermove",f,{passive:!0}),addEventListener("resize",c,{passive:!0}),o.raf=requestAnimationFrame(d),t.__hsDestroy=function(){try{removeEventListener("pointermove",f)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
