	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(e){e=e||document;var K="archiveView",mq=matchMedia("(min-width: 1024px)"),P=e.querySelector(".section-archive-playful"),M=e.querySelector(".section-archive-minimal"),B=e.querySelector(".archive-switch-block"),S=e.querySelector(".archive-switch"),D=e.querySelector(".archive-switch-dot");if(!P||!M||e.__archiveViewBound)return;e.__archiveViewBound=1;var btns=[B,S].filter(Boolean),tl=null,raf=0;function R(){if(raf)return;raf=1;requestAnimationFrame(function(){raf=0;try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}})}function hideBoth(){try{window.gsap&&gsap.set&&gsap.set([P,M],{display:"none"})}catch(_){}P.style.display="none";M.style.display="none"}function stored(){try{var v=localStorage.getItem(K);return"playful"===v||"minimal"===v?v:null}catch(_){return null}}function desired(){return mq.matches?(stored()||"playful"):"minimal"}function ui(v){var on="playful"===v;B&&(B.dataset.view=v,B.setAttribute("aria-pressed",String(on)),B.classList.toggle("is-playful",on),B.classList.toggle("is-minimal",!on));S&&(S.dataset.view=v,S.classList.toggle("is-playful",on),S.classList.toggle("is-minimal",!on));D&&(D.dataset.view=v,D.classList.toggle("is-playful",on),D.classList.toggle("is-minimal",!on))}function emit(v){try{document.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:v}}))}catch(_){}try{var f=localStorage.getItem("archiveFilter");f&&document.dispatchEvent(new CustomEvent("archive:filter",{bubbles:!0,detail:{filter:f,source:"view"}}))}catch(_){}}function collect(v){var sec="playful"===v?P:M,items=[],vis=[];if(!sec)return{sec:null,items:items,vis:vis};items=[].slice.call(sec.querySelectorAll("playful"===v?".archive-playful-item":".archive-minimal-item")||[]);for(var i=0;i<items.length;i++){var it=items[i];try{delete it.__almPrep;delete it.__almDone;delete it.__almObs}catch(_){}var ve="minimal"===v?it.querySelector(".archive-minimal-item-visual"):null;if(ve)try{delete ve.__almVisPrep;delete ve.__almVisDone}catch(_){}}vis="minimal"===v?items.map(function(it){return it.querySelector(".archive-minimal-item-visual")}).filter(Boolean):[];return{sec:sec,items:items,vis:vis}}function prep(v){if(!window.gsap)return;var c=collect(v),items=c.items,vis=c.vis;items.forEach(function(it){gsap.killTweensOf(it);gsap.set(it,{y:18,autoAlpha:0,willChange:"transform,opacity"})});vis.forEach(function(el){gsap.killTweensOf(el);gsap.set(el,{autoAlpha:0,filter:"blur(10px)",willChange:"opacity,filter"})})}function playIn(v){if(!window.gsap)return;var c=collect(v),items=c.items,vis=c.vis,t=gsap.timeline({defaults:{ease:"power3.out"}});items.length&&t.to(items,{y:0,autoAlpha:1,duration:.6,stagger:.06,overwrite:!0,clearProps:"y,willChange"},0);vis.length&&t.to(vis,{autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"filter,willChange"},0);t.add(function(){R();emit(v)});return t}function showInstant(v){hideBoth();var sec="playful"===v?P:M;sec&&(sec.style.display="block");ui(v);emit(v);try{window.gsap&&gsap.set&&gsap.set(sec,{autoAlpha:1,filter:"none",clearProps:"opacity,visibility"})}catch(_){}R()}function switchTo(v){if(!mq.matches)v="minimal";var cur=(B&&B.dataset.view)||(S&&S.dataset.view)||("none"!==P.style.display?"playful":"minimal");if(cur===v)return;try{localStorage.setItem(K,v)}catch(_){}ui(v);tl&&tl.kill&&(tl.kill(),tl=null);hideBoth();var from="playful"===cur?P:M,to="playful"===v?P:M;if(!from||!to)return showInstant(v);from.style.display="block";to.style.display="none";prep(v);tl=gsap.timeline({defaults:{ease:"power2.out"},onComplete:function(){tl=null}}).set(from,{display:"block",autoAlpha:1,filter:"none"},0).to(from,{autoAlpha:0,filter:"blur(10px)",duration:.22,overwrite:!0},0).add(function(){from.style.display="none";to.style.display="block";try{gsap.set(to,{autoAlpha:1,filter:"none"})}catch(_){}}).add(function(){playIn(v)},.06)}function onClick(ev){ev&&ev.preventDefault&&ev.preventDefault();if(!mq.matches)return showInstant("minimal");var cur=(B&&B.dataset.view)||(S&&S.dataset.view)||("none"!==P.style.display?"playful":"minimal");switchTo("playful"===cur?"minimal":"playful")}function onMQ(){var v=desired();showInstant(v);window.gsap&&(prep(v),playIn(v))}hideBoth();var v=desired();showInstant(v);window.gsap&&(prep(v),playIn(v));btns.forEach(function(b){b&&b.addEventListener("click",onClick,{passive:!1})});mq.addEventListener?mq.addEventListener("change",onMQ):mq.addListener(onMQ);e.__archiveViewDestroy=function(){try{tl&&tl.kill&&tl.kill()}catch(_){}try{mq.removeEventListener?mq.removeEventListener("change",onMQ):mq.removeListener(onMQ)}catch(_){}btns.forEach(function(b){try{b&&b.removeEventListener("click",onClick)}catch(_){}});e.__archiveViewBound=0;e.__archiveViewDestroy=null}}
			}),
			//feature({
			//	id: "archiveViewController",
			//	stage: "early",
			//	namespaces: ["archive"],
			//	selectors: [".section-archive-playful",".section-archive-minimal",".archive-switch-block",".archive-switch",".archive-switch-dot"],
			//	init: function(e){e=e||document;var K="archiveView",mq=matchMedia("(min-width: 1024px)"),P=e.querySelector(".section-archive-playful"),M=e.querySelector(".section-archive-minimal"),B=e.querySelector(".archive-switch-block"),S=e.querySelector(".archive-switch"),D=e.querySelector(".archive-switch-dot");if(!P||!M||e.__archiveViewBound)return;e.__archiveViewBound=1;var btns=[B,S].filter(Boolean),tl=null,raf=0;function R(){if(raf)return;raf=1;requestAnimationFrame(function(){raf=0;try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}})}function hideBoth(){try{window.gsap&&gsap.set&&gsap.set([P,M],{display:"none"})}catch(_){}P.style.display="none",M.style.display="none"}function stored(){try{var v=localStorage.getItem(K);return"playful"===v||"minimal"===v?v:null}catch(_){return null}}function desired(){return mq.matches?(stored()||"playful"):"minimal"}function ui(v){var on="playful"===v;B&&(B.dataset.view=v,B.setAttribute("aria-pressed",String(on)),B.classList.toggle("is-playful",on),B.classList.toggle("is-minimal",!on)),S&&(S.dataset.view=v,S.classList.toggle("is-playful",on),S.classList.toggle("is-minimal",!on)),D&&(D.dataset.view=v,D.classList.toggle("is-playful",on),D.classList.toggle("is-minimal",!on))}function emit(v){try{document.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:v}}))}catch(_){}}function collect(v){var sec="playful"===v?P:M,items=[],vis=[];if(!sec)return{sec:null,items:items,vis:vis};items=[].slice.call(sec.querySelectorAll("playful"===v?".archive-playful-item":".archive-minimal-item")||[]);items.forEach(function(it){it.__almDone=0,it.__almVisDone=0});vis=items.map(function(it){return it.querySelector("playful"===v?".archive-playful-item-visual":".archive-minimal-item-visual")}).filter(Boolean);return{sec:sec,items:items,vis:vis}}function prep(v){if(!window.gsap)return;var c=collect(v),items=c.items,vis=c.vis;items.forEach(function(it){gsap.killTweensOf(it),gsap.set(it,{y:18,autoAlpha:0,willChange:"transform,opacity"})});vis.forEach(function(el){gsap.killTweensOf(el),gsap.set(el,{autoAlpha:0,filter:"blur(10px)",willChange:"opacity,filter"})})}function playIn(v){if(!window.gsap)return;var c=collect(v),items=c.items,vis=c.vis;var t=gsap.timeline({defaults:{ease:"power3.out"}});items.length&&t.to(items,{y:0,autoAlpha:1,duration:.6,stagger:.06,overwrite:!0,clearProps:"y,willChange"},0);vis.length&&t.to(vis,{autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"filter,willChange"},0);t.add(function(){R(),emit(v)});return t}function showInstant(v){hideBoth();var sec="playful"===v?P:M;if(sec)sec.style.display="block";ui(v);emit(v);try{window.gsap&&gsap.set&&gsap.set(sec,{autoAlpha:1,filter:"none",clearProps:"opacity,visibility"})}catch(_){}R()}function switchTo(v){if(!mq.matches)v="minimal";var cur=(B&&B.dataset.view)||(S&&S.dataset.view)||(P.style.display!=="none"?"playful":"minimal");if(cur===v)return;try{localStorage.setItem(K,v)}catch(_){ }ui(v);tl&&tl.kill&&(tl.kill(),tl=null);hideBoth();var from="playful"===cur?P:M,to="playful"===v?P:M;if(!from||!to)return showInstant(v);from.style.display="block";to.style.display="none";prep(v);tl=gsap.timeline({defaults:{ease:"power2.out"},onComplete:function(){tl=null}}).set(from,{display:"block",autoAlpha:1,filter:"none"},0).to(from,{autoAlpha:0,filter:"blur(10px)",duration:.22,overwrite:!0},0).add(function(){from.style.display="none",to.style.display="block";try{gsap.set(to,{autoAlpha:1,filter:"none"})}catch(_){}}).add(function(){playIn(v)},0.06)}function onClick(ev){ev&&ev.preventDefault&&ev.preventDefault();if(!mq.matches)return showInstant("minimal");var cur=(B&&B.dataset.view)||(S&&S.dataset.view)||(P.style.display!=="none"?"playful":"minimal");switchTo("playful"===cur?"minimal":"playful")}function onMQ(){showInstant(desired());window.gsap&&prep(desired());window.gsap&&playIn(desired())}hideBoth();var v=desired();showInstant(v);if(window.gsap){prep(v);playIn(v)}btns.forEach(function(b){b&&b.addEventListener("click",onClick,{passive:!1})});mq.addEventListener?mq.addEventListener("change",onMQ):mq.addListener(onMQ);e.__archiveViewDestroy=function(){try{tl&&tl.kill&&tl.kill()}catch(_){}try{mq.removeEventListener?mq.removeEventListener("change",onMQ):mq.removeListener(onMQ)}catch(_){}btns.forEach(function(b){try{b&&b.removeEventListener("click",onClick)}catch(_){}});e.__archiveViewBound=0;e.__archiveViewDestroy=null}}
			//}),
			feature({
