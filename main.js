...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".showreel-container");if(!r||!n)return;t.__hsBound=1,n.style.transform="translate3d(0,0,0)";var i=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9"),o={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0},L=2.2,M=.14,V=2e3,S=.10,H={base:.92,min:.84,max:1};function c(){var e=n.getBoundingClientRect(),t=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0,o.tw=t.width||r.offsetWidth||0,o.left=t.left,o.right=t.right,o.baseC=e.left+e.width/2-o.x,!i&&o.w&&(n.style.height=o.w*9/16+"px")}function u(e,t,r){return e<t?t:e>r?r:e}function l(e){var t=u(e,o.left,o.right),i=t+o.w/2,c=o.left+o.w/2,l=o.right-o.w/2;c>l&&(c=l=(o.left+o.right)/2);var a=u(i,c,l);return a-o.baseC}function a(e){var t=e.clientX;o.hasMove&&(o.vx+=t-(null==o.px?t:o.px)),o.hasMove=!0,o.px=t}function s(e){o.last||(o.last=e);if(!o.hasMove||null==o.px){o.last=e,o.raf=requestAnimationFrame(s);return}var t=Math.min(.05,(e-o.last)/1e3);o.last=e,c();var r=l(o.px),i=1-Math.exp(-L*t);o.x+=i*(r-o.x),o.vx*=.82,Math.abs(o.vx)<.1&&(o.vx=0);var a=0;o.vx&&(a=-o.vx/V,a>M?a=M:a<-M&&(a=-M)),o.sq+=S*(a-o.sq);var s=H.base+o.sq;s<H.min?s=H.min:s>H.max&&(s=H.max),n.style.transform="translate3d("+o.x+"px,0,0) scale("+s+")",o.raf=requestAnimationFrame(s)}c(),addEventListener("pointermove",a,{passive:!0}),addEventListener("resize",c,{passive:!0}),o.raf=requestAnimationFrame(s),t.__hsDestroy=function(){try{removeEventListener("pointermove",a)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
