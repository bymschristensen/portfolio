	...
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({
				...
				init:function(r){if(!window.gsap||!window.ScrollTrigger)return;r=r||document;var s=[].slice.call(r.querySelectorAll(".section-single-service"));if(!s.length)return;s.forEach(function(e){var t=e.offsetHeight<(window.innerHeight||document.documentElement.clientHeight),l=gsap.timeline({scrollTrigger:{trigger:e,start:t?"top top":"bottom bottom",pin:!0,pinSpacing:!1,scrub:1,invalidateOnRefresh:!0}});l.to(e,{ease:"none",startAt:{filter:"contrast(100%) blur(0px)"},filter:"contrast(10%) blur(10px)"},0)})}
			}),
			feature({
				id: "productGallery",
				stage: "main",
