	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(e){if(!window.gsap)return;e=e||document;var t=e.querySelector('[data-barba="container"]')||e;if(t.__almCleanup)try{t.__almCleanup()}catch(e){}var i=[].slice.call(t.querySelectorAll(".archive-playful-item,.archive-minimal-item")),a=[].slice.call(t.querySelectorAll(".archive-minimal-item-visual"));if(!i.length&&!a.length)return;function l(e){return!e||e.__almDone||"none"===e.style.display}function r(e){e.__almDone=1,gsap.fromTo(e,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.55,ease:"power3.out",overwrite:!0,clearProps:"y,filter,willChange"})}function n(e){e.__almDone=1,gsap.fromTo(e,{autoAlpha:0,filter:"blur(10px)"},{autoAlpha:1,filter:"blur(0px)",duration:.55,ease:"power3.out",overwrite:!0,clearProps:"filter,willChange"})}var o=new IntersectionObserver((function(e){e.forEach((function(e){var t=e.target;if(!e.isIntersecting||l(t))return;/archive-minimal-item-visual/.test(t.className)?n(t):r(t)}))}),{root:null,threshold:.15});i.forEach((function(e){o.observe(e)})),a.forEach((function(e){o.observe(e)})),t.__almCleanup=function(){try{o.disconnect()}catch(e){}t.__almCleanup=null}}
			}),
			feature({
