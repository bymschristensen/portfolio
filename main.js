...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({id:"archiveController",stage:"main",namespaces:["archive"],selectors:[".section-archive-playful",".section-archive-minimal",".archive-playful-list",".archive-minimal-list",".archive-switch-block",".filters-tab",".modal-filters-item"],init:function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveControllerBound)return;e.__archiveControllerBound=1;var t=[].slice.call(e.querySelectorAll(".filters-tab")),n=[].slice.call(e.querySelectorAll(".modal-filters-item")),a=t.concat(n),i=e.querySelector(".archive-switch-block");function o(r){return(r||"").toString().trim().toLowerCase()}function l(r){var e=r&&r.getAttribute&&((r.getAttribute("data-filter")||r.getAttribute("data-category")||r.getAttribute("data-archive-filter")||r.getAttribute("data-value"))||"");return o(e||r.textContent)}function s(){var r=e.querySelector(".list-archive.is-playful")||e.querySelector('[data-archive-list="playful"]')||null,t=e.querySelector(".list-archive.is-minimal")||e.querySelector('[data-archive-list="minimal"]')||null,n=r&&!r.classList.contains("is-hidden")?r:t&&!t.classList.contains("is-hidden")?t:r||t;return{playful:r,minimal:t,active:n}}function c(r,e){if(!e||"all"===e)return!0;for(var t=r.querySelectorAll(".cms-categories, .list-categories, .archive-categories, [data-category], [data-cms-category]"),n="",a=0;a<t.length;a++)n+=" "+(t[a].textContent||"");return o(n).indexOf(e)>-1}function u(r){var t=s().active;if(!t)return;for(var n=[].slice.call(t.querySelectorAll(".list-item-archive-project")),a=0;a<n.length;a++){var i=n[a],o=c(i,r);i.style.display=o?"":"none",i.setAttribute("aria-hidden",o?"false":"true")}try{window.dispatchEvent(new CustomEvent("archive:filterChanged",{detail:{key:r}}))}catch(r){}}function d(){var r=e.querySelector(".filters-tab.is-active")||e.querySelector(".modal-filters-item.is-active")||a[0];return r?l(r)||"all":"all"}function f(r){for(var e=0;e<a.length;e++){var t=a[e],n=l(t)||"all";(r||"all")===n?t.classList.add("is-active"):t.classList.remove("is-active")}}function v(r){var t=s(),n=t.playful,a=t.minimal;if(!n&&!a)return;var i="playful"===r?n:a,o="playful"===r?a:n;if(!i||!o)return;gsap.killTweensOf([i,o]);var l=gsap.timeline({defaults:{overwrite:!0}});l.set(i,{display:"",autoAlpha:1}).to(o,{autoAlpha:0,duration:.18,ease:"power2.out"},0).add(function(){o.classList.add("is-hidden"),o.setAttribute("aria-hidden","true"),i.classList.remove("is-hidden"),i.setAttribute("aria-hidden","false")},.18).set(i,{autoAlpha:0},.18).to(i,{autoAlpha:1,duration:.18,ease:"power2.out"},.19).add(function(){try{window.dispatchEvent(new CustomEvent("archive:viewChanged",{detail:{view:r}}))}catch(r){}},.21)}u(d());f(d());for(var m=0;m<a.length;m++)!function(r){r.addEventListener("click",function(e){e.preventDefault();var t=l(r)||"all";f(t),u(t)},{passive:!1})}(a[m]);i&&i.addEventListener("click",function(r){r.preventDefault();var e=s(),t=e.playful,n=e.minimal;if(!t&&!n)return;var a=t&&!t.classList.contains("is-hidden")?"playful":n&&!n.classList.contains("is-hidden")?"minimal":t?"playful":"minimal";v("playful"===a?"minimal":"playful");var i=d();f(i),u(i)},{passive:!1})}}),
			feature({id:"archiveListMotion",stage:"main",namespaces:["archive"],selectors:[".archive-playful-list",".archive-minimal-list",".section-archive-playful",".section-archive-minimal"],init:function(r){if(!window.gsap)return;r=r||document;var e=r.querySelector('[data-barba="container"]')||r;if(e.__archiveListMotionBound)return;e.__archiveListMotionBound=1;function t(r){return(r||"").toString().trim().toLowerCase()}function n(r){return!(!r)||((r=e.querySelector(r))&&r)}function a(r){return r&&getComputedStyle(r).display!=="none"&&getComputedStyle(r).visibility!=="hidden"&&r.getClientRects&&r.getClientRects().length>0}function i(r){if(!r)return[];for(var e=[].slice.call(r.querySelectorAll(".list-item-archive-project")),t=[],n=0;n<e.length;n++)a(e[n])&&t.push(e[n]);return t}function o(r){var t=e.querySelector(r);return t||null}function l(r){var n=o(".archive-playful-list")||o(".list-archive.is-playful")||o('[data-archive-list="playful"]'),a=o(".archive-minimal-list")||o(".list-archive.is-minimal")||o('[data-archive-list="minimal"]');return"playful"===r?n:a}function s(r,n){var a=o(".section-archive-playful"),i=o(".section-archive-minimal");return a||i?"playful"===r?a:i:n}function c(r){for(var n=[].slice.call(e.querySelectorAll("a,button,div,[role='button']")),a=0;a<n.length;a++){var i=t(n[a].textContent);if(i===t(r))return n[a]}return null}var u=c("details"),d=c("visuals"),f=null;function v(r){u&&(u.classList.toggle("is-active","minimal"===r),u.setAttribute("aria-pressed","minimal"===r?"true":"false"));d&&(d.classList.toggle("is-active","playful"===r),d.setAttribute("aria-pressed","playful"===r?"true":"false"))}function m(r,e){r&&(r.classList.remove("is-hidden"),r.setAttribute("aria-hidden","false"));e&&(e.classList.add("is-hidden"),e.setAttribute("aria-hidden","true"))}function p(r){var t="playful"===r?l("playful"):l("minimal"),n="playful"===r?l("minimal"):l("playful"),a=s("playful",l("playful")),o=s("minimal",l("minimal")),c="playful"===r?a:o,p="playful"===r?o:a;if(!c||!p)return;var u=i(c===t?t:c);u.length||(u=i(t));f&&f.kill&&f.kill(),gsap.killTweensOf([c,p].concat(u)),f=gsap.timeline({defaults:{overwrite:!0}}),f.to(p,{autoAlpha:0,duration:.15,ease:"power2.out"},0).add(function(){m(c,p),gsap.set(c,{autoAlpha:1})},.16).set(u,{autoAlpha:0,y:80,filter:"blur(10px)"},.17).to(u,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.45,ease:"power3.out",stagger:{each:.05,from:"start"}},.18),v(r==="playful"?"playful":"minimal");try{window.dispatchEvent(new CustomEvent("archive:viewChanged",{detail:{view:r}}))}catch(r){}}function h(r,e){r&&r.addEventListener("click",function(r){r.preventDefault(),p(e)},{passive:!1})}h(u,"minimal"),h(d,"playful")}})
		);
