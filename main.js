...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(r){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;r=r||document;var s=r.querySelector(".hero-section-showreel");if(!s||s.__hsBound)return;var t=s.querySelector(".showreel-track"),n=s.querySelector(".showreel-container");if(!t||!n)return;s.__hsBound=1;n.style.transformOrigin="50% 50%";n.style.willChange="transform";n.style.transform="translate3d(0,0,0) scale(1)";var o={x:0,s:1,ts:1,px:null,last:0,raf:0,w:0,tw:0,tL:0,tR:0,baseC:0,hasMove:!1},S0=.96,S1=1.1;function a(){var e=n.getBoundingClientRect(),r=t.getBoundingClientRect();o.w=e.width||n.offsetWidth||0;o.tw=r.width||t.offsetWidth||0;o.tL=r.left;o.tR=r.right;o.baseC=e.left+e.width/2-o.x}function c(e,r,a){return e<r?r:e>a?a:e}function l(e){var r=c(e,o.tL,o.tR),a=o.w*o.s*.15,i=r+a,s=o.tL+o.w*o.s/2,d=o.tR-o.w*o.s/2;if(s>d){var u=(o.tL+o.tR)/2;s=d=u}i=c(i,s,d);return i-o.baseC}function i(e){o.hasMove=!0;o.px=e.clientX}function d(){var e=t.getBoundingClientRect(),r=(innerHeight||document.documentElement.clientHeight||1),a=e.top+e.height/2,i=Math.abs(a-r/2),s=1-Math.min(1,i/(r*.75));o.ts=S0+s*(S1-S0)}function u(){n.style.transform="translate3d("+o.x+"px,0,0) scale("+o.s+")"}function f(e){o.last||(o.last=e);var r=Math.min(.05,(e-o.last)/1e3);o.last=e;a();var s=(innerWidth||document.documentElement.clientWidth||1),d=.5*s,p=o.px==null?d:o.px,h=o.hasMove?l(p):0,m=1-Math.exp(-10*r),v=1-Math.exp(-6*r);o.s+=v*(o.ts-o.s);o.x+=m*(h-o.x);u();o.raf=requestAnimationFrame(f)}a();d();addEventListener("pointermove",i,{passive:!0});addEventListener("scroll",d,{passive:!0});addEventListener("resize",a,{passive:!0});o.raf=requestAnimationFrame(f);s.__hsDestroy=function(){try{removeEventListener("pointermove",i)}catch(e){}try{removeEventListener("scroll",d)}catch(e){}try{removeEventListener("resize",a)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(r){r=r||document;var s=r.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{s&&s.__hsDestroy&&s.__hsDestroy()}catch(e){}}}),
			feature({
