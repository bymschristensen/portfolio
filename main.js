	...
	window.InitManager = (function () {
		...
		registries.common.push(
			...
			feature({
				...
				namespaces: '*',
				selectors: [],
				//init: async r=>{if(window.__CC_LOCK)return window.__customCursorDestroy||(()=>{});window.__CC_LOCK=1;try{window.__customCursorDestroy&&window.__customCursorDestroy()}catch{}try{document.getElementById("cc-webgl")?.remove(),document.getElementById("cc-dom")?.remove()}catch{}if(!matchMedia("(pointer:fine)").matches||!matchMedia("(hover:hover)").matches)return document.body.classList.remove("cursor--disable-all-cursors"),window.__customCursorDestroy=()=>{},CoreUtilities.Cursor.setDestroy(window.__customCursorDestroy),window.__CC_LOCK=0,window.__customCursorDestroy;const c=document.createElement("canvas");c.className="cursor-webgl",c.id="cc-webgl",document.body.appendChild(c);const a=c.getContext("2d"),w=document.createElement("div");w.className="custom-cursor",w.id="cc-dom";const k=document.createElement("div");k.className="cursor-label cursor-label--right",k.setAttribute("aria-hidden","true");const B=document.createElement("div");B.className="cursor-label__inner";const C=document.createElement("div");C.className="cursor-label__text",B.appendChild(C),k.appendChild(B),w.appendChild(k),document.body.appendChild(w);const W=innerWidth/2,H=innerHeight/2,p={x:W,y:H,tx:W,ty:H},Q=gsap.quickSetter(w,"x","px"),K=gsap.quickSetter(w,"y","px"),j=gsap.quickSetter(k,"x","px"),z=gsap.quickSetter(k,"y","px"),qR=gsap.quickSetter(k,"rotation","deg"),qRX=gsap.quickSetter(k,"rotationX","deg"),qRY=gsap.quickSetter(k,"rotationY","deg");gsap.set(w,{x:p.x,y:p.y,scale:1,opacity:0,transformOrigin:"center center",pointerEvents:"none"}),gsap.set(k,{autoAlpha:0,willChange:"transform,clip-path,opacity",transformPerspective:800,transformOrigin:"100% 0%"}),gsap.set(B,{display:"block"});let L=0,E=0;function R(){L=innerWidth,E=innerHeight,c.width=L,c.height=E}R();const h=Array.from({length:40},()=>({x:p.x,y:p.y,vx:0,vy:0})),S={s:1};let I=null,T=null,b=null,N=null,A=!1,O=!1;const U=.01,V=.005;let i=p.x,l=p.y;function J(){clearTimeout(N),N=setTimeout(Z,1e4)}function G(){const e=document.documentElement;i=(.25+.5*Math.random())*e.clientWidth,l=(.25+.5*Math.random())*e.clientHeight}function Z(){if(A||O)return;A=!0,G();const e=()=>{A&&!O&&(Math.random()<V&&G(),p.tx+=(i-p.tx)*U,p.ty+=(l-p.ty)*U,b=requestAnimationFrame(e))};b=requestAnimationFrame(e)}function x(){A=!1,b&&cancelAnimationFrame(b),b=null}const ht=(e,t,n)=>Math.max(t,Math.min(n,e)),yt=t=>t.split("").map(e=>`<span class="cc-char" style="display:inline-block;will-change:transform,opacity">${" "===e?"&nbsp;":e}</span>`).join("");let P=0,M=0,rt=0,nt=0,mt=0,gt=0,tt=0,et=0,ot=0,st=0,ut=!1,dt=10,ct="",el=null;function _hideClip(e){return e?"inset(0% 0% 0% 100%)":"inset(0% 100% 0% 0%)"}function _showClip(){return"inset(0% 0% 0% 0%)"}function _setSide(e){k.classList.toggle("cursor-label--left",!!e),k.classList.toggle("cursor-label--right",!e),gsap.set(k,{transformOrigin:e?"0% 0%":"100% 0%"})}function _sideIsLeft(){return k.classList.contains("cursor-label--left")}function _calcSide(){const e=k.offsetWidth||0,t=innerWidth-(e+28);return p.tx>t}function _revealLabel(e){const t=_calcSide();_setSide(t),ct=(e||ct||"Hover something").trim()||"Hover something";const n=t;gsap.killTweensOf(k),gsap.set(k,{autoAlpha:1,clipPath:_hideClip(n)}),gsap.to(k,{clipPath:_showClip(),duration:.34,ease:"power3.out",overwrite:!0});C.innerHTML=yt(ct);const o=C.querySelectorAll(".cc-char");gsap.killTweensOf(o),gsap.set(o,{y:10,opacity:0}),gsap.to(o,{y:0,opacity:1,duration:.32,ease:"power3.out",delay:.05,overwrite:!0,stagger:{each:.016,from:n?"end":"start"}}),ut=!0}function _swapText(e){e=(e||"").trim()||"Hover something";if(!ut)return _revealLabel(e);if(e===ct)return;ct=e;const t=_sideIsLeft(),n=C.querySelectorAll(".cc-char");gsap.killTweensOf(n);const o=gsap.timeline({overwrite:!0});o.to(n,{y:10,opacity:0,duration:.16,ease:"power2.in",stagger:{each:.01,from:t?"start":"end"}}).add(()=>{C.innerHTML=yt(ct)}).set(C.querySelectorAll(".cc-char"),{y:10,opacity:0}).to(C.querySelectorAll(".cc-char"),{y:0,opacity:1,duration:.26,ease:"power3.out",stagger:{each:.014,from:t?"end":"start"}})}function _hideLabel(){if(!ut)return;ut=!1;const e=_sideIsLeft(),t=C.querySelectorAll(".cc-char");gsap.killTweensOf(t),gsap.killTweensOf(k),gsap.to(t,{y:10,opacity:0,duration:.14,ease:"power2.in",overwrite:!0,stagger:{each:.01,from:e?"start":"end"}}),gsap.to(k,{clipPath:_hideClip(e),duration:.2,ease:"power2.in",overwrite:!0,onComplete:()=>{gsap.set(k,{autoAlpha:0})}})}function _animateSideSwitch(e){const t=_sideIsLeft(),n=!!e;if(t===n)return;const o=C.querySelectorAll(".cc-char");gsap.killTweensOf(o),gsap.killTweensOf(k),gsap.to(o,{y:10,opacity:0,duration:.12,ease:"power2.in",overwrite:!0,stagger:{each:.008,from:t?"start":"end"}}),gsap.to(k,{clipPath:_hideClip(t),duration:.16,ease:"power2.in",overwrite:!0,onComplete:()=>{_setSide(n),gsap.set(k,{clipPath:_hideClip(n),autoAlpha:1}),gsap.to(k,{clipPath:_showClip(),duration:.26,ease:"power3.out",overwrite:!0});const s=C.querySelectorAll(".cc-char");gsap.set(s,{y:10,opacity:0}),gsap.to(s,{y:0,opacity:1,duration:.26,ease:"power3.out",delay:.04,overwrite:!0,stagger:{each:.014,from:n?"end":"start"}})}})}const Dt=e=>{if(O)return;x(),J();const t=e.clientX,n=e.clientY;rt=t-P,nt=n-M,P=t,M=n;mt=ht(.35*rt,-16,16),gt=ht(.35*nt,-14,14),p.tx=t,p.ty=n},Ft=()=>{document.hidden?x():J()},_enter=t=>{if(O)return;x(),J(),el=t;const n=(t?.dataset.cursor||"").toLowerCase();if(!t)return document.body.classList.remove("cursor--disable-all-cursors"),w.className="custom-cursor",gsap.to(w,{scale:1,opacity:1,duration:.25,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:1,duration:.25,ease:"power2.out",overwrite:!0}),void _hideLabel();if("hide"===n)return w.classList.add("cursor--hide"),document.body.classList.add("cursor--disable-all-cursors"),gsap.set(w,{scale:0,opacity:0,overwrite:!0}),void gsap.set(S,{s:0,overwrite:!0});w.className="custom-cursor",document.body.classList.remove("cursor--disable-all-cursors");let o=1;if("scaleup"===n)o=3,w.classList.add("cursor--scaleup"),_hideLabel();else if("text"===n){const e=((t.dataset.cursorText||t.dataset.text||"")+"").trim();_revealLabel(e||"Hover something"),o=1}else _hideLabel();gsap.to(w,{scale:o,opacity:1,duration:.25,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:o,duration:.25,ease:"power2.out",overwrite:!0})},_leave=()=>{if(O)return;el=null,_hideLabel(),w.className="custom-cursor",document.body.classList.remove("cursor--disable-all-cursors"),gsap.to(w,{scale:1,opacity:1,duration:.25,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:1,duration:.25,ease:"power2.out",overwrite:!0})},qt=e=>{if(O)return;const t=e.target.closest?.("[data-cursor]");if(!t)return;const n=e.relatedTarget;if(n&&t.contains(n))return;el!==t&&_enter(t)},Mt=e=>{if(O)return;if(!el)return;const t=e.relatedTarget;if(t&&el.contains(t))return;_leave()};function Y(){if(O)return;O=!0,x(),I&&cancelAnimationFrame(I),T&&cancelAnimationFrame(T),removeEventListener("resize",R),document.removeEventListener("mousemove",Dt),document.removeEventListener("pointerover",qt),document.removeEventListener("pointerout",Mt),document.removeEventListener("visibilitychange",Ft);try{c.remove()}catch{}try{w.remove()}catch{}window.__customCursorDestroy=null,window.__CC_LOCK=0}addEventListener("resize",R),document.addEventListener("mousemove",Dt,{passive:!0}),document.addEventListener("pointerover",qt,{passive:!0}),document.addEventListener("pointerout",Mt,{passive:!0}),document.addEventListener("visibilitychange",Ft),I=requestAnimationFrame(function e(){a.clearRect(0,0,L,E),p.x+=.45*(p.tx-p.x),p.y+=.45*(p.ty-p.y),h.forEach((e,t)=>{if(0===t)return e.x=p.x,void(e.y=p.y);const n=h[t-1];e.vx+=.4*(n.x-e.x),e.vy+=.4*(n.y-e.y),e.vx*=.5,e.vy*=.5,e.x+=e.vx,e.y+=e.vy});const t=getComputedStyle(document.documentElement).getPropertyValue("--colors--highlight").trim()||"#000";a.strokeStyle=t;for(let e=0;e<h.length-1;e++){const n=h[e],o=h[e+1],s=e/(h.length-1);a.lineWidth=16*(1-s)+2*s,a.lineCap="round",a.beginPath(),a.moveTo(n.x,n.y),a.lineTo(o.x,o.y),a.stroke()}a.beginPath(),a.fillStyle=t,a.arc(p.x,p.y,10*S.s,0,2*Math.PI),a.fill(),I=requestAnimationFrame(e)}),T=requestAnimationFrame(function e(){Q(p.x),K(p.y);const t=_calcSide();ut&&_animateSideSwitch(t);if(ut){tt+=(mt-tt)*.16,et+=(gt-et)*.16;const e1=(t?-dt:dt)+tt,n1=et;ot+=(e1-ot)*.22,st+=(n1-st)*.22,j(ot),z(st);const s=ht(tt*1.15,-18,18),d=ht(et*1.05,-14,14),u=ht(tt*.55,-10,10),f=ht(et*.55,-10,10);qR(s*.35),qRY(u),qRX(-f)}else qR(0),qRY(0),qRX(0);T=requestAnimationFrame(e)}),J(),window.__customCursorDestroy=Y,CoreUtilities.Cursor.setDestroy(Y),window.__CC_LOCK=0,Y}
				init:async r=>{if(window.__CC_LOCK)return window.__customCursorDestroy||(()=>{});window.__CC_LOCK=1;try{window.__customCursorDestroy&&window.__customCursorDestroy()}catch{}try{document.getElementById("cc-webgl")?.remove(),document.getElementById("cc-dom")?.remove()}catch{}if(!matchMedia("(pointer:fine)").matches||!matchMedia("(hover:hover)").matches)return document.body.classList.remove("cursor--disable-all-cursors"),window.__customCursorDestroy=()=>{},CoreUtilities.Cursor.setDestroy(window.__customCursorDestroy),window.__CC_LOCK=0,window.__customCursorDestroy;const c=document.createElement("canvas");c.className="cursor-webgl",c.id="cc-webgl",document.body.appendChild(c);const a=c.getContext("2d"),w=document.createElement("div");w.className="custom-cursor",w.id="cc-dom";const k=document.createElement("div");k.className="cursor-label cursor-label--right",k.setAttribute("aria-hidden","true");const B=document.createElement("div");B.className="cursor-label__inner";const C=document.createElement("div");C.className="cursor-label__text",B.appendChild(C),k.appendChild(B),w.appendChild(k),document.body.appendChild(w);let L=0,E=0;const R=()=>{L=innerWidth,E=innerHeight,c.width=L,c.height=E};R();const W=innerWidth/2,H=innerHeight/2,p={x:W,y:H,tx:W,ty:H},Q=gsap.quickSetter(w,"x","px"),K=gsap.quickSetter(w,"y","px"),j=gsap.quickSetter(k,"x","px"),z=gsap.quickSetter(k,"y","px"),jr=gsap.quickSetter(k,"rotation","deg");gsap.set(w,{x:p.x,y:p.y,scale:1,opacity:0,transformOrigin:"center center",pointerEvents:"none"}),gsap.set(k,{autoAlpha:0,willChange:"transform,clip-path,opacity"}),gsap.set(B,{display:"block"});const h=Array.from({length:40},()=>({x:p.x,y:p.y,vx:0,vy:0})),S={s:1};let I=null,T=null,N=null,O=!1;const ht=(e,t,n)=>Math.max(t,Math.min(n,e)),yt=t=>t.split("").map(e=>`<span class="cc-char" style="display:inline-block;will-change:transform,opacity">${" "===e?"&nbsp;":e}</span>`).join("");let mx=p.x,my=p.y,pmx=p.x,pmy=p.y,vx=0,vy=0,txo=28,tyo=0,xo=28,yo=0,ro=0,tarRo=0,shown=!1,txt="",sideLeft=!1;const _hideClip=e=>e?"inset(0% 0% 0% 100%)":"inset(0% 100% 0% 0%)",_showClip=()=>"inset(0% 0% 0% 0%)",_setSide=e=>{sideLeft=!!e,k.classList.toggle("cursor-label--left",sideLeft),k.classList.toggle("cursor-label--right",!sideLeft),k.style.transformOrigin=sideLeft?"right top":"left top"},_calcSide=()=>p.tx>innerWidth*.8;function _ensureText(e){const t=((e||"").trim()||"Hover something");t!==txt&&(txt=t,C.innerHTML=yt(txt))}function _showLabel(e){_ensureText(e),_setSide(_calcSide());const t=C.querySelectorAll(".cc-char");gsap.killTweensOf(t),gsap.killTweensOf(k),gsap.set(k,{autoAlpha:1,clipPath:_hideClip(sideLeft)}),gsap.to(k,{clipPath:_showClip(),duration:.28,ease:"power3.out",overwrite:!0}),gsap.set(t,{y:10,opacity:0}),gsap.to(t,{y:0,opacity:1,duration:.28,ease:"power3.out",delay:.04,overwrite:!0,stagger:{each:.014,from:sideLeft?"end":"start"}}),shown=!0}function _swapText(e){const t=((e||"").trim()||"Hover something");if(!shown)return _showLabel(t);if(t===txt)return;const n=sideLeft,o=C.querySelectorAll(".cc-char");gsap.killTweensOf(o);const s=gsap.timeline({overwrite:!0});s.to(o,{y:10,opacity:0,duration:.14,ease:"power2.in",stagger:{each:.01,from:n?"start":"end"}}).add(()=>{_ensureText(t)}).set(C.querySelectorAll(".cc-char"),{y:10,opacity:0}).to(C.querySelectorAll(".cc-char"),{y:0,opacity:1,duration:.22,ease:"power3.out",stagger:{each:.012,from:n?"end":"start"}})}function _hideLabel(){if(!shown)return;shown=!1;const e=sideLeft,t=C.querySelectorAll(".cc-char");gsap.killTweensOf(t),gsap.killTweensOf(k),gsap.to(t,{y:10,opacity:0,duration:.12,ease:"power2.in",overwrite:!0,stagger:{each:.01,from:e?"start":"end"}}),gsap.to(k,{clipPath:_hideClip(e),duration:.18,ease:"power2.in",overwrite:!0,onComplete:()=>gsap.set(k,{autoAlpha:0})})}function _animateSide(){const e=_calcSide();if(e===sideLeft)return;const t=txt||"Hover something";_ensureText(t);const n=C.querySelectorAll(".cc-char");gsap.killTweensOf(n),gsap.killTweensOf(k),gsap.to(k,{clipPath:_hideClip(sideLeft),duration:.14,ease:"power2.in",overwrite:!0,onComplete:()=>{_setSide(e),gsap.set(k,{autoAlpha:1,clipPath:_hideClip(sideLeft)}),gsap.to(k,{clipPath:_showClip(),duration:.22,ease:"power3.out",overwrite:!0});const o=C.querySelectorAll(".cc-char");gsap.set(o,{y:10,opacity:0}),gsap.to(o,{y:0,opacity:1,duration:.22,ease:"power3.out",delay:.03,overwrite:!0,stagger:{each:.012,from:sideLeft?"end":"start"}})}})}const Dt=e=>{if(O)return;const t=e.clientX,n=e.clientY;vx=t-pmx,vy=n-pmy,pmx=t,pmy=n,mx=t,my=n,p.tx=t,p.ty=n,clearTimeout(N),N=setTimeout(()=>{},1e4)},qt=e=>{if(O)return;clearTimeout(N),N=setTimeout(()=>{},1e4);const t=e.target.closest("[data-cursor]");if(!t)return document.body.classList.remove("cursor--disable-all-cursors"),w.className="custom-cursor",gsap.to(w,{scale:1,opacity:1,duration:.22,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:1,duration:.22,ease:"power2.out",overwrite:!0}),void _hideLabel();const n=(t.dataset.cursor||"").toLowerCase();if("hide"===n)return w.classList.add("cursor--hide"),document.body.classList.add("cursor--disable-all-cursors"),gsap.set(w,{scale:0,opacity:0,overwrite:!0}),void gsap.set(S,{s:0,overwrite:!0});w.className="custom-cursor",document.body.classList.remove("cursor--disable-all-cursors");let o=1;if("scaleup"===n)o=3,w.classList.add("cursor--scaleup"),_hideLabel();else if("text"===n){const e=((t.dataset.cursorText||t.dataset.text||"")+"").trim();shown?_swapText(e||"Hover something"):_showLabel(e||"Hover something"),o=1}else _hideLabel();gsap.to(w,{scale:o,opacity:1,duration:.22,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:o,duration:.22,ease:"power2.out",overwrite:!0})},Mt=e=>{if(O)return;const t=e.target.closest("[data-cursor]");t&&(t.dataset.cursor||"").toLowerCase()==="text"?_hideLabel():(_hideLabel(),w.className="custom-cursor",document.body.classList.remove("cursor--disable-all-cursors"),gsap.to(w,{scale:1,opacity:1,duration:.22,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:1,duration:.22,ease:"power2.out",overwrite:!0}))},Ft=()=>{document.hidden||clearTimeout(N)};function Y(){if(O)return;O=!0,I&&cancelAnimationFrame(I),T&&cancelAnimationFrame(T),removeEventListener("resize",R),document.removeEventListener("mousemove",Dt),document.removeEventListener("pointerover",qt),document.removeEventListener("pointerout",Mt),document.removeEventListener("visibilitychange",Ft);try{c.remove()}catch{}try{w.remove()}catch{}window.__customCursorDestroy=null,window.__CC_LOCK=0}addEventListener("resize",R),document.addEventListener("mousemove",Dt,{passive:!0}),document.addEventListener("pointerover",qt,{passive:!0}),document.addEventListener("pointerout",Mt,{passive:!0}),document.addEventListener("visibilitychange",Ft),I=requestAnimationFrame(function e(){a.clearRect(0,0,L,E),p.x+=.45*(p.tx-p.x),p.y+=.45*(p.ty-p.y),h.forEach((t,n)=>{if(0===n)return t.x=p.x,void(t.y=p.y);const o=h[n-1];t.vx+=.4*(o.x-t.x),t.vy+=.4*(o.y-t.y),t.vx*=.5,t.vy*=.5,t.x+=t.vx,t.y+=t.vy});const t=getComputedStyle(document.documentElement).getPropertyValue("--colors--highlight").trim()||"#000";a.strokeStyle=t;for(let t2=0;t2<h.length-1;t2++){const n=h[t2],o=h[t2+1],s=t2/(h.length-1);a.lineWidth=16*(1-s)+2*s,a.lineCap="round",a.beginPath(),a.moveTo(n.x,n.y),a.lineTo(o.x,o.y),a.stroke()}a.beginPath(),a.fillStyle=t,a.arc(p.x,p.y,10*S.s,0,2*Math.PI),a.fill(),I=requestAnimationFrame(e)}),T=requestAnimationFrame(function e(){Q(p.x),K(p.y),shown&&_animateSide();const bw=k.offsetWidth||0;baseX=sideLeft?-(bw+28):28,txo=baseX+ht(vx*.08,-10,10),tyo=ht(vy*.06,-8,8),tarRo=ht(vy*.08+vx*.03,-12,12)*(sideLeft?-1:1),xo+=(txo-xo)*.22,yo+=(tyo-yo)*.22,ro+=(tarRo-ro)*.18,j(xo),z(yo),jr(ro),T=requestAnimationFrame(e)}),window.__customCursorDestroy=Y,CoreUtilities.Cursor.setDestroy(Y),window.__CC_LOCK=0,Y}
			}),
