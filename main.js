...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		// Entry Animations
		var EntryAnimations = {};
		EntryAnimations.selected=function(e){e=e||document;var t=e.querySelector(".selected-container"),n=t&&t.querySelector(".selected-content"),i=gsap.timeline({defaults:{ease:"power2.out"}});if(!t||!n)return i;function r(){var e=[].slice.call(n.querySelectorAll(".selected-item-outer"));if(!e.length)return;e.forEach(function(e){if(e.__entryPrepared)return;var t=e.querySelector(".selected-visual"),n=e.querySelector(".selected-item-header .headline-m"),i=e.querySelector(".selected-item-details"),r=e.querySelectorAll(".selected-item-details .body-s");t&&gsap.set(t,{scaleY:0,opacity:0,transformOrigin:"bottom center",willChange:"transform,opacity"}),n&&gsap.set(n,{opacity:0,willChange:"transform,opacity"}),i&&gsap.set(i,{opacity:0,height:0,willChange:"height,opacity"}),r.length&&gsap.set(r,{opacity:0,y:20,filter:"blur(10px)",willChange:"transform,opacity,filter"}),e.__entryPrepared=!0})}function o(){var e=Math.max(document.documentElement.clientWidth,window.innerWidth||0),o=window.innerHeight||document.documentElement.clientHeight||0,l=[].slice.call(n.querySelectorAll(".selected-item-outer"));if(!l.length)return i;var s=l.map(function(t){var n=t.getBoundingClientRect(),i=Math.max(0,Math.min(n.right,e)-Math.max(n.left,0))*Math.max(0,Math.min(n.bottom,o)-Math.max(n.top,0));return{el:t,rect:n,area:i,cx:(n.left+n.right)/2}}),d=s.filter(function(e){return e.area>1}).sort(function(e,t){return e.rect.left-t.rect.left});if(!d.length){var c=e/2;d=s.slice().sort(function(e,t){return Math.abs(e.cx-c)-Math.abs(t.cx-c)}).slice(0,2).sort(function(e,t){return e.rect.left-t.rect.left})}var u={};d.forEach(function(e){u[e.el]=!0}),s.forEach(function(e){if(!e.el.__entryDone&&!u[e.el]){var t=e.el.querySelector(".selected-visual"),n=e.el.querySelector(".selected-item-header .headline-m"),i=e.el.querySelector(".selected-item-details"),r=e.el.querySelectorAll(".selected-item-details .body-s");t&&gsap.set(t,{scaleY:1,opacity:1}),n&&gsap.set(n,{opacity:1}),i&&gsap.set(i,{opacity:1,height:"auto"}),r.length&&gsap.set(r,{opacity:1,y:0,filter:"blur(0px)"}),e.el.__entryDone=!0}}),d.forEach(function(e,t){var n=e.el,r=n.querySelector(".selected-visual"),o=n.querySelector(".selected-item-header .headline-m"),l=n.querySelector(".selected-item-details"),s=n.querySelectorAll(".selected-item-details .body-s"),d=.14*t;r&&i.set(r,{opacity:1},d).to(r,{scaleY:1,duration:.75},d),o&&i.set(o,{opacity:1},d+.16).call(function(){if(window.SplitText&&window.splitAndMask&&window.animateLines&&window.safelyRevertSplit){var e=splitAndMask(o);animateLines(e.lines).eventCallback("onComplete",function(){safelyRevertSplit(e,o)})}else gsap.to(o,{y:0,opacity:1,duration:.55})},null,d+.16),l&&i.to(l,{opacity:1,height:"auto",duration:.4},d+.56),s.length&&i.to(s,{opacity:1,y:0,filter:"blur(0px)",duration:.4,stagger:.12},d+.56),n.__entryDone=!0});return i}function a(){return new Promise(function(e){requestAnimationFrame(function(){requestAnimationFrame(e)})})}function l(){r();return a().then(function(){try{if(document.documentElement.hasAttribute("data-preloading")){var e=[].concat([].slice.call(n.querySelectorAll(".appear-in-line")),[].slice.call(n.querySelectorAll(".selected-item-outer .selected-visual")),[].slice.call(n.querySelectorAll(".selected-item-outer .selected-item-header .headline-m")),[].slice.call(n.querySelectorAll(".selected-item-outer .selected-item-details")));e.length&&gsap.set(e,{visibility:"visible"})}document.documentElement.removeAttribute("data-preloading")}catch{}return a().then(o)})}if(document.documentElement.hasAttribute("data-preloading")){r();}if(t.hasAttribute("data-loop-ready"))return l(),i;var s=!1,d=function(){s||(s=!0,n.removeEventListener("selected:loop-ready",d,!0),l())};return n.addEventListener("selected:loop-ready",d,!0),setTimeout(function(){s||d()},520),i};
