	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(e){e=e||document;var t="archiveView",i=matchMedia("(min-width: 1024px)"),a=e.querySelector(".section-archive-playful"),l=e.querySelector(".section-archive-minimal"),r=e.querySelector(".archive-switch-block"),s=e.querySelector(".archive-switch"),n=e.querySelector(".archive-switch-dot");if(!a||!l||e.__archiveViewBound)return;e.__archiveViewBound=1;var c=[r,s].filter(Boolean),o=null,u=null,d=0;function m(){if(d)return;d=1;requestAnimationFrame(function(){d=0;try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}})}function f(){try{window.gsap&&gsap.set&&gsap.set([a,l],{display:"none"})}catch(_){}a.style.display="none",l.style.display="none"}function p(){try{var e2=localStorage.getItem(t);return"playful"===e2||"minimal"===e2?e2:null}catch(_){return null}}function g(){return i.matches?p()||"playful":"minimal"}function h(e2){var t2="playful"===e2;r&&(r.dataset.view=e2,r.setAttribute("aria-pressed",String(t2)),r.classList.toggle("is-playful",t2),r.classList.toggle("is-minimal",!t2)),s&&(s.dataset.view=e2,s.classList.toggle("is-playful",t2),s.classList.toggle("is-minimal",!t2)),n&&(n.dataset.view=e2,n.classList.toggle("is-playful",t2),n.classList.toggle("is-minimal",!t2))}function v(e2){try{document.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:e2}}))}catch(_){}}function y(e2){var t2="playful"===e2?a:l;t2.style.display="block";try{window.gsap&&gsap.set&&gsap.set(t2,{autoAlpha:1,filter:"none",clearProps:"opacity,visibility"})}catch(_){}h(e2),v(e2),m()}function b(e2){if(!window.gsap)return{items:[],visuals:[]};var t2="playful"===e2?a:l,i2="playful"===e2?".archive-playful-item":".archive-minimal-item",r2="playful"===e2?".archive-playful-item-visual":".archive-minimal-item-visual",s2=[].slice.call(t2.querySelectorAll(i2)||[]),n2=[];return s2.forEach(function(e3){var t3=e3.querySelector(r2);t3&&n2.push(t3)}),s2.forEach(function(e3){gsap.killTweensOf(e3),gsap.set(e3,{y:18,autoAlpha:0,willChange:"transform,opacity"})}),n2.forEach(function(e3){gsap.killTweensOf(e3),gsap.set(e3,{autoAlpha:0,filter:"blur(10px)",willChange:"opacity,filter"})}),{items:s2,visuals:n2}}function w(e2){if(!window.gsap)return;var t2=b(e2),i2=t2.items,r2=t2.visuals;gsap.timeline({defaults:{ease:"power3.out"}}).to(i2,{y:0,autoAlpha:1,duration:.6,stagger:.06,overwrite:!0,clearProps:"y,willChange"},0).to(r2,{autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"filter,willChange"},0).add(function(){m(),v(e2)})}function k(e2){f();var t2="playful"===e2?a:l;t2.style.display="block";h(e2),v(e2);try{window.gsap&&gsap.set&&gsap.set(t2,{autoAlpha:1,filter:"none",clearProps:"opacity,visibility"})}catch(_){}m()}function S(e2){if(!window.gsap)return k(e2),void function(e3){try{localStorage.setItem(t,e3)}catch(_){}}(e2);u&&(u.kill&&u.kill(),u=null);var n2=(r&&r.dataset.view)||(s&&s.dataset.view)||("none"!==a.style.display?"playful":"minimal");if(n2===e2)return;var c2="playful"===n2?a:l,o2="playful"===e2?a:l;h(e2);try{localStorage.setItem(t,e2)}catch(_){}gsap.killTweensOf([c2,o2]),f(),c2.style.display="block",o2.style.display="none";var d2=b(e2);u=gsap.timeline({defaults:{ease:"power2.out"},onComplete:function(){u=null}}).set(c2,{display:"block",autoAlpha:1,filter:"none"},0).to(c2,{autoAlpha:0,filter:"blur(10px)",duration:.22,overwrite:!0},0).add(function(){c2.style.display="none",o2.style.display="block";try{gsap.set(o2,{autoAlpha:1,filter:"none"})}catch(_){}}).to(d2.items,{y:0,autoAlpha:1,duration:.6,stagger:.06,overwrite:!0,clearProps:"y,willChange"},"-=0.02").to(d2.visuals,{autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"filter,willChange"},"-=0.62").add(function(){m(),v(e2)})}function C(e2){e2&&e2.preventDefault&&e2.preventDefault();if(i.matches){var t2=("playful"===(r&&r.dataset.view||s&&s.dataset.view||("none"!==a.style.display?"playful":"minimal"))?"minimal":"playful");S(t2)}else k("minimal")}function x(){var e2=g();k(e2),window.gsap?w(e2):A()}function A(){if(o)return;var e2=0;o=setInterval(function(){if(window.gsap){clearInterval(o),o=null;w(g())}else e2+=50,e2>=2000&&(clearInterval(o),o=null)},50)}f();var E=g();k(E),window.gsap?w(E):A(),c.forEach(function(e2){e2&&e2.addEventListener("click",C,{passive:!1})}),i.addEventListener?i.addEventListener("change",x):i.addListener(x),e.__archiveViewDestroy=function(){try{o&&(clearInterval(o),o=null)}catch(_){}try{u&&(u.kill&&u.kill(),u=null)}catch(_){}try{i.removeEventListener?i.removeEventListener("change",x):i.removeListener(x)}catch(_){}c.forEach(function(e2){try{e2&&e2.removeEventListener("click",C)}catch(_){}}),e.__archiveViewBound=0,e.__archiveViewDestroy=null}}
			}),
			feature({
