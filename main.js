...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({id:"archiveFiltersController",stage:"early",namespaces:["archive"],selectors:["#archive-filter-all","#archive-filter-appswebapps","#archive-filter-websites","#archive-filter-ecommerce","#archive-filter-platforms-systems","#archive-filter-other","#nav-archive-filter-all","#nav-archive-filter-appswebapps","#nav-archive-filter-websites","#nav-archive-filter-ecommerce","#nav-archive-filter-platforms-systems","#nav-archive-filter-other",".section-archive-playful",".section-archive-minimal"],init:function(r){r=r||document;var e="archiveFilter",t=r.querySelector("main.main")||r;if(t.__afcBound)return;t.__afcBound=1;var n=["archive-filter-all","archive-filter-appswebapps","archive-filter-websites","archive-filter-ecommerce","archive-filter-platforms-systems","archive-filter-other","nav-archive-filter-all","nav-archive-filter-appswebapps","nav-archive-filter-websites","nav-archive-filter-ecommerce","nav-archive-filter-platforms-systems","nav-archive-filter-other"],a=null,o=null,i=null,l=null,c=null;function s(e){return(e||"").replace(/^nav-archive-filter-/,"").replace(/^archive-filter-/,"").trim()}function u(e){return e=(e||"").toLowerCase().trim().replace(/&/g," ").replace(/[–—]/g,"-").replace(/[^a-z0-9]+/g," ").trim().replace(/\s+/g,"-"),"apps-web-apps"===e||"apps-webapps"===e||"apps-web"===e?"appswebapps":"e-commerce"===e||"ecommerce"===e?"ecommerce":"platforms-systems"===e||"platforms-and-systems"===e?"platforms-systems":"websites"===e?"websites":"other"===e?"other":"all"===e?"all":e}function f(e){if(e.__afCats)return e.__afCats;for(var t=["all"],n=e.querySelectorAll(".archive-categories .cms-categories"),a=0;a<n.length;a++){var o=(n[a].textContent||"").trim();o&&(o=u(o))&&-1===t.indexOf(o)&&t.push(o)}return e.__afCats=t,t}function d(){var e=t.querySelector(".section-archive-playful"),n=t.querySelector(".section-archive-minimal"),a=e?[].slice.call(e.querySelectorAll(".archive-playful-item")):[],o=n?[].slice.call(n.querySelectorAll(".archive-minimal-item")):[];return{playful:e,playfulItems:a,minimal:n,minimalItems:o,all:a.concat(o)}}function v(e){for(var a=0;a<n.length;a++){var o=n[a],i=r.getElementById? r.getElementById(o):document.getElementById(o);if(!i)continue;var l=s(o)===e;i.classList.toggle("is-active",l);try{i.setAttribute("aria-current",l?"true":"false")}catch(e){}try{i.setAttribute("aria-pressed",l?"true":"false")}catch(e){}}}function p(e){var t=d().all;return"all"===e?t.length:t.filter(function(t){return-1!==f(t).indexOf(e)}).length}function m(){for(var e=0;e<n.length;e++){var t=n[e],a=r.getElementById? r.getElementById(t):document.getElementById(t);if(!a)continue;var o=u(s(t)),i=a.querySelector(t.indexOf("nav-")===0?".nav-counter-filters":".filters-counter");i&&(i.textContent="("+p(o)+")")}}function h(e,n,a){var o=r.getElementById? r.getElementById("archive-results-counter"):document.getElementById("archive-results-counter");if(!o)return;var i=parseInt((o.textContent||"").replace(/\D/g,""),10)||0,l=e;window.gsap?gsap.to({v:i},{v:l,duration:n?.5:.01,ease:"power1.out",onUpdate:function(){o.textContent=Math.round(this.targets()[0].v)}}):o.textContent=l}function y(e,t){if(!t||!t.length)return;try{window.gsap?gsap.timeline().set(t,{y:100,opacity:0,filter:"blur(0px)",willChange:"transform,opacity"}).to(t,{y:0,opacity:1,duration:.6,ease:"power2.out",stagger:.12}):t.forEach(function(e){e.style.opacity="1"})}catch(e){}}function g(e){if(!e||!e.length)return;for(var t=0;t<e.length;t++)e[t].classList.remove("open");for(var n=0;n<e.length;n++){var a=e[n];if("none"!==a.style.display&&null!==a.offsetParent){a.classList.add("open");break}}}function b(n,a){n=u(n||"all")||"all";var o=a&&a.source||"auto",i=!!(a&&a.animate);v(n);var l=d(),c=l.all;for(var s=0;s<c.length;s++){var p=c[s],m=f(p),h="all"===n||-1!==m.indexOf(n);p.style.display=h?"":"none"}var b=c.filter(function(e){return"none"!==e.style.display});h(b.length,i);if(i)y(n,b);l.playfulItems&&g(l.playfulItems);l.minimalItems&&g(l.minimalItems);if("user"===o)try{localStorage.setItem(e,n)}catch(e){}try{t.dispatchEvent(new CustomEvent("archive:filter",{bubbles:!0,detail:{filter:n,source:o||"auto"}}))}catch(e){}}function w(){try{var t=localStorage.getItem(e);return t?u(t):null}catch(e){}return null}a=function(e){var n=e.target&&e.target.closest?e.target.closest('[id^="archive-filter-"],[id^="nav-archive-filter-"]'):null;if(!n||!n.id)return;var a=s(n.id);e.preventDefault&&e.preventDefault();b(a,{source:"user",animate:!0})};o=function(e){var n=e&&e.detail?e.detail:{},a=n.filter||n.key||n.category||"all",o=n.source||"event";if(o==="controller")return;b(a,{source:o,animate:!0})};i=function(){b(w()||"all",{source:"auto",animate:!1})};l=function(){b(w()||"all",{source:"auto",animate:!0})};t.addEventListener("click",a,{passive:!1});t.addEventListener("archive:filter",o);t.addEventListener("archive:view",l);m();b(w()||"all",{source:"auto",animate:!1});return t.__afcDestroy=function(){try{t.removeEventListener("click",a)}catch(e){}try{t.removeEventListener("archive:filter",o)}catch(e){}try{t.removeEventListener("archive:view",l)}catch(e){}t.__afcBound=0;t.__afcDestroy=null}}}),
			feature({id:"archiveViewController",stage:"early",namespaces:["archive"],selectors:[".section-archive-playful",".section-archive-minimal",".archive-switch-block",".archive-switch",".archive-switch-dot"],init:function(e){e=e||document;var t="archiveView",i=matchMedia("(min-width: 1024px)"),a=e.querySelector(".section-archive-playful"),l=e.querySelector(".section-archive-minimal"),r=e.querySelector(".archive-switch-block"),s=e.querySelector(".archive-switch"),n=e.querySelector(".archive-switch-dot");if(a&&l&&!e.__archiveViewBound){e.__archiveViewBound=1;var c=[r,s].filter(Boolean);p();var o=v(),u=o||f();return g(u,o?"stored":"auto"),d(u),i.addEventListener?i.addEventListener("change",m):i.addListener(m),c.forEach((function(e){e&&e.addEventListener("click",w,{passive:!1})})),e.__archiveViewDestroy=function(){try{i.removeEventListener?i.removeEventListener("change",m):i.removeListener(m)}catch(e){}c.forEach((function(e){try{e&&e.removeEventListener("click",w)}catch(e){}})),e.__archiveViewBound=0,e.__archiveViewDestroy=null}}function p(){try{window.gsap&&gsap.set&&gsap.set([a,l],{display:"none"})}catch(e){}a.style.display="none",l.style.display="none"}function v(){var e=localStorage.getItem(t);return"playful"===e||"minimal"===e?e:null}function f(){return i.matches?"playful":"minimal"}function y(e){var t="playful"===e;r&&(r.dataset.view=e,r.setAttribute("aria-pressed",String(t)),r.classList.toggle("is-playful",t),r.classList.toggle("is-minimal",!t)),s&&(s.dataset.view=e,s.classList.toggle("is-playful",t),s.classList.toggle("is-minimal",!t)),n&&(n.dataset.view=e,n.classList.toggle("is-playful",t),n.classList.toggle("is-minimal",!t))}function h(e){if(window.gsap){var t=[].slice.call(function(e){return"playful"===e?a.querySelectorAll(".archive-playful-item"):l.querySelectorAll(".archive-minimal-item")}(e)||[]);return t.forEach((function(e){e.__almDone=1,gsap.killTweensOf(e),gsap.set(e,{y:18,autoAlpha:0,filter:"blur(10px)",willChange:"transform,opacity,filter"})})),t}}function d(t){var i="playful"===t?a:l;if(!window.gsap)return p(),i.style.display="block",void y(t);p(),i.style.display="block",y(t),gsap.killTweensOf(i),gsap.set(i,{autoAlpha:1});var r=h(t);gsap.timeline({defaults:{ease:"power3.out"}}).to(r,{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"y,filter,willChange"},0).add((function(){try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(e){}try{e.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:t}}))}catch(e){}}),">")}function g(i,r){p();var s="playful"===i?a:l;s.style.display="block";try{window.gsap&&gsap.set&&gsap.set(s,{autoAlpha:1,filter:"none",clearProps:"opacity,visibility"})}catch(e){}if(y(i),"user"===r)try{localStorage.setItem(t,i)}catch(e){}try{e.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:i}}))}catch(e){}}function w(i){i&&i.preventDefault&&i.preventDefault(),function(i){if(window.gsap){var n=r&&r.dataset.view||s&&s.dataset.view||("none"!==a.style.display?"playful":"minimal");if(n!==i){var c="playful"===n?a:l,o="playful"===i?a:l;y(i);try{localStorage.setItem(t,i)}catch(e){}gsap.killTweensOf([c,o]);var u=h(i);gsap.timeline({defaults:{ease:"power2.out"}}).to(c,{autoAlpha:0,filter:"blur(10px)",duration:.22,overwrite:!0},0).add((function(){c.style.display="none",o.style.display="block",gsap.set(o,{autoAlpha:1,filter:"none"})}),">").to(u,{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"y,filter,willChange"},">-=0.02").add((function(){try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(e){}try{e.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:i}}))}catch(e){}}),">")}}else g(i,"user")}("playful"===(r&&r.dataset.view||s&&s.dataset.view||("none"!==a.style.display?"playful":"minimal"))?"minimal":"playful")}function m(){v()||(g(f(),"auto"),d(f()))}}}),	
			feature({id:"archiveListMotion",stage:"main",namespaces:["archive"],selectors:[".archive-playful-item",".archive-minimal-item"],init:function(e){if(!window.gsap)return;e=e||document;var t=e.querySelector('[data-barba="container"]')||e;if(t.__almCleanup)try{t.__almCleanup()}catch(_){}var items=[].slice.call(t.querySelectorAll(".archive-playful-item,.archive-minimal-item"));if(!items.length)return;var io=new IntersectionObserver(function(ents){ents.forEach(function(ent){var it=ent.target;if(!ent.isIntersecting||it.__almDone||it.style.display==="none")return;it.__almDone=1;gsap.fromTo(it,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.55,ease:"power3.out",overwrite:!0,clearProps:"y,filter,willChange"})})},{root:null,threshold:.15});items.forEach(function(it){io.observe(it)});t.__almCleanup=function(){try{io.disconnect()}catch(_){}t.__almCleanup=null}}}),
			feature({id:"archiveController",stage:"main",namespaces:["archive"],selectors:[".section-archive-playful",".section-archive-minimal"],init:function(e){if(!(e=e||document).__archiveControllerBound)return e.__archiveControllerBound=1,e.__archiveControllerDestroy=function(){e.__archiveControllerBound=0,e.__archiveControllerDestroy=null}}})
		);
