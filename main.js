...
// Entry Orchestrator
	window.EntryOrchestrator = window.EntryOrchestrator || (function () {
		...
		// Entry Animations
		var EntryAnimations = {};
		EntryOrchestrator.EntryAnimations.selected=function(e){e=e||document;var t=e.querySelector(".selected-container"),n=t&&t.querySelector(".selected-content"),i=gsap.timeline();if(!t||!n)return i;function r(e){return new Promise((function(t){requestAnimationFrame((function(){requestAnimationFrame((function(){t(e)}))}))}))}function o(){if(document.documentElement.hasAttribute("data-preloading")){var e=function(e){return n.querySelectorAll(e)};gsap.set([].concat([].slice.call(e(".appear-in-line")),[].slice.call(e(".selected-item-outer .selected-visual")),[].slice.call(e(".selected-item-outer .selected-item-header .headline-m")),[].slice.call(e(".selected-item-outer .selected-item-details"))),{visibility:"visible"})}}function a(){var e=Math.max(document.documentElement.clientWidth,window.innerWidth||0),a=window.innerHeight||document.documentElement.clientHeight||0,l=[].slice.call(n.querySelectorAll(".selected-item-outer"));if(!l.length)return i;function s(e){if(e.__entryPrepared)return;var t=e.querySelector(".selected-visual"),n=e.querySelector(".selected-item-header .headline-m"),i=e.querySelector(".selected-item-details"),r=e.querySelectorAll(".selected-item-details .body-s");t&&gsap.set(t,{scaleY:0,transformOrigin:"bottom center",opacity:0}),n&&gsap.set(n,{opacity:0}),i&&gsap.set(i,{opacity:0,height:0}),r.length&&gsap.set(r,{opacity:0,y:20,filter:"blur(10px)"}),e.__entryPrepared=!0}l.forEach(s);var d=l.map((function(t){var n=t.getBoundingClientRect(),i=Math.max(0,Math.min(n.right,e)-Math.max(n.left,0))*Math.max(0,Math.min(n.bottom,a)-Math.max(n.top,0));return{el:t,rect:n,area:i,cx:(n.left+n.right)/2}})),c=d.filter((function(e){return e.area>1})).sort((function(e,t){return e.rect.left-t.rect.left}));if(!c.length){var u=e/2;c=d.slice().sort((function(e,t){return Math.abs(e.cx-u)-Math.abs(t.cx-u)})).slice(0,2).sort((function(e,t){return e.rect.left-t.rect.left}))}var f={};c.forEach((function(e){f[e.el]=!0})),d.forEach((function(e){if(!e.el.__entryDone&&!f[e.el]){var t=e.el.querySelector(".selected-visual"),n=e.el.querySelector(".selected-item-header .headline-m"),i=e.el.querySelector(".selected-item-details"),r=e.el.querySelectorAll(".selected-item-details .body-s");t&&gsap.set(t,{scaleY:1,opacity:1}),n&&gsap.set(n,{opacity:1}),i&&gsap.set(i,{opacity:1,height:"auto"}),r.length&&gsap.set(r,{opacity:1,y:0,filter:"blur(0px)"}),e.el.__entryDone=!0}})),c.forEach((function(e,t){var n=e.el,r=n.querySelector(".selected-visual"),o=n.querySelector(".selected-item-header .headline-m"),a=n.querySelector(".selected-item-details"),l=n.querySelectorAll(".selected-item-details .body-s"),s=.14*t;r&&i.set(r,{opacity:1},s).to(r,{scaleY:1,duration:.8,ease:"power2.out"},s),o&&i.set(o,{opacity:1},s+.18).call((function(){var e=(window.CoreUtilities&&CoreUtilities.Text)||null;if(e&&window.SplitText&&window.splitAndMask&&window.animateLines&&window.safelyRevertSplit){var t=splitAndMask(o);animateLines(t.lines).eventCallback("onComplete",(function(){safelyRevertSplit(t,o)}))}else gsap.to(o,{y:0,opacity:1,duration:.6,ease:"power2.out"})}),null,s+.18),a&&i.to(a,{opacity:1,height:"auto",duration:.42,ease:"power2.out"},s+.58),l.length&&i.to(l,{opacity:1,y:0,filter:"blur(0px)",duration:.42,ease:"power2.out",stagger:.12},s+.58),n.__entryDone=!0}));return i}return t.hasAttribute("data-loop-ready")?(o(),r(0).then(a),i):(o(),new Promise((function(e){var i=function(){n.removeEventListener("selected:loop-ready",i,!0),e()};n.addEventListener("selected:loop-ready",i,!0),setTimeout((function(){n.removeEventListener("selected:loop-ready",i,!0),e()}),700)})).then(r).then(a),i)};
