...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.capabilities.push(
			...
			feature({id:"heroShowreel",stage:"main",namespaces:["capabilities"],selectors:[".hero-section-showreel .showreel-track",".hero-section-showreel .showreel-container"],init:async function(e){if(matchMedia("(prefers-reduced-motion: reduce)").matches||!matchMedia("(pointer:fine)").matches)return;e=e||document;var t=e.querySelector(".hero-section-showreel");if(!t||t.__hsBound)return;var r=t.querySelector(".showreel-track"),n=t.querySelector(".hero-section-showreel .showreel-container"),h=t.querySelector(".showreel-headline-wrapper"),q=t.querySelector(".showreel-options");if(!r||!n)return;t.__hsBound=1;var i=window.CSS&&CSS.supports&&CSS.supports("aspect-ratio:16/9"),o={x:0,px:null,last:0,raf:0,w:0,tw:0,left:0,right:0,baseC:0,hasMove:!1,vx:0,sq:0,wP:0,prevSq:0,wob:0,sp:0,range:0},L=2.2,M=.3,V=1300,S=.13,H={base:.8,min:.65,max:1},WF=5,WS=.5,SR=.08,EPS=.002;function clamp(v,min,max){return v<min?min:v>max?max:v}function c(){var hr=t.getBoundingClientRect(),wh=window.innerHeight||document.documentElement.clientHeight||0,total=hr.height-wh;total<0&&(total=0);var scrolled=clamp(-hr.top,0,total);o.sp=total?scrolled/total:0;o.range=total;var e=n.getBoundingClientRect(),tr=r.getBoundingClientRect();o.w=e.width||n.offsetWidth||0;o.tw=tr.width||r.offsetWidth||0;o.left=tr.left;o.right=tr.right;o.baseC=e.left+e.width/2-o.x;!i&&o.w&&(n.style.height=o.w*9/16+"px")}function u(e){var t=clamp(e,o.left,o.right),i=t+o.w/2,c=o.left+o.w/2,l=o.right-o.w/2;c>l&&(c=l=(o.left+o.right)/2);var a=clamp(i,c,l);return a-o.baseC}function a(e){var t=e.clientX;o.hasMove&&(o.vx+=t-(null==o.px?t:o.px));o.hasMove=!0;o.px=t}function s(e){o.last||(o.last=e);var t=(e-o.last)/1e3;t<0&&(t=0);t>.05&&(t=.05);o.last=e;c();var prog=o.sp||0,base=H.base+(1-H.base)*prog,min=base-(H.base-H.min)*(1-.6*prog),max=base+(H.max-H.base)*(1-prog),y=(prog-.5)*(window.innerHeight*.25),headOffset=-o.range*prog;h&&(h.style.transform="translate3d(0,"+headOffset+"px,0)");q&&(q.style.transform="translate3d(0,"+headOffset+"px,0)");if(!o.hasMove||null==o.px){n.style.transform="translate3d("+o.x+"px,"+y+"px,0) scale("+base+")";o.raf=requestAnimationFrame(s);return}var r=u(o.px),i=1-Math.exp(-L*t);o.x+=i*(r-o.x);o.vx*=.96;Math.abs(o.vx)<.02&&(o.vx=0);var l=0;o.vx&&(l=-o.vx/V,l>M?l=M:l<-M&&(l=-M));o.sq+=S*(l-o.sq);var a=base+o.sq;a<min?a=min:a>max&&(a=max);var f=1,hS=a-base,v=o.prevSq;o.prevSq=hS;if(WS&&(Math.abs(hS)>.005||Math.abs(v)>.01)){o.wP+=WF*t;var amp=WS*(1-prog);f=1+amp*Math.sin(o.wP)}var C=a*f;n.style.transform="translate3d("+o.x+"px,"+y+"px,0) scale("+C+")";o.raf=requestAnimationFrame(s)}c();n.style.transform="translate3d(0,0,0) scale("+H.base+")";addEventListener("pointermove",a,{passive:!0});addEventListener("resize",c,{passive:!0});o.raf=requestAnimationFrame(s);t.__hsDestroy=function(){try{removeEventListener("pointermove",a)}catch(e){}try{removeEventListener("resize",c)}catch(e){}try{o.raf&&cancelAnimationFrame(o.raf)}catch(e){}}},destroy:async function(e){e=e||document;var t=e.querySelector(".hero-section-showreel")||document.querySelector(".hero-section-showreel");try{t&&t.__hsDestroy&&t.__hsDestroy()}catch(e){}}}),
			feature({
