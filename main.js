	...
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({
				...
				init: function(e){e=e||document;var t="archiveView",i=matchMedia("(min-width: 1024px)"),a=e.querySelector(".section-archive-playful"),l=e.querySelector(".section-archive-minimal"),r=e.querySelector(".archive-switch-block"),s=e.querySelector(".archive-switch"),n=e.querySelector(".archive-switch-dot");if(!a||!l||e.__archiveViewBound)return;e.__archiveViewBound=1;var c=[r,s].filter(Boolean),o=null,d=0;function u(){try{window.gsap&&gsap.set&&gsap.set([a,l],{display:"none"})}catch(_){}a.style.display="none",l.style.display="none"}function m(){try{var e=localStorage.getItem(t);return"playful"===e||"minimal"===e?e:null}catch(_){}return null}function f(){return i.matches?m()||"playful":"minimal"}function p(e){var t="playful"===e;r&&(r.dataset.view=e,r.setAttribute("aria-pressed",String(t)),r.classList.toggle("is-playful",t),r.classList.toggle("is-minimal",!t)),s&&(s.dataset.view=e,s.classList.toggle("is-playful",t),s.classList.toggle("is-minimal",!t)),n&&(n.dataset.view=e,n.classList.toggle("is-playful",t),n.classList.toggle("is-minimal",!t))}function g(e){try{document.dispatchEvent(new CustomEvent("archive:view",{bubbles:!0,detail:{view:e}}))}catch(_){}}function h(e){u();var t="playful"===e?a:l;t.style.display="block";try{window.gsap&&gsap.set&&gsap.set(t,{autoAlpha:1,filter:"none",clearProps:"opacity,visibility"})}catch(_){}p(e),g(e);try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}}function v(e){if(!window.gsap)return[];var t="playful"===e?a:l,i="playful"===e?".archive-playful-item":".archive-minimal-item",r=[].slice.call(t.querySelectorAll(i)||[]);return r.forEach(function(e){e.__almDone=1,gsap.killTweensOf(e),gsap.set(e,{y:18,autoAlpha:0,filter:"blur(10px)",willChange:"transform,opacity,filter"})}),r}function y(e){if(!window.gsap||d)return;d=1;var t=v(e);t.length&&gsap.timeline({defaults:{ease:"power3.out"}}).to(t,{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"y,filter,willChange"},0).add(function(){try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}g(e)})}function b(e){if(!window.gsap)return h(e),void function(e){try{localStorage.setItem(t,e)}catch(_){}}(e);var n=(r&&r.dataset.view)||(s&&s.dataset.view)||("none"!==a.style.display?"playful":"minimal");if(n===e)return;var c="playful"===n?a:l,o="playful"===e?a:l;p(e);try{localStorage.setItem(t,e)}catch(_){}gsap.killTweensOf([c,o]),u(),c.style.display="block",o.style.display="none";var d=v(e);gsap.timeline({defaults:{ease:"power2.out"}}).set(c,{display:"block",autoAlpha:1,filter:"none"},0).to(c,{autoAlpha:0,filter:"blur(10px)",duration:.22,overwrite:!0},0).add(function(){c.style.display="none",o.style.display="block",gsap.set(o,{autoAlpha:1,filter:"none"})}).to(d,{y:0,autoAlpha:1,filter:"blur(0px)",duration:.6,stagger:.06,overwrite:!0,clearProps:"y,filter,willChange"},"-=0.02").add(function(){try{window.ScrollTrigger&&ScrollTrigger.refresh&&ScrollTrigger.refresh()}catch(_){}g(e)})}function w(e){e&&e.preventDefault&&e.preventDefault();if(i.matches){var t=("playful"===(r&&r.dataset.view||s&&s.dataset.view||("none"!==a.style.display?"playful":"minimal"))?"minimal":"playful");b(t)}else h("minimal")}function k(){h(f()),d=0,window.gsap?y(f()):S()}function S(){if(o)return;var e=0;o=setInterval(function(){if(window.gsap){clearInterval(o),o=null,y(f())}else e+=50,e>=2000&&(clearInterval(o),o=null)},50)}u(),h(f()),window.gsap?y(f()):S(),c.forEach(function(e){e&&e.addEventListener("click",w,{passive:!1})}),i.addEventListener?i.addEventListener("change",k):i.addListener(k),e.__archiveViewDestroy=function(){try{o&&(clearInterval(o),o=null)}catch(_){}try{i.removeEventListener?i.removeEventListener("change",k):i.removeListener(k)}catch(_){}c.forEach(function(e){try{e&&e.removeEventListener("click",w)}catch(_){}}),e.__archiveViewBound=0,e.__archiveViewDestroy=null}}
			}),
			feature({
				...
				//init: function(e){if(!window.gsap)return;e=e||document;var t=e.querySelector('[data-barba="container"]')||e;if(t.__almCleanup)try{t.__almCleanup()}catch(e){}var i=[].slice.call(t.querySelectorAll(".archive-playful-item,.archive-minimal-item"));if(!i.length)return;var r=new IntersectionObserver(function(e){e.forEach(function(e){var i=e.target;if(!e.isIntersecting||i.__almDone||"none"===i.style.display)return;i.__almDone=1;var r=i.classList.contains("archive-minimal-item")?i.querySelector(".archive-minimal-item-visual"):null;r&&!r.__almVisDone&&(r.__almVisDone=1,gsap.fromTo(r,{autoAlpha:0,filter:"blur(10px)"},{autoAlpha:1,filter:"blur(0px)",delay:.35,duration:1,ease:"power2.out",overwrite:!0,clearProps:"filter,willChange"})),gsap.fromTo(i,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.55,ease:"power3.out",overwrite:!0,clearProps:"y,filter,willChange"})})},{root:null,threshold:.15});i.forEach(function(e){r.observe(e)}),t.__almCleanup=function(){try{r.disconnect()}catch(e){}t.__almCleanup=null}}
				init: function(e){if(!window.gsap)return;e=e||document;var t=e.querySelector('[data-barba="container"]')||e;if(t.__almCleanup)try{t.__almCleanup()}catch(_){ }var i=[].slice.call(t.querySelectorAll(".archive-playful-item,.archive-minimal-item"));if(!i.length)return;var a=.085,r=3,n=.12,o=10,s=function(e){return e&&"none"!==e.style.display};i.forEach(function(e){gsap.set(e,{autoAlpha:0,y:18,filter:"blur(10px)",willChange:"transform,opacity,filter"});var t=e.classList.contains("archive-minimal-item")?e.querySelector(".archive-minimal-item-visual"):null;t&&!t.__almVisInit&&(t.__almVisInit=1,gsap.set(t,{autoAlpha:0,filter:"blur("+o+"px)",willChange:"opacity,filter"}))});var l=new IntersectionObserver(function(e){e.forEach(function(e){var t=e.target;if(!e.isIntersecting||!s(t))return;var i=[].slice.call(t.querySelectorAll(".archive-minimal-item"));if(!i.length)return;var o=i.map(function(e){return e.querySelector(".archive-minimal-item-visual")}).filter(Boolean),l=gsap.timeline({defaults:{ease:"power3.out"},overwrite:!0});t.__almMinDone||(t.__almMinDone=1,l.to(i,{autoAlpha:1,y:0,filter:"blur(0px)",duration:.55,stagger:a,clearProps:"filter,willChange"} ,0),o.length&&l.to(o,{autoAlpha:1,filter:"blur(0px)",duration:.8,stagger:a,ease:"sine.out",clearProps:"filter,willChange"},Math.max(0,(r-1)*a+n)),l.add(function(){i.forEach(function(e){gsap.set(e,{clearProps:"willChange"})}),o.forEach(function(e){gsap.set(e,{clearProps:"willChange"})})}),l.play()),l.unobserve(t)})},{root:null,threshold:.15});var u=[].slice.call(t.querySelectorAll(".archive-minimal-list"));u.forEach(function(e){l.observe(e)});var d=new IntersectionObserver(function(e){e.forEach(function(e){var t=e.target;if(!e.isIntersecting||!s(t))return;if(t.__almDone)return;t.__almDone=1;var i=t.classList.contains("archive-minimal-item")?t.querySelector(".archive-minimal-item-visual"):null;i&&!i.__almVisDone&&(i.__almVisDone=1,gsap.fromTo(i,{autoAlpha:0,filter:"blur("+o+"px)"},{autoAlpha:1,filter:"blur(0px)",delay:.35,duration:1,ease:"sine.out",overwrite:!0,clearProps:"filter,willChange"}));gsap.fromTo(t,{y:18,autoAlpha:0,filter:"blur(10px)"},{y:0,autoAlpha:1,filter:"blur(0px)",duration:.55,ease:"power3.out",overwrite:!0,clearProps:"y,filter,willChange"});d.unobserve(t)})},{root:null,threshold:.15});i.forEach(function(e){e.classList.contains("archive-playful-item")&&d.observe(e)});t.__almCleanup=function(){try{l.disconnect()}catch(_){}try{d.disconnect()}catch(_){}t.__almCleanup=null}}
			}),
			feature({
