...
// Init Manager
	window.InitManager = (function () {
		...
		registries.pages.archive.push(
			...
			feature({id:"archivePlayfulExperience",stage:"main",namespaces:["archive"],selectors:[".section-archive-playful",".archive-playful-item",".archive-playful-visuals",".archive-playful-visual-img",".archive-playful-data-inner",".archive-playful-data-inner .headline-xxs",".archive-playful-data-inner .body-sm",".archive-playful-item-data .shortcut-link"],init:function(r){r=r||document;var h=r.querySelector('[data-barba="container"][data-barba-namespace="archive"]')||r.querySelector('[data-barba="container"]')||r;if(h.__apxBound)return;h.__apxBound=1;if(!window.gsap||!window.ScrollTrigger)return void(h.__apxBound=0);var g=window.gsap,S=window.ScrollTrigger,mm=matchMedia("(min-width:1024px)"),pr=matchMedia("(prefers-reduced-motion: reduce)");if(pr.matches)return void(h.__apxBound=0);var P=h.querySelector(".section-archive-playful");if(!P)return void(h.__apxBound=0);var un=[],tr=[],tl=[],made=0,api=h.__archiveSystemAPI&&h.__archiveSystemAPI.mod?{m:h.__archiveSystemAPI.mod}:null,orig=null;function on(n,e,f,o){n&&n.addEventListener(e,f,o),un.push(function(){try{n.removeEventListener(e,f,o)}catch(_){}})}function q(a,s){return a?a.querySelector(s):null}function qs(a,s){return a?[].slice.call(a.querySelectorAll(s)):[]}function vis(){try{return!!(P&&getComputedStyle(P).display!=="none")}catch(_){return!0}}function items(){return[].slice.call(P.querySelectorAll(".archive-playful-item"))}function prep(it,idx){if(!it||it.__apxPrep)return;it.__apxPrep=1;var v=q(it,".archive-playful-visuals"),imgs=qs(it,".archive-playful-visual-img"),di=q(it,".archive-playful-data-inner"),hx=q(it,".archive-playful-data-inner .headline-xxs"),bx=q(it,".archive-playful-data-inner .body-sm"),sl=q(it,".archive-playful-item-data .shortcut-link");v&&g.set(v,{height:0,opacity:0,overflow:"hidden",willChange:"height,opacity"});di&&g.set(di,{marginTop:0,willChange:"margin-top"});hx&&g.set(hx,{opacity:0,height:0,overflow:"hidden",willChange:"height,opacity"});bx&&g.set(bx,{opacity:0,height:0,overflow:"hidden",willChange:"height,opacity"});sl&&g.set(sl,{opacity:0,height:0,overflow:"hidden",y:0,willChange:"transform,opacity,height"});imgs.length&&imgs.forEach(function(im){try{g.set(im,{scale:1.5,yPercent:-15,transformOrigin:"50% 50%",willChange:"transform"})}catch(_){}});if(idx===0){v&&g.set(v,{height:"45vh",opacity:1});di&&g.set(di,{marginTop:"1rem"});hx&&g.set(hx,{opacity:1,height:"1rem"});bx&&g.set(bx,{opacity:1,height:"3rem"});sl&&g.set(sl,{opacity:1,height:"1rem",y:0})}}function makeTL(it){var v=q(it,".archive-playful-visuals"),imgs=qs(it,".archive-playful-visual-img"),di=q(it,".archive-playful-data-inner"),hx=q(it,".archive-playful-data-inner .headline-xxs"),bx=q(it,".archive-playful-data-inner .body-sm"),sl=q(it,".archive-playful-item-data .shortcut-link"),t=g.timeline({paused:!0,defaults:{ease:"none"}});v&&t.set(v,{opacity:1},.01);imgs.length&&t.to(imgs,{yPercent:15,duration:1},0).to(imgs,{keyframes:[{scale:1.5},{scale:1.1},{scale:1.1},{scale:1.5}],times:[0,.30,.70,1],duration:1},0);v&&t.to(v,{height:"45vh",duration:.30},.30).to(v,{height:"45vh",duration:.40},.30).to(v,{height:0,duration:.30},.70).to(v,{opacity:0,duration:0},1);di&&t.to(di,{marginTop:"1rem",duration:.70},.10).to(di,{marginTop:"1rem",duration:.10},.80).to(di,{marginTop:0,duration:.20},.80);hx&&t.set(hx,{opacity:0,height:0},.10).to(hx,{opacity:1,height:"1rem",duration:.18},.28).to(hx,{opacity:0,height:0,duration:.08},.92);bx&&t.set(bx,{opacity:0,height:0},.15).to(bx,{opacity:1,height:"3rem",duration:.18},.30).to(bx,{opacity:0,height:0,duration:.10},.88);sl&&t.set(sl,{opacity:0,height:0,y:"2rem"},.15).to(sl,{opacity:1,height:"1rem",y:0,duration:.18},.30).to(sl,{opacity:1,height:"1rem",duration:.40},.30).to(sl,{opacity:0,height:0,y:"2rem",duration:.10},.88).to(sl,{y:0,duration:0},1);return t}function kill(){for(var i=0;i<tr.length;i++)try{tr[i]&&tr[i].kill&&tr[i].kill()}catch(_){ }for(i=0;i<tl.length;i++)try{tl[i]&&tl[i].kill&&tl[i].kill()}catch(_){ }tr.length=0;tl.length=0;made=0}function patchMotion(on){if(!api||!api.m)return;var m=api.m;function isPlayful(){try{var v=m.getView?m.getView():(h.__archiveSystemAPI&&h.__archiveSystemAPI.mod&&h.__archiveSystemAPI.mod.getView?h.__archiveSystemAPI.mod.getView():"playful");return v==="playful"&&mm.matches&&vis()}catch(_){return mm.matches&&vis()}}if(on){if(orig)return;orig={sched:m.scheduleMotionRefresh,reset:m.resetMotion};m.scheduleMotionRefresh=function(){if(isPlayful())return;try{return orig.sched&&orig.sched.apply(this,arguments)}catch(_){}};m.resetMotion=function(){if(isPlayful())return;try{return orig.reset&&orig.reset.apply(this,arguments)}catch(_){}}}else if(orig){m.scheduleMotionRefresh=orig.sched;m.resetMotion=orig.reset;orig=null}}function build(){if(made)return;var list=items();if(!list.length)return;for(var i=0;i<list.length;i++){prep(list[i],i);var t=makeTL(list[i]);tl.push(t);if(i===0){tr.push(S.create({trigger:list[i],start:"top 70%",end:"top 0%",scrub:!0,onUpdate:function(self){try{t.progress(.7+.3*self.progress)}catch(_){}}}))}else{tr.push(S.create({trigger:list[i],start:"top 100%",end:"top 0%",scrub:!0,onUpdate:function(self){try{t.progress(self.progress)}catch(_){}}}))}}made=1;try{S.refresh()}catch(_){}}function enable(){if(!mm.matches||!vis()){patchMotion(0);return}patchMotion(1);build();for(var i=0;i<tr.length;i++)try{tr[i]&&tr[i].enable&&tr[i].enable()}catch(_){}}function disable(){patchMotion(0);for(var i=0;i<tr.length;i++)try{tr[i]&&tr[i].disable&&tr[i].disable()}catch(_){}}function sync(){mm.matches&&vis()?enable():disable()}function onMQ(){sync()}function onView(){sync()}on(document,"archive:view",onView,{passive:!0});try{mm.addEventListener?mm.addEventListener("change",onMQ):mm.addListener(onMQ)}catch(_){ }un.push(function(){try{mm.removeEventListener?mm.removeEventListener("change",onMQ):mm.removeListener(onMQ)}catch(_){}});requestAnimationFrame(sync);return function(){try{disable();kill()}catch(_){ }patchMotion(0);un.forEach(function(fn){fn()});un.length=0;try{h.__apxBound=0}catch(_){}}}})
		);
