...
// Selected Work + Archive + Resources
	...
	function initCounters(e=document){[{id:"work-counter-selected",selector:".selected-item-outer"},{id:"work-counter-archive",selector:".list-item-archive-project"},{id:"work-counter-resources",selector:".resource-item"},{id:"archive-results-counter",selector:".list-item-archive-project"}].forEach((({id:t,selector:r})=>{const o=e.querySelector(`#${t}`);if(!o)return;const c=e.querySelectorAll(r).length;if("archive-results-counter"===t){const e=o.textContent||"",t={value:parseInt(e.replace(/\D/g,""),10)||0};gsap.to(t,{value:c,duration:.5,ease:"power1.out",onUpdate:()=>{o.textContent=Math.round(t.value)}})}else o.textContent=`(${c})`}))}
  ...
  cards.forEach((card, idx)=>{
    ...
    if(block)  gsap.set(block ,{willChange:"transform",force3D:true});
    gsap.set(card,{willChange:"filter",transform:"translateZ(0)"});
...
// Unified Navigation System + Menu Links Hover + Filters Navigation Category Counters + Theme Switch
...
// Page Transition & Entry Animations
