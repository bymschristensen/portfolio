	...
	window.InitManager = (function () {
		...
		registries.common.push(
			...
			feature({
				...
				init:async r=>{if(window.__CC_LOCK)return window.__customCursorDestroy||(()=>{});window.__CC_LOCK=1;try{window.__customCursorDestroy&&window.__customCursorDestroy()}catch{}try{document.getElementById("cc-webgl")?.remove(),document.getElementById("cc-dom")?.remove()}catch{}if(!matchMedia("(pointer:fine)").matches||!matchMedia("(hover:hover)").matches)return document.body.classList.remove("cursor--disable-all-cursors"),window.__customCursorDestroy=()=>{},CoreUtilities.Cursor.setDestroy(window.__customCursorDestroy),window.__CC_LOCK=0,window.__customCursorDestroy;const c=document.createElement("canvas");c.className="cursor-webgl",c.id="cc-webgl",document.body.appendChild(c);const a=c.getContext("2d"),w=document.createElement("div");w.className="custom-cursor",w.id="cc-dom";const k=document.createElement("div");k.className="cursor-label cursor-label--right",k.setAttribute("aria-hidden","true");const B=document.createElement("div");B.className="cursor-label__inner";const C=document.createElement("div");C.className="cursor-label__text",B.appendChild(C),k.appendChild(B),w.appendChild(k),document.body.appendChild(w);const W=innerWidth/2,H=innerHeight/2,p={x:W,y:H,tx:W,ty:H},Q=gsap.quickSetter(w,"x","px"),K=gsap.quickSetter(w,"y","px"),j=gsap.quickSetter(k,"x","px"),z=gsap.quickSetter(k,"y","px"),V=gsap.quickSetter(k,"rotation","deg");gsap.set(w,{x:p.x,y:p.y,scale:1,opacity:0,transformOrigin:"center center",pointerEvents:"none"}),gsap.set(k,{autoAlpha:0,willChange:"transform,clip-path,opacity"}),gsap.set(B,{display:"block"});let L=0,E=0;function R(){L=innerWidth,E=innerHeight,c.width=L,c.height=E}R();const h=Array.from({length:40},()=>({x:p.x,y:p.y,vx:0,vy:0})),S={s:1};let I=null,T=null,b=null,N=null,A=!1,O=!1;const U=.01,VV=.005;let i=p.x,l=p.y;function J(){clearTimeout(N),N=setTimeout(Z,1e4)}function G(){const e=document.documentElement;i=(.25+.5*Math.random())*e.clientWidth,l=(.25+.5*Math.random())*e.clientHeight}function Z(){if(A||O)return;A=!0,G();const e=()=>{A&&!O&&(Math.random()<VV&&G(),p.tx+=(i-p.tx)*U,p.ty+=(l-p.ty)*U,b=requestAnimationFrame(e))};b=requestAnimationFrame(e)}function x(){A=!1,b&&cancelAnimationFrame(b),b=null}const ht=(e,t,n)=>Math.max(t,Math.min(n,e)),yt=t=>t.split("").map(e=>`<span class="cc-char" style="display:inline-block;will-change:transform,opacity">${" "===e?"&nbsp;":e}</span>`).join("");let P=0,M=0,rt=0,nt=0,mt=0,gt=0,tt=0,et=0,ot=0,st=0,ut=!1,dt=10,ct="",rot=0,sideTl=null,prevSideLeft=!1;function _hideClip(e){return e?"inset(0% 0% 0% 100%)":"inset(0% 100% 0% 0%)"}function _showClip(){return"inset(0% 0% 0% 0%)"}function _setSide(e){k.classList.toggle("cursor-label--left",!!e),k.classList.toggle("cursor-label--right",!e),gsap.set(k,{transformOrigin:e?"100% 0%":"0% 0%"})}function _sideIsLeft(){return k.classList.contains("cursor-label--left")}function _calcSide(){const e=innerWidth,t=_sideIsLeft()?e*.72:e*.8;return p.tx>t}function _chars(){return C.querySelectorAll(".cc-char")}function _forceCharsVisible(){const e=_chars();e&&e.length&&gsap.set(e,{opacity:1,y:0,clearProps:"transform"})}function _animateSideSwitch(e){const t=_sideIsLeft(),n=!!e;if(t===n||!ut)return;prevSideLeft=n,sideTl&&sideTl.kill();const o=_chars();sideTl=gsap.timeline({overwrite:!0});sideTl.to(o,{y:10,opacity:0,duration:.12,ease:"power2.in",stagger:{each:.008,from:t?"start":"end"}},0).to(k,{clipPath:_hideClip(t),duration:.16,ease:"power2.in"},0).add(()=>{_setSide(n),gsap.set(k,{clipPath:_hideClip(n),autoAlpha:1})}).add(()=>{const s=_chars();gsap.set(s,{y:10,opacity:0})}).to(k,{clipPath:_showClip(),duration:.26,ease:"power3.out"},.16).to(_chars(),{y:0,opacity:1,duration:.26,ease:"power3.out",delay:.02,stagger:{each:.014,from:n?"end":"start"}},.16).add(()=>{_forceCharsVisible()},">")}function _revealLabel(e){const t=_calcSide();_setSide(t),ct=(e||ct||"Hover something").trim()||"Hover something";C.innerHTML=yt(ct);const n=_chars();sideTl&&sideTl.kill(),gsap.killTweensOf(n),gsap.killTweensOf(k),gsap.set(k,{autoAlpha:1,clipPath:_hideClip(t)}),gsap.set(n,{y:10,opacity:0}),gsap.to(k,{clipPath:_showClip(),duration:.34,ease:"power3.out",overwrite:!0}),gsap.to(n,{y:0,opacity:1,duration:.32,ease:"power3.out",delay:.05,overwrite:!0,stagger:{each:.016,from:t?"end":"start"}}),ut=!0,prevSideLeft=t}function _swapText(e){e=(e||"").trim()||"Hover something";if(!ut)return _revealLabel(e);if(e===ct)return;ct=e;const t=_sideIsLeft(),n=_chars();sideTl&&sideTl.kill(),gsap.killTweensOf(n);const o=gsap.timeline({overwrite:!0});o.to(n,{y:10,opacity:0,duration:.16,ease:"power2.in",stagger:{each:.01,from:t?"start":"end"}}).add(()=>{C.innerHTML=yt(ct)}).set(_chars(),{y:10,opacity:0}).to(_chars(),{y:0,opacity:1,duration:.26,ease:"power3.out",stagger:{each:.014,from:t?"end":"start"}}).add(()=>{_forceCharsVisible()})}function _hideLabel(){if(!ut)return;ut=!1;const e=_sideIsLeft(),t=_chars();sideTl&&sideTl.kill(),gsap.killTweensOf(t),gsap.killTweensOf(k),gsap.to(t,{y:10,opacity:0,duration:.14,ease:"power2.in",overwrite:!0,stagger:{each:.01,from:e?"start":"end"}}),gsap.to(k,{clipPath:_hideClip(e),duration:.2,ease:"power2.in",overwrite:!0,onComplete:()=>{gsap.set(k,{autoAlpha:0})}})}const Dt=e=>{if(O)return;x(),J();const t=e.clientX,n=e.clientY;rt=t-P,nt=n-M,P=t,M=n;mt=ht(.35*rt,-16,16),gt=ht(.35*nt,-14,14),p.tx=t,p.ty=n},Ft=()=>{document.hidden?x():J()},qt=e=>{if(O)return;x(),J();const t=e.target.closest("[data-cursor]");if(!t)return document.body.classList.remove("cursor--disable-all-cursors"),gsap.to(w,{scale:1,opacity:1,duration:.25,ease:"power2.out",overwrite:!0}),void _hideLabel();const n=(t.dataset.cursor||"").toLowerCase();if("hide"===n)return w.classList.add("cursor--hide"),document.body.classList.add("cursor--disable-all-cursors"),gsap.set(w,{scale:0,opacity:0,overwrite:!0}),void gsap.set(S,{s:0,overwrite:!0});w.className="custom-cursor",document.body.classList.remove("cursor--disable-all-cursors");let o=1;if("scaleup"===n)o=3,w.classList.add("cursor--scaleup"),_hideLabel();else if("text"===n){const e=((t.dataset.cursorText||t.dataset.text||"")+"").trim();_revealLabel(e||"Hover something"),o=1}else _hideLabel();gsap.to(w,{scale:o,opacity:1,duration:.25,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:o,duration:.25,ease:"power2.out",overwrite:!0})},Mt=e=>{if(O)return;const t=e.target.closest("[data-cursor]");t&&(t.dataset.cursor||"").toLowerCase()==="text"&&_hideLabel(),_hideLabel(),w.className="custom-cursor",document.body.classList.remove("cursor--disable-all-cursors"),gsap.to(w,{scale:1,opacity:1,duration:.25,ease:"power2.out",overwrite:!0}),gsap.to(S,{s:1,duration:.25,ease:"power2.out",overwrite:!0})};function Y(){if(O)return;O=!0,x(),I&&cancelAnimationFrame(I),T&&cancelAnimationFrame(T),removeEventListener("resize",R),document.removeEventListener("mousemove",Dt),document.removeEventListener("pointerover",qt),document.removeEventListener("pointerout",Mt),document.removeEventListener("visibilitychange",Ft);try{c.remove()}catch{}try{w.remove()}catch{}window.__customCursorDestroy=null,window.__CC_LOCK=0}addEventListener("resize",R),document.addEventListener("mousemove",Dt,{passive:!0}),document.addEventListener("pointerover",qt,{passive:!0}),document.addEventListener("pointerout",Mt,{passive:!0}),document.addEventListener("visibilitychange",Ft),I=requestAnimationFrame(function e(){a.clearRect(0,0,L,E),p.x+=.45*(p.tx-p.x),p.y+=.45*(p.ty-p.y),h.forEach((e,t)=>{if(0===t)return e.x=p.x,void(e.y=p.y);const n=h[t-1];e.vx+=.4*(n.x-e.x),e.vy+=.4*(n.y-e.y),e.vx*=.5,e.vy*=.5,e.x+=e.vx,e.y+=e.vy});const t=getComputedStyle(document.documentElement).getPropertyValue("--colors--highlight").trim()||"#000";a.strokeStyle=t;for(let e=0;e<h.length-1;e++){const n=h[e],o=h[e+1],s=e/(h.length-1);a.lineWidth=16*(1-s)+2*s,a.lineCap="round",a.beginPath(),a.moveTo(n.x,n.y),a.lineTo(o.x,o.y),a.stroke()}a.beginPath(),a.fillStyle=t,a.arc(p.x,p.y,10*S.s,0,2*Math.PI),a.fill(),I=requestAnimationFrame(e)}),T=requestAnimationFrame(function e(){Q(p.x),K(p.y);const t=_calcSide();ut&&_animateSideSwitch(t);if(ut){tt+=(mt-tt)*.16,et+=(gt-et)*.16;const e1=(t?-dt:dt)+tt,n1=et;ot+=(e1-ot)*.22,st+=(n1-st)*.22,j(ot),z(st);const rr=ht((et*.55+tt*.08),-12,12);rot+=(rr-rot)*.18,V(rot)}T=requestAnimationFrame(e)}),J(),window.__customCursorDestroy=Y,CoreUtilities.Cursor.setDestroy(Y),window.__CC_LOCK=0,Y}
			}),
